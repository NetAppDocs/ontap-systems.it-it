...
---
= Sostituisci il modulo NVRAM o i DIMM NVRAM nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo NVRAM o i DIMM NVRAM nel tuo sistema AFF A700 per ripristinare la corretta funzionalità NVRAM e le prestazioni del sistema.
