...
summary: Per sostituire a caldo un modulo di alimentazione del controller di destaging, che contiene la batteria NVRAM10, individuare il modulo DCPM guasto, rimuoverlo dallo chassis e installare il modulo DCPM sostitutivo. 
---
= Sostituisci a caldo il modulo di alimentazione del controller di de-stage (DCPM) nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nel tuo sistema AFF A700 puoi sostituire a caldo il modulo di alimentazione del controller di de-stage (DCPM) per rimpiazzare il modulo guasto senza interrompere il servizio.
