...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina e verifica la configurazione del controller nel tuo sistema AFF A700 dopo aver completato la sostituzione dell'hardware e aver avviato in modalità Manutenzione.
