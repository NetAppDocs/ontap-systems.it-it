...
---
= Installa il tuo sistema storage AFF A700 in pochi semplici passaggi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A700 seguendo le semplici istruzioni grafiche, dal montaggio nei rack e dal cablaggio fino alla configurazione iniziale del sistema.
