...
sidebar: sidebar 
keywords: aff a700, x91148a, module, open, slots, nic, storage 
...
---
= Aggiungi un modulo X91148A a un sistema AFF A700 utilizzando uno slot libero
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo X91148A al tuo AFF A700 utilizzando uno slot disponibile nello chassis.
