...
summary: Sostituisci la batteria del real-time clock nel modulo controller AFF A700 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema AFF A700 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.
