...
summary: 'Avviare l"immagine di ripristino ONTAP dall"unità USB su un sistema AFF A700 per ripristinare il supporto di avvio. Il sistema AFF A700 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.' 
---
= Avvia l'immagine di ripristino sul tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
