...
---
= Aggiungi un modulo storage X91148A al tuo AFF A700 quando tutti gli slot sono occupati
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo storage X91148A al tuo AFF A700 quando tutti gli slot sono occupati, sostituendo un modulo esistente.
