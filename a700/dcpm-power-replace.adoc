...
---
= Sostituisci il modulo DCPM nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo DCPM nel tuo sistema AFF A700 per ripristinare la corretta gestione dell'alimentazione per la NVRAM10.
