...
---
= Sostituisci il controller nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo AFF A700 rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo di ricambio, installandolo nello chassis e avviando la modalità di manutenzione.
