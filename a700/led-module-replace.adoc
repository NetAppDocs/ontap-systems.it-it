...
---
= Sostituisci un modulo LED USB nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo LED USB nel tuo AFF A700 per ripristinare il LED indicatore di stato e la funzionalità USB.
