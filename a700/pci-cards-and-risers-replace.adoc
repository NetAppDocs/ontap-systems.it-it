...
---
= Sostituisci un modulo I/O in un sistema AFF A700 o in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo I/O nel tuo sistema AFF A700 o FAS9000 scollegando i cavi, rimuovendo il riser, sostituendo il modulo e ricablando.
