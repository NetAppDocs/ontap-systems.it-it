...
summary: Per arrestare il nodo compromesso, è necessario determinare lo stato del nodo e, se necessario, assumere il controllo del nodo in modo che il nodo integro continui a servire i dati provenienti dallo storage del nodo compromesso. 
---
= Spegni il controller danneggiato in un sistema AFF A700 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni il controller guasto nel tuo sistema AFF A700 prima della sostituzione, utilizzando la procedura appropriata per la tua configurazione.
