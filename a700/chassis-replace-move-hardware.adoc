...
---
= Sostituisci lo chassis nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo sistema AFF A700 trasferendo gli alimentatori, le ventole e i moduli controller dallo chassis guasto a quello di ricambio.
