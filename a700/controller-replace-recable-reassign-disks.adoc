...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller del tuo sistema AFF A700 ricablando lo storage, ripristinando NetApp Storage Encryption (se necessario) e installando le licenze per il nuovo controller.
