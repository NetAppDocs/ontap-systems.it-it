...
summary: Per ripristinare il sistema AFF A700 al funzionamento completo, ricablare lo storage, ripristinare la configurazione NetApp Storage Encryption se necessario e installare le licenze per il nuovo controller. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller del tuo sistema AFF A700 ricablando lo storage, ripristinando la configurazione di NetApp Storage Encryption (se necessario) e installando le licenze per il nuovo controller.
