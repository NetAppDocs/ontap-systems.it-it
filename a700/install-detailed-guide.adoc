...
---
= Installa il tuo sistema storage AFF A700 utilizzando istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A700 seguendo le istruzioni dettagliate passo passo, dal montaggio nei rack e dal cablaggio fino alla messa in funzione iniziale del sistema.
