...
---
= Installa il tuo sistema storage AFF A700 usando le istruzioni video
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A700 seguendo le istruzioni video che mostrano come installare e cablare il tuo sistema.
