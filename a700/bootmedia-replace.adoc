...
summary: Sostituisci il supporto di avvio guasto su un sistema AFF A700. Il sistema AFF A700 supporta solo procedure manuali di ripristino del supporto di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Sostituisci il supporto di boot in un sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
