...
summary: Sostituire il supporto di avvio non riuscito su un modulo controller AFF A700 . Il sistema AFF A700 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
