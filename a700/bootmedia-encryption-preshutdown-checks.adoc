...
summary: Prima di arrestare il nodo danneggiato e verificare lo stato delle chiavi di crittografia integrate, è necessario controllare lo stato del nodo danneggiato, disabilitare il giveback automatico e verificare quale versione di ONTAP è in esecuzione sul sistema. Il sistema AFF A700 supporta solo procedure di ripristino manuale tramite supporti di avvio. 
---
= Verifica il supporto della crittografia sul supporto di avvio nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema di archiviazione, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Il sistema AFF A700 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
