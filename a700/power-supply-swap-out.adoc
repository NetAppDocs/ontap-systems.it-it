...
---
= Sostituisci a caldo l'alimentatore nel sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un alimentatore nel tuo sistema AFF A700 per mantenere un'alimentazione continua al sistema.
