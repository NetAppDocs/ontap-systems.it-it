...
summary: 'Dopo aver completato la sostituzione del supporto di avvio, eseguire l"operazione di switchback MetroCluster per riportare la configurazione al suo stato operativo normale. Il sistema AFF A700 supporta solo procedure manuali di ripristino del supporto di avvio.' 
---
= Commuta gli aggregati in una configurazione MetroCluster a due nodi per il tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
