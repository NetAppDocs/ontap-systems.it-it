...
summary: Ripristinare la crittografia sul supporto di avvio sostitutivo. Il sistema AFF A700 supporta solo procedure manuali di ripristino del supporto di avvio. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
