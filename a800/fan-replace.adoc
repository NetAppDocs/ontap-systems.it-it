...
---
= Sostituisci una ventola nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo ventola nel tuo sistema AFF A800 quando una ventola si guasta o non funziona in modo efficiente, per mantenere un raffreddamento adeguato e prevenire problemi di prestazioni del sistema.
