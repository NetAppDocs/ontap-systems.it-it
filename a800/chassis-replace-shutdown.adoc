...
summary: Per sostituire lo chassis, devi spegnere i controller. 
---
= Spegni i controller AFF A800 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere i controller nel sistema di archiviazione AFF A800 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
