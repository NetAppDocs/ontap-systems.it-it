...
---
= Sostituisci un'unità nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità nel tuo sistema AFF A800 quando un'unità si guasta o richiede un aggiornamento. Il processo di sostituzione prevede l'identificazione dell'unità difettosa, la sua rimozione sicura e l'installazione di una nuova unità per garantire l'accesso continuo ai dati e le prestazioni del sistema.
