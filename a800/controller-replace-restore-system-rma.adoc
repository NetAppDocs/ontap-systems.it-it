...
summary: Per ripristinare il sistema AFF A800 al funzionamento completo, ripristinare la configurazione NetApp Storage Encryption se necessario, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
