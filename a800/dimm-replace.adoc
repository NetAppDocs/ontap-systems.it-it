...
[role="lead"]
Sostituire un modulo DIMM nel sistema AFF A800 se vengono rilevati troppi errori di memoria correggibili o non correggibili. Tali errori possono impedire al sistema di archiviazione di avviare ONTAP. Il processo di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e la restituzione della parte guasta a NetApp.
