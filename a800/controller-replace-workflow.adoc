...
summary: Per iniziare, sostituisci il controller nel tuo sistema di archiviazione AFF A800 spegnendo il controller danneggiato, rimuovendolo e sostituendolo, riconfigurando le impostazioni di sistema e verificandone il funzionamento. 
---
= Flusso di lavoro di sostituzione del controller - AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema di archiviazione AFF A800 spegnendo il controller danneggiato, rimuovendo e sostituendo il controller, ripristinando la configurazione del sistema e restituendo il controllo delle risorse di archiviazione al controller sostitutivo.
