...
summary: Sostituire il modulo NVDIMM nel controller AFF A800 quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM identificato non è integro. La mancata sostituzione di un modulo NVDIMM difettoso può causare un system panic. 
---
= Sostituisci il modulo NVDIMM in un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo NVDIMM nel tuo sistema AFF A800 quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM identificato non è integro. Se non sostituisci un modulo NVDIMM difettoso, il sistema va in panic.

.Prima di iniziare
* Assicurati di avere il modulo NVDIMM sostitutivo che hai ricevuto da NetApp e che sia compatibile con il tuo sistema AFF A800.
* Assicurati che tutti gli altri componenti del sistema storage funzionino correttamente. Se non lo fanno, contatta il supporto NetApp.
