...
---
= Sostituisci a caldo un alimentatore nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un alimentatore nel tuo sistema AFF A800 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per eseguire questa sostituzione.
