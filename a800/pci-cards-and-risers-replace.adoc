...
---
= Sostituisci una scheda PCIe nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe nel tuo AFF A800 quando la scheda si guasta o necessita di un aggiornamento. La procedura di sostituzione prevede la disconnessione dei cavi e dei moduli SFP o QSFP, la sostituzione della scheda e il ricablaggio.

.Prima di iniziare
* È necessario avere a disposizione un pezzo di ricambio o un pezzo di ricambio NetApp .
* Assicurati che tutti gli altri componenti del sistema storage funzionino correttamente. In caso contrario, contatta il supporto tecnico.
...
Per sostituire una scheda PCIe, scollega il cablaggio e rimuovi eventuali QSFP e SFP dalle porte delle schede PCIe nel riser di destinazione, rimuovi il riser dal modulo controller, rimuovi e sostituisci la scheda PCIe, reinstalla il riser e tutti i QSFP e SFP sulle porte e ricabla le porte.
