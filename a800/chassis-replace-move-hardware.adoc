...
---
= Sostituisci lo chassis nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo che hai installato i moduli controller nel nuovo chassis, avvia lo chassis.

Per le coppie HA con due moduli controller nello stesso chassis, la sequenza di installazione dei moduli controller è particolarmente importante perché ciascun modulo tenta di riavviarsi non appena viene completamente inserito nello chassis.
...
Dopo aver sostituito il telaio AFF A800 danneggiato e reinstallato i componenti, è necessariolink:chassis-replace-complete-system-restore-rma.html["completare la sostituzione del telaio"]
