...
---
= Specifiche principali per un sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage AFF A800 in una singola coppia HA. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] per le specifiche complete di questo sistema storage.
...
* Versione minima ONTAP : ONTAP 9.4RC1
...
* Temperatura/altitudine/umidità di funzionamento: da 5°C a 40°C (da 41°F a 104°F) fino a 3048 m (10000 piedi) di altitudine; umidità relativa dall'8% al 90%, senza condensa
