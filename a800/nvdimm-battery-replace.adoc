...
[role="lead"]
Sostituisci la batteria NVDIMM nel tuo sistema AFF A800 quando inizia a scaricarsi o si guasta, perché preserva i dati di sistema critici durante le interruzioni di corrente. La procedura di sostituzione prevede la rimozione del modulo controller, la sostituzione della batteria e la reinstallazione del modulo controller.
