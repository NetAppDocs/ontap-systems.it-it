...
---
= Sostituisci la batteria NVDIMM nel tuo sistema AFF A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NV nel tuo sistema AFF A800 quando inizia a scaricarsi o si guasta, poiché preserva i dati di sistema critici durante le interruzioni di corrente. La procedura di sostituzione prevede la rimozione del modulo controller, la sostituzione della batteria e la reinstallazione del modulo controller.
