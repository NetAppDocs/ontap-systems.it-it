...
---
= Sostituisci a caldo un disco in un sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un disco nel tuo sistema AFF C800 quando un disco si guasta o necessita di un aggiornamento. La procedura di sostituzione prevede l'identificazione del disco guasto, la sua rimozione in sicurezza e l'installazione di un nuovo disco per garantire la continuità dell'accesso ai dati e le prestazioni del sistema.
