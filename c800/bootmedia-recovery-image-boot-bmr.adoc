...
summary: Dopo aver installato il nuovo supporto di boot nel sistema AFF C800, puoi avviare il processo automatico di ripristino del supporto di boot per ripristinare la configurazione dal nodo partner. 
---
= Ripristina l'immagine di avvio sul tuo sistema AFF C800 utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
