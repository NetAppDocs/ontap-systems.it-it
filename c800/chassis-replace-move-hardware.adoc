...
---
= Sostituisci lo chassis nel tuo sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il telaio AFF C800 danneggiato e reinstallato i componenti, è necessariolink:chassis-replace-complete-system-restore-rma.html["completare la sostituzione del telaio"]
