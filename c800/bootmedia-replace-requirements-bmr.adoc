...
summary: Prima di sostituire il supporto di avvio nel sistema AFF C800, assicurarsi di soddisfare i requisiti necessari per una sostituzione corretta. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
