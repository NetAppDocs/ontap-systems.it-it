...
summary: 'Mantieni l"hardware AFF C800' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mantieni l'hardware del tuo sistema di archiviazione AFF C800 per garantire affidabilità a lungo termine e prestazioni ottimali. Eseguite regolarmente attività di manutenzione, come la sostituzione di componenti difettosi, per prevenire tempi di inattività e perdite di dati.

Le procedure di manutenzione presuppongono che il sistema di archiviazione AFF C800 sia già stato implementato come nodo di archiviazione nell'ambiente ONTAP .
