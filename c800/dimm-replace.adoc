...
summary: Sostituire un modulo DIMM nel sistema AFF C800 se vengono rilevati errori di memoria correggibili o non correggibili in eccesso. Tali errori possono impedire al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM nel tuo sistema AFF C800 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un modulo DIMM nel sistema AFF C800 se vengono rilevati troppi errori di memoria correggibili o non correggibili. Tali errori possono impedire al sistema di archiviazione di avviare ONTAP. Il processo di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e la restituzione della parte guasta a NetApp.
