...
summary: 'Ripristinare la crittografia sul supporto di avvio sostitutivo del sistema AFF C800 per garantire una protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell"accesso sicuro ai dati.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF C800 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristinare la crittografia sul supporto di avvio sostitutivo del sistema AFF C800 per garantire una protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell'accesso sicuro ai dati.
