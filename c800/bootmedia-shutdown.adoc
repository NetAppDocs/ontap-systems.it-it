...
summary: Arresta il controller nel tuo sistema storage AFF C800 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio. 
---
= Arresta il controller nel tuo sistema AFF C800 durante il processo di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage AFF C800 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio.
