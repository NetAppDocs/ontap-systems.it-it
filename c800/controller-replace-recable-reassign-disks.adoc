...
---
= Ricable the system and reassign disks - AFF C800 (riscrivere il sistema e riassegnare i dischi)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
