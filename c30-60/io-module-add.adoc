...
summary: Aggiungi un modulo I/O al tuo sistema di archiviazione AFF C30 o AFF C60 per migliorare la connettività di rete ed espandere la capacità del tuo sistema di gestire il traffico dati. 
---
...
[role="lead"]
Aggiungi un modulo I/O al tuo sistema di archiviazione AFF C30 o AFF C60 per migliorare la connettività di rete ed espandere la capacità del tuo sistema di gestire il traffico dati.
