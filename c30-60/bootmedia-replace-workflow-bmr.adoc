...
summary: 'Il ripristino automatico dell"immagine di avvio prevede che il sistema identifichi e selezioni automaticamente l"opzione appropriata del menu di avvio. Utilizza l"immagine di avvio sul nodo partner per reinstallare ONTAP sul supporto di avvio sostitutivo del sistema di storage AFF C30 o AFF C60.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema AFF C30 o AFF C60 utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il ripristino automatico dell'immagine di avvio prevede che il sistema identifichi e selezioni automaticamente l'opzione appropriata del menu di avvio. Utilizza l'immagine di avvio sul nodo partner per reinstallare ONTAP sul supporto di avvio sostitutivo del sistema di storage AFF C30 o AFF C60.
...
[role="quick-margin-para"]
Rimuovi il supporto di avvio danneggiato dal modulo controller e installa il supporto di avvio sostitutivo.
