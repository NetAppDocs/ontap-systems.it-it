...
summary: 'Prima di sostituire il controller nel tuo sistema storage AFF C30 o AFF C60, assicurati di soddisfare i requisiti necessari per una sostituzione riuscita. Questo include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di avere il controller di ricambio corretto e il salvataggio dell"output della console del controller in un file di log.' 
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema storage AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
