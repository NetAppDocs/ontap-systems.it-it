...
summary: 'Sostituire un modulo ventola nel sistema AFF C30 o AFF C60 in caso di guasto o funzionamento non efficiente di una ventola, in quanto ciò può influire sul raffreddamento del sistema e sulle prestazioni generali. Il processo di sostituzione prevede l"arresto del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp.' 
---
...
[role="lead"]
Sostituire un modulo ventola nel sistema AFF C30 o AFF C60 in caso di guasto o funzionamento non efficiente di una ventola, in quanto ciò può influire sul raffreddamento del sistema e sulle prestazioni generali. Il processo di sostituzione prevede l'arresto del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp.
