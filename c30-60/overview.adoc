...
[role="lead"]
Queste sono alcune specifiche selezionate per i sistemi storage AFF C30 e AFF C60 in una singola coppia HA. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] per le specifiche complete di questi sistemi storage.
