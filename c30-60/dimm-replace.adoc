...
summary: Sostituire un modulo DIMM nel sistema di archiviazione AFF C30 o AFF C60 se vengono rilevati troppi errori di memoria correggibili o non correggibili.  Tali errori possono impedire al sistema di archiviazione di avviare ONTAP.  Il processo di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e la restituzione della parte guasta a NetApp. 
---
= Sostituisci un modulo DIMM nel tuo sistema storage AFF C30 o AFF C60 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un modulo DIMM nel sistema di archiviazione AFF C30 o AFF C60 se vengono rilevati troppi errori di memoria correggibili o non correggibili.  Tali errori possono impedire al sistema di archiviazione di avviare ONTAP.  Il processo di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e la restituzione della parte guasta a NetApp.

.Prima di iniziare
* Tutti gli altri componenti del sistema storage devono funzionare correttamente. In caso contrario, contatta https://mysupport.netapp.com/site/global/dashboard["Supporto NetApp"] prima di continuare.
...
Per sostituire un modulo DIMM, individua il modulo DIMM difettoso all'interno del controller.
