...
summary: 'Sostituire un DIMM nel modulo controller quando il sistema registra un numero crescente di codici di correzione degli errori correggibili (ECC); il mancato rispetto di questa precauzione causa il blocco del sistema.' 
---
