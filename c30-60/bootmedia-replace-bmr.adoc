...
summary: 'Il supporto di avvio del sistema di storage AFF C30 o AFF C60 memorizza firmware e dati di configurazione essenziali. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l"installazione del supporto di avvio sostitutivo e la successiva reinstallazione del modulo controller.' 
---
= Sostituisci il supporto di avvio nel tuo sistema storage AFF C30 o AFF C60 utilizzando la procedura di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
