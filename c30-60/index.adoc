...
---
= Manutenzione dell'hardware AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per i sistemi di storage AFF C30 o AFF C60, è possibile eseguire le procedure di manutenzione sui seguenti componenti.
