...
summary: 'Sostituisci un"unità di alimentazione CA o CC nel tuo sistema storage AFF C30 o AFF C60 quando si guasta o presenta un malfunzionamento, così il sistema continua a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"alimentatore difettoso dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"alimentatore difettoso e poi ricollegarlo alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore nel tuo sistema storage AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un alimentatore CA o CC (PSU) nel tuo sistema storage AFF C30 o AFF C60 quando si guasta o presenta malfunzionamenti, così il sistema continua a ricevere l'alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare la PSU difettosa dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire la PSU difettosa e poi ricollegarla alla fonte di alimentazione.
