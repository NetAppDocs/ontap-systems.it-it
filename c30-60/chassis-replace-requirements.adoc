...
summary: Prima di sostituire il telaio del sistema di archiviazione AFF C30 o AFF C60, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita.  Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre del telaio sostitutivo corretto e degli strumenti necessari. 
---
= Verifica i requisiti prima di sostituire il chassis AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il telaio del sistema di archiviazione AFF C30 o AFF C60, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita.  Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre del telaio sostitutivo corretto e degli strumenti necessari.
