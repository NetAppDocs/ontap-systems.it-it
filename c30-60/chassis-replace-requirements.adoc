...
summary: Prima di sostituire lo chassis del tuo sistema storage AFF C30 o AFF C60, assicurati di soddisfare i requisiti necessari per una sostituzione riuscita. Questo include la verifica che tutti gli altri componenti del sistema funzionino correttamente e che tu abbia lo chassis di ricambio corretto e gli strumenti necessari. 
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
