...
summary: 'Preparare l"installazione del sistema di storage AFF C30 o AFF C60 preparando il sito, disimballando le confezioni e confrontando il contenuto delle confezioni con il documento di trasporto e registrando il sistema di storage per accedere ai vantaggi del supporto.' 
---
= Preparati a installare il tuo sistema storage AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Preparare l'installazione del sistema di storage AFF C30 o AFF C60 preparando il sito, disimballando le confezioni e confrontando il contenuto delle confezioni con il documento di trasporto e registrando il sistema di storage per accedere ai vantaggi del supporto.
