...
---
= Specifiche principali per un sistema AFF C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage AFF C30 in una singola coppia HA. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema storage.
