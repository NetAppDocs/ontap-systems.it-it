...
summary: Sostituisci un modulo I/O nel tuo sistema di archiviazione AFF C30 o AFF C60 quando il modulo si guasta o richiede un aggiornamento per supportare prestazioni più elevate o funzionalità aggiuntive. La procedura di sostituzione prevede lo spegnimento del controller, la sostituzione del modulo I/O guasto, il riavvio del controller e la restituzione del componente guasto a NetApp. 
---
= Sostituisci un modulo I/O nel sistema storage AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[step-1-shut-down-the-controller-with-the-impaired-io-module]]
== Passaggio 1: Spegni il controller con il modulo I/O danneggiato

Spegni o esegui il takeover del controller con il modulo I/O danneggiato usando una delle seguenti opzioni.
