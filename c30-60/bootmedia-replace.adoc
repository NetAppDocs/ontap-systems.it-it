...
summary: 'Il supporto di avvio del sistema AFF C30 o AFF C60 memorizza i dati essenziali del firmware e della configurazione. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l"installazione del supporto di avvio sostitutivo e il trasferimento manuale dell"immagine ONTAP sul supporto di avvio sostitutivo tramite un"unità flash USB.' 
---
