...
summary: 'Sostituisci a caldo un disco nel tuo sistema storage AFF C30 o AFF C60 quando un disco si guasta o necessita di un upgrade. La procedura di sostituzione prevede l"identificazione del disco guasto, la sua rimozione in sicurezza e l"installazione di un nuovo disco per garantire la continuità dell"accesso ai dati e le prestazioni del sistema.' 
---
= Sostituisci a caldo un disco in un sistema AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se in precedenza in questa procedura è stata disattivata l'assegnazione automatica dell'unità, assegnare manualmente la proprietà dell'unità e quindi riattivare l'assegnazione automatica dell'unità se necessario:
+
