...
summary: Dopo aver collegato i controller alla rete e gli shelf del sistema storage AFF C30 o AFF C60, potrai accendere shelf e controller. 
---
= Accendi il tuo sistema storage AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
