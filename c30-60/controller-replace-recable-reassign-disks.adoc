...
summary: 'Restituire il controllo delle risorse di archiviazione al controller sostitutivo in modo che il sistema di archiviazione AFF C30 o AFF C60 possa riprendere il normale funzionamento.  La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema: nessuna crittografia, crittografia OKM di Onboard Key Manager o crittografia EKM di External Key Manager.' 
---
= Restituisci il controller nel tuo sistema storage AFF C30 o AFF C60 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituire il controllo delle risorse di archiviazione al controller sostitutivo in modo che il sistema di archiviazione AFF C30 o AFF C60 possa riprendere il normale funzionamento.  La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema: nessuna crittografia, crittografia Onboard Key Manager (OKM) o crittografia External Key Manager (EKM).
