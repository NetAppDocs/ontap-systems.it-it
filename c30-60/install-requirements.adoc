...
summary: 'Consulta i requisiti per l"installazione del tuo sistema storage AFF C30 o AFF C60, inclusi l"attrezzatura necessaria, le precauzioni per il sollevamento e le specifiche del sito, così l"installazione procede senza intoppi.' 
---
= Consulta i requisiti per l'installazione del tuo sistema storage AFF C30 e AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta i requisiti per l'installazione del tuo sistema storage AFF C30 o AFF C60, inclusi l'attrezzatura necessaria, le precauzioni per il sollevamento e le specifiche del sito, così l'installazione procede senza intoppi.
