...
summary: 'Dopo aver installato il nuovo dispositivo di supporto di avvio nel sistema AFF C30 o AFF C60, è possibile avviare manualmente l"immagine di ripristino da un"unità USB per ripristinare la configurazione dal nodo partner.' 
---
