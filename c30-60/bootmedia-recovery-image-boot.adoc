...
summary: 'Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema AFF C30 o AFF C60, è possibile avviare l"immagine di ripristino da un"unità USB e ripristinare la configurazione dal nodo partner.' 
---
...
[role="lead"]
Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema AFF C30 o AFF C60, è possibile avviare l'immagine di ripristino da un'unità USB e ripristinare la configurazione dal nodo partner.
