...
summary: 'Dopo aver installato l"hardware del sistema di storage AFF C30 o AFF C60, collegare i controller alla rete e agli shelf.' 
---
= Collega l'hardware AFF C30 e AFF C60 per la connettività di rete e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[Schema di cablaggio del cluster senza switch c30 e c60 utilizzando due moduli I/O 100Gbe]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[Schema di cablaggio del cluster senza switch c30 e c60 utilizzando un modulo I/O 100Gbe]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[Schema di cablaggio del cluster con switch c30 e c60 utilizzando due moduli I/O 100Gbe]
