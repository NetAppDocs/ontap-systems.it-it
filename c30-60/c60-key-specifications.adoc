...
---
= Specifiche principali per un sistema AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage AFF C60 in una singola coppia HA. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema storage.
