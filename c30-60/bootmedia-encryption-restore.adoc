...
summary: 'Ripristina la crittografia sul supporto di avvio sostitutivo del tuo sistema di archiviazione AFF C30 o AFF C60 per garantire la protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell"accesso sicuro ai dati.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema storage AFF C30 o AFF C60 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
