...
---
= Procedura di sostituzione del supporto di avvio per un sistema AFF C30 o AFF C60 utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Rimuovi il supporto di avvio guasto dal controller e installa il supporto di avvio sostitutivo, quindi trasferisci un'immagine ONTAP utilizzando una chiavetta USB.
