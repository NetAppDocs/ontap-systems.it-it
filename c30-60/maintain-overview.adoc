...
summary: 'Eseguire la manutenzione dell"hardware AFF C30 e AFF C60' 
---
...
[role="lead"]
Potrebbe essere necessario eseguire le procedure di manutenzione dell'hardware. Le procedure specifiche per la manutenzione dei componenti del sistema AFF C30 e AFF C60 sono descritte in questa sezione.
