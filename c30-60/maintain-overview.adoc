...
summary: 'Mantenete l"hardware del vostro sistema di storage AFF C30 o AFF C60 per garantirne l"affidabilità a lungo termine e prestazioni ottimali. Eseguite regolarmente attività di manutenzione, come la sostituzione di componenti difettosi, per prevenire tempi di inattività e perdite di dati.' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF C30 o AFF C60
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
