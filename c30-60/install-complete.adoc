...
summary: Dopo aver acceso il sistema di storage AFF C30 o AFF C60, è possibile rilevare una rete di cluster e configurare un cluster ONTAP. 
---
...
[role="lead"]
Dopo aver acceso il sistema di storage AFF C30 o AFF C60, è possibile rilevare una rete di cluster e configurare un cluster ONTAP.
