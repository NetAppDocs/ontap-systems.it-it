...
---
= Esamina i requisiti per la sostituzione di un controller in un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel tuo sistema AFF C190, verifica i prerequisiti per la procedura di sostituzione e seleziona quella corretta per la versione di ONTAP in uso.
