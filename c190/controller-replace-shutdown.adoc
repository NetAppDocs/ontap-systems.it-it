...
---
= Spegni il controller guasto in un sistema AFF C190 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni il controller guasto in un sistema AFF C190 per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il controller.
