...
---
= Completa la sostituzione dello chassis del tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis per il tuo sistema AFF C190 verificando lo stato HA dello chassis e restituendo il componente guasto a NetApp.
