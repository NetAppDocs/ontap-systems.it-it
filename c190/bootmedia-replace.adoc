...
summary: Sostituire il supporto di avvio non riuscito su un modulo controller AFF C190 . Il sistema AFF C190 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
