...
Dopo aver installato il modulo controller e qualsiasi altro componente nel nuovo chassis, è necessario avviarlo in uno stato in cui è possibile eseguire il test diagnostico di interconnessione.
