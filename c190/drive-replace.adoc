...
---
= Sostituisci a caldo un disco in un sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un disco guasto nel tuo sistema AFF C190 senza interrompere l'I/O. L'AFF C190 supporta sia dischi SSD che HDD, ognuno con una procedura di sostituzione dedicata.
