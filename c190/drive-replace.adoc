...
---
= Sostituisci un'unità nel tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un disco guasto nel tuo sistema AFF C190 senza interrompere l'I/O. AFF C190 supporta sia dischi SSD che HDD, ognuno con una procedura di sostituzione dedicata.
