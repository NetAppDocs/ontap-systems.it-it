...
---
= Sostituisci la batteria NVMEM nel tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema AFF C190 rimuovendo il modulo controller, aprendolo, sostituendo la batteria e reinstallando il modulo controller.
...
[NOTE]
====
Il LED NVRAM lampeggia durante il trasferimento dei contenuti nella memoria flash quando si arresta il sistema. Una volta completata la destage, il LED si spegne.
