...
---
= Ricable the system and reassign disks - AFF C190 (riscrivere il sistema e riassegnare i dischi)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Fase 2: Verifica della modifica dell'ID di sistema su un sistema ha
...
.
----
. Verificare che i volumi previsti siano presenti per ciascun controller: `vol show -node _node-name_`
