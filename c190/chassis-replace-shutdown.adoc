...
---
= Spegni i controller AFF C190 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta i controller in un sistema AFF C190 per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci lo chassis.
