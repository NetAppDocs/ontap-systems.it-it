...
summary: Verificare il supporto e lo stato della chiave di crittografia prima di spegnere il controller danneggiato su un sistema AFF C190 . Il sistema AFF C190 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Controlla il supporto della crittografia sul supporto di avvio in un AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
