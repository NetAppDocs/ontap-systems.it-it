...
summary: Ripristinare la configurazione di crittografia sul supporto di avvio sostitutivo per un sistema AFF C190 . Il sistema AFF C190 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
