...
summary: 'È necessario sostituire un DIMM nel controller quando il sistema storage riscontra errori quali un numero eccessivo di errori di correzione degli errori correggibili basati sugli avvisi di Health Monitor o errori ECC non correggibili, in genere causati dal guasto di un singolo DIMM che impedisce al sistema storage l"avvio di ONTAP.' 
---
= Sostituisci un modulo DIMM nel tuo sistema AFF C190 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
