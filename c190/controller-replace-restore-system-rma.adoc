...
---
= Completa la sostituzione del controller per il tuo sistema AFF C190
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller per il tuo sistema AFF C190 ripristinando la configurazione di crittografia dello storage NetApp (se necessario), installando le licenze per il nuovo controller e restituendo il componente guasto a NetApp.
