...
summary: 'Una volta verificate le variabili d"ambiente, è necessario completare i passaggi specifici per i sistemi che hanno Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE abilitati. Il sistema FAS9000 supporta solo procedure manuali di ripristino del supporto di avvio.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema FAS9000 completando i passaggi per il tuo tipo di key manager, come l'Onboard Key Manager (OKM). Il sistema FAS9000 supporta solo procedure manuali di ripristino del supporto di avvio.
