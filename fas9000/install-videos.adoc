...
---
= Installa un sistema storage FAS9000 usando le istruzioni video
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema FAS9000 seguendo le istruzioni video che mostrano come installare e cablare il sistema.
