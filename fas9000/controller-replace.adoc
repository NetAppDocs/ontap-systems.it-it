...
summary: 'Sostituisci l"hardware del modulo controller in un sistema FAS9000. Questa procedura include la rimozione del nodo danneggiato, lo spostamento dei componenti FRU sul modulo controller di ricambio, l"installazione del modulo controller di ricambio nello chassis e l"avvio del sistema in modalità Maintenance.' 
---
= Sostituisci il controller in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci l'hardware del modulo controller in un sistema FAS9000. Questa procedura include la rimozione del nodo danneggiato, lo spostamento dei componenti FRU sul modulo controller di ricambio, l'installazione del modulo controller di ricambio nello chassis e l'avvio del sistema in modalità Maintenance.
...
+
image::../media/drw_9000_remove_boot_dev.gif[Rimuovere il dispositivo di avvio]
...
+
image::../media/drw_9000_replace_pcm_dimms.png[Rimuovere i moduli DIMM del controller]
