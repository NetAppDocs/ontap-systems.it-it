...
summary: 'Puoi sostituire a caldo il modulo ventola in un sistema FAS9000 senza interrompere il servizio. Devi sostituire il modulo ventola entro due minuti dalla rimozione per evitare di interrompere il flusso d"aria del sistema.' 
---
= Sostituisci a caldo un modulo ventola in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo il modulo ventola in un sistema FAS9000 senza interrompere il servizio. Devi sostituire il modulo ventola entro due minuti dalla rimozione per evitare di interrompere il flusso d'aria del sistema.
