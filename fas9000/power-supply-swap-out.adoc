...
summary: Sostituire a caldo un alimentatore in un sistema FAS9000 senza interrompere il servizio. Questa procedura prevede di spegnere, scollegare e rimuovere il vecchio alimentatore, quindi installare, collegare e accendere il nuovo alimentatore. 
---
= Sostituisci a caldo un alimentatore in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire a caldo un alimentatore in un sistema FAS9000 senza interrompere il servizio. Questa procedura prevede di spegnere, scollegare e rimuovere il vecchio alimentatore, quindi installare, collegare e accendere il nuovo alimentatore.
