...
---
= Installa il tuo sistema FAS9000 seguendo le istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste istruzioni dettagliate, passo passo, ti guidano nell'installazione del tuo sistema FAS9000, dal montaggio in rack e cablaggio fino alla configurazione iniziale. Usa questi passaggi se vuoi una guida all'installazione più approfondita rispetto ai passaggi rapidi.
...
Puoi collegare il nuovo sistema ai moduli DS212C, DS224C o NS224, a seconda che si tratti di un sistema AFF o FAS.
...
Devi collegare ogni controller ai moduli NSM sullo shelf di dischi NS224 su un sistema AFF A700 o ASA AFF A700 che esegue ONTAP 9.8 o versioni successive.

* Questa attività si applica solo a ASA AFF A700 con ONTAP 9.8 o versione successiva.
* I sistemi devono avere almeno un modulo X91148A installato nello slot 3 o 7 per ciascun controller. L'animazione o le illustrazioni mostrano questo modulo installato in entrambi gli slot 3 e 7.
...
Devi collegare ciascun controller ai moduli NSM sugli shelf di dischi NS224 su un sistema AFF A700 o ASA AFF A700 con ONTAP 9.8 o versioni successive.
...
+
Se il sistema dispone di alloggiamenti per unità NS224, questi sono preimpostati con gli ID 00 e 01. Se vuoi modificare gli ID degli alloggiamenti, devi creare uno strumento da inserire nel foro in cui si trova il pulsante.
...
.. Seleziona *Network* nel riquadro a sinistra, fai clic con il pulsante destro del mouse su *Network* e poi seleziona *Refresh*.
.. Fare doppio clic sull'icona ONTAP e accettare i certificati visualizzati sullo schermo.
+

NOTE: Il valore visualizzato è il numero di serie del sistema per il nodo di destinazione.
