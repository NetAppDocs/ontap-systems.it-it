...
summary: Sostituisci un modulo I/O in un sistema FAS9000 utilizzando una sequenza specifica di operazioni supportata da tutte le versioni di ONTAP che il tuo sistema esegue. 
---
= Sostituisci un modulo I/O in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo I/O in un sistema FAS9000 utilizzando una sequenza specifica di operazioni supportata da tutte le versioni di ONTAP che il tuo sistema esegue.
