...
summary: Completa la sostituzione dello chassis in un sistema FAS9000 verificando lo stato HA dello chassis e restituendo la parte guasta a NetApp, come descritto nelle istruzioni RMA fornite con il kit. 
---
= Completa la sostituzione dello chassis per un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis in un sistema FAS9000 verificando lo stato HA dello chassis e restituendo la parte guasta a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
