...
---
= Sostituire il modulo di caching o aggiungere/sostituire un modulo di dump core - AFF A700 e FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Fase 1: Spegnimento del controller compromesso
...
| image:../media/legend_icon_01.png[""] | Pulsante di rilascio arancione. 
