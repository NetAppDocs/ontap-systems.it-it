...
summary: Per eseguire lo swap a caldo di un modulo di alimentazione del controller di destaggio DCPM, che contiene la batteria NVRAM10, è necessario individuare il modulo DCPM guasto, rimuoverlo dallo chassis e installare il modulo DCPM sostitutivo. 
---
= Sostituisci a caldo un modulo DCPM nel tuo sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
