...
summary: 'Sostituisci a caldo il modulo di alimentazione del controller di destage (DCPM), che contiene la batteria NVRAM10, in un sistema FAS9000 senza interrompere il servizio.' 
---
= Sostituisci a caldo un modulo DCPM in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo il modulo di alimentazione del controller di destage (DCPM), che contiene la batteria NVRAM10, in un sistema FAS9000 senza interrompere il servizio.
