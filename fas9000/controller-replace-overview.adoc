...
summary: Prima di sostituire il controller in un sistema FAS9000, controlla i prerequisiti per la procedura di sostituzione e scegli quella corretta per la tua versione di ONTAP. 
---
= Esamina i requisiti per la sostituzione di un controller in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller in un sistema FAS9000, controlla i prerequisiti per la procedura di sostituzione e scegli quella corretta per la tua versione di ONTAP.
