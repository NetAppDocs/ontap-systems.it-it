...
---
= Spegni il controller FAS9000 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di poter sostituire lo chassis, devi arrestare il controller danneggiato nel tuo sistema FAS9000.
