...
summary: 'Sostituisci un modulo NVRAM guasto o i DIMM all"interno del modulo NVRAM in un sistema FAS9000. Poiché l"ID di sistema deriva dal modulo NVRAM, la sostituzione del modulo riassegna i dischi appartenenti al sistema al nuovo ID di sistema.' 
---
= Sostituisci il modulo NVRAM o i DIMM NVRAM in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo NVRAM guasto o i DIMM all'interno del modulo NVRAM in un sistema FAS9000. Poiché l'ID di sistema deriva dal modulo NVRAM, la sostituzione del modulo riassegna i dischi appartenenti al sistema al nuovo ID di sistema.
