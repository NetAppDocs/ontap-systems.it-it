...
summary: Sostituisci la batteria del real-time clock nel modulo controller di un sistema FAS9000 così che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio real-time in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria real-time clock (RTC) nel modulo controller di un sistema FAS9000 così che i servizi e le applicazioni che dipendono da una sincronizzazione accurata dell'ora continuino a funzionare.
