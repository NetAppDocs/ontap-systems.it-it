...
summary: Sostituisci un modulo LED USB in un sistema FAS9000 senza interrompere il servizio. Il modulo fornisce connettività alle porte console e allo stato del sistema e non richiede attrezzi per la sostituzione. 
---
= Sostituisci a caldo un modulo LED USB in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo LED USB in un sistema FAS9000 senza interrompere il servizio. Il modulo fornisce connettività alle porte console e allo stato del sistema e non richiede attrezzi per la sostituzione.
