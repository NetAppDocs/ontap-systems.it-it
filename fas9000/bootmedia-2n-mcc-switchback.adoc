...
[role="lead"]
Dopo aver completato la sostituzione del supporto di avvio, eseguire l'operazione di switchback MetroCluster . Il sistema FAS9000 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
