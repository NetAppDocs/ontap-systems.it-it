...
---
= Avviare l'immagine di ripristino - FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La procedura per avviare il nodo danneggiato dall'immagine di ripristino varia a seconda che il sistema si trovi in ​​una configurazione MetroCluster a due nodi. Il sistema FAS9000 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
