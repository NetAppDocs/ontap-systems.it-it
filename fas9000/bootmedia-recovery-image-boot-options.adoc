...
summary: 'La procedura per avviare il nodo danneggiato dall"immagine di ripristino varia a seconda che il sistema si trovi in ​​una configurazione MetroCluster a due nodi. Il sistema FAS9000 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Avvia l'immagine di ripristino sul tuo sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato il supporto di boot sostitutivo nel tuo sistema FAS9000, avvia l'immagine di ripristino da un'unità USB. La procedura per avviare il controller guasto dipende dal fatto che il sistema sia in una configurazione MetroCluster a due nodi. Il sistema FAS9000 supporta solo procedure manuali di ripristino del supporto di boot.
