...
summary: Ricollega i cavi dello storage e conferma la riassegnazione dei dischi su un sistema FAS9000 così il controller sostitutivo può riprendere le normali operazioni. 
---
= Restituisci il controller in un sistema FAS9000 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ricollega i cavi dello storage e conferma la riassegnazione dei dischi su un sistema FAS9000 così il controller sostitutivo può riprendere le normali operazioni.
...
La procedura da utilizzare dipende dalla configurazione di ridondanza del controller.
...
--
.Opzione 2: MetroCluster a due nodi
--
=== Riassegnare manualmente l'ID di sistema sui sistemi in una configurazione MetroCluster a due nodi
