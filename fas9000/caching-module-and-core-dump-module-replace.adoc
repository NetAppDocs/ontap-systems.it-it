...
summary: 'Sostituisci il modulo di caching o il modulo di core dump in un sistema FAS9000 quando il sistema registra un singolo messaggio AutoSupport (ASUP) che segnala che il modulo è andato offline. Se non lo sostituisci, si verifica un peggioramento delle performance.' 
---
= Sostituisci il modulo di caching o il modulo core dump in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo di caching o il modulo di core dump in un sistema FAS9000 quando il sistema registra un singolo messaggio AutoSupport (ASUP) che segnala che il modulo è andato offline. Se non lo sostituisci, si verifica un peggioramento delle performance.
