...
summary: Sostituisci un modulo DCPM guasto in un sistema FAS9000. Il modulo deve essere sostituito nello chassis entro cinque minuti dalla rimozione, altrimenti il controller associato si spegne. 
---
= Sostituisci il modulo DCPM in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo DCPM guasto in un sistema FAS9000. Il modulo deve essere sostituito nello chassis entro cinque minuti dalla rimozione, altrimenti il controller associato si spegne.
