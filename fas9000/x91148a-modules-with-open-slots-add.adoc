...
summary: Aggiungi un modulo X91148A in uno slot modulo vuoto in un sistema FAS9000, utilizzandolo come NIC 100GbE o come modulo storage per shelf storage NS224. 
---
= Aggiungi un modulo X91148A a un sistema FAS9000 utilizzando uno slot aperto
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo X91148A in uno slot modulo vuoto in un sistema FAS9000, utilizzandolo come NIC 100GbE o come modulo storage per shelf storage NS224.
