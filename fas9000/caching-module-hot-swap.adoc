...
summary: Sostituisci a caldo il modulo di caching in un sistema FAS9000. A partire da ONTAP 9.4, puoi sostituire a caldo il modulo NVMe SSD Flash Cache, situato davanti al modulo NVRAM10 nello slot 6, con un modulo di caching della stessa capacità dello stesso fornitore supportato o di un fornitore diverso supportato. 
---
= Sostituisci a caldo un modulo di caching in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo il modulo di caching in un sistema FAS9000. A partire da ONTAP 9.4, puoi sostituire a caldo il modulo NVMe SSD Flash Cache, situato davanti al modulo NVRAM10 nello slot 6, con un modulo di caching della stessa capacità dello stesso fornitore supportato o di un fornitore diverso supportato.
