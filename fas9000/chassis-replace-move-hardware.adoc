...
summary: 'Sostituisci lo chassis in un sistema FAS9000 spostando le ventole, i dischi rigidi e il modulo o i moduli controller dallo chassis guasto a un nuovo chassis dello stesso modello, quindi sostituisci lo chassis guasto dal rack delle apparecchiature o dall"armadio di sistema.' 
---
= Sostituisci lo chassis in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis in un sistema FAS9000 spostando le ventole, i dischi rigidi e il modulo o i moduli controller dallo chassis guasto a un nuovo chassis dello stesso modello, quindi sostituisci lo chassis guasto dal rack delle apparecchiature o dall'armadio di sistema.
