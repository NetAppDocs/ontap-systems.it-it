...
summary: 'Per accedere ai componenti all"interno del controller, è necessario prima rimuovere il modulo controller dal sistema e poi rimuovere il coperchio sul modulo controller. Il sistema FAS9000 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Sostituisci il supporto di boot nel tuo sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire il supporto di avvio, è necessario rimuovere il modulo controller danneggiato, installare il supporto di avvio sostitutivo e trasferire l'immagine di avvio su un'unità flash USB. Il sistema FAS9000 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
