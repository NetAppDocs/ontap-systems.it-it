...
summary: 'Sostituisci il supporto di avvio in un sistema FAS9000 rimuovendo il modulo controller danneggiato, installando il supporto di avvio sostitutivo e trasferendo l"immagine di avvio su un"unità flash USB.' 
---
= Sostituisci il supporto di avvio in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il supporto di avvio in un sistema FAS9000 rimuovendo il modulo controller danneggiato, installando il supporto di avvio sostitutivo e trasferendo l'immagine di avvio su una chiavetta USB. Il sistema FAS9000 supporta solo il ripristino manuale del supporto di avvio; il ripristino automatico non è supportato.
