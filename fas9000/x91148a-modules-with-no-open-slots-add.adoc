...
summary: Rimuovi una o più schede di rete o moduli storage esistenti da un sistema FAS9000 completamente popolato per installare uno o più moduli storage X91148A. 
---
= Aggiungi un modulo storage X91148A a un sistema FAS9000 quando tutti gli slot sono occupati
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rimuovi una o più schede di rete o moduli storage esistenti da un sistema FAS9000 completamente popolato per installare uno o più moduli storage X91148A.
