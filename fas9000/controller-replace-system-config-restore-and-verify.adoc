...
summary: 'Dopo aver completato la sostituzione dell"hardware del controller e aver avviato il sistema FAS9000 in modalità Manutenzione, verifica la configurazione di basso livello del controller sostitutivo e riconfigura le impostazioni di sistema se necessario.' 
---
= Ripristina e verifica la configurazione del controller in un sistema FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware del controller e aver avviato il sistema FAS9000 in modalità Manutenzione, verifica la configurazione di basso livello del controller sostitutivo e riconfigura le impostazioni di sistema se necessario.
