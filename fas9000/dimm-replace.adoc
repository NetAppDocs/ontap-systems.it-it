...
summary: Sostituisci un DIMM in un sistema FAS9000 quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili tramite avvisi di Health Monitor o errori ECC non correggibili. Un DIMM difettoso può impedire al sistema storage di avviare ONTAP, quindi la sua sostituzione ripristina il funzionamento stabile. 
---
= Sostituisci un modulo DIMM in un sistema FAS9000 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM in un sistema FAS9000 quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili tramite avvisi di Health Monitor o errori ECC non correggibili. Un DIMM difettoso può impedire al sistema storage di avviare ONTAP, quindi la sua sostituzione ripristina il funzionamento stabile.
