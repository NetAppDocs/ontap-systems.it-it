...
summary: Arresta o prendi il controllo del controller danneggiato in un sistema FAS9000, utilizzando la procedura appropriata per la tua configurazione, così che il nodo funzionante continui a fornire dati dallo storage del nodo danneggiato. 
---
= Spegni il controller guasto in un sistema FAS9000 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni o assumi il controllo del controller danneggiato in un sistema FAS9000 utilizzando la procedura appropriata per la tua configurazione.
