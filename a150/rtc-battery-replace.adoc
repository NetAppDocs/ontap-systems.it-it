...
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema AFF A150 per garantire che i servizi e le applicazioni che si basano su una sincronizzazione oraria precisa continuino a funzionare.
