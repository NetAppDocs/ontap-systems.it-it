...
---
= Esamina i requisiti per la sostituzione del controller nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel tuo sistema AFF A150, assicurati di soddisfare i requisiti necessari per una sostituzione riuscita. Questo include la verifica che tutti gli shelf dei dischi funzionino correttamente, che il controller funzionante possa subentrare a quello guasto e che tu scelga la procedura di sostituzione corretta per la tua versione di ONTAP.
