...
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel tuo sistema AFF A150, assicurati di soddisfare i requisiti necessari per una sostituzione riuscita. Verifica che tutti gli shelf dei dischi funzionino correttamente, che il controller integro possa effettuare il takeover di quello guasto e che tu abbia selezionato la procedura di sostituzione corretta per la tua versione di ONTAP.
