...
summary: 'Sostituisci l"alimentatore nel tuo sistema AFF A150 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per eseguire questa sostituzione.' 
---
= Sostituisci a caldo un alimentatore in un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci l'alimentatore nel tuo sistema AFF A150 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per eseguire questa sostituzione.
