...
---
= Avvia l'immagine di ripristino sul tuo sistema AFF A150 utilizzando la procedura di ripristino manuale tramite avvio.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato il nuovo supporto di avvio nel tuo sistema AFF A150, avvia l'immagine di ripristino ONTAP da un'unità USB per ripristinare il file system e verificare le variabili ambientali.
