...
---
= Installa il tuo sistema AFF A150 seguendo le istruzioni video
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e collega il tuo sistema storage AFF A150 seguendo le istruzioni video passo passo.
