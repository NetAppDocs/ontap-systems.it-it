...
---
= Completa la sostituzione dello chassis per il tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Questa procedura completa la sostituzione dello chassis per il tuo sistema AFF A150 verificando lo stato HA, ripristinando gli aggregati e restituendo lo chassis a NetApp.
