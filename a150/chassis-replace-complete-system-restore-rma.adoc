...
[role="lead"]
Verifica lo stato HA dello chassis, ripristina gli aggregati e restituisci la parte guasta a NetApp per completare la sostituzione dello chassis del tuo sistema AFF A150.
