...
---
= Scegli come installare il tuo sistema storage AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Scegli il formato che preferisci per installare il tuo sistema storage AFF A150: istruzioni dettagliate passo passo, guida grafica rapida o istruzioni video.
