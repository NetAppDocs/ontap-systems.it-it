...
---
= Specifiche principali per un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esamina le specifiche selezionate del sistema storage AFF A150, che si riferiscono a una singola coppia ad alta disponibilità. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche di AFF A150.
