...
---
= Sostituisci un'unità nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità guasta nel tuo AFF A150 in modo non disruptivo mentre è in corso l'I/O per ripristinare la capacità di storage e le prestazioni.
