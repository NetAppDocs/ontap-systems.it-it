...
---
= Sostituisci a caldo un disco in un sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un'unità guasta nel tuo sistema AFF A150 senza interruzioni mentre l'I/O è in corso, per ripristinare la capacità e le prestazioni dello storage.
