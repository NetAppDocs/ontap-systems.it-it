...
---
= Installa il tuo sistema AFF A150 seguendo istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A150 seguendo queste istruzioni dettagliate passo passo, dalla preparazione del sito all'avvio del cluster ONTAP.
...
*Avvertenza:* Se stai installando ONTAP 9.13.1P8 - 9.13.1P11, ONTAP 9.14.1P1 - 9.14.1P7 o ONTAP 9.15.1 - 9.15.1P2 e il tuo sistema contiene 10 o più unità a stato solido interne, devi adottare ulteriori misure per preparare il sistema all'installazione. Vedi il problema  https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-285173["CONTAP-285173 - ADP non lascia una partizione root di riserva su un AFF A150 con 10 o più dischi interni"^].
...
** Cavi di rete aggiuntivi per collegare il tuo sistema allo switch di rete e al laptop o alla console con un browser web
** Un computer portatile o una console con connessione RJ-45 e accesso a un browser web
...
Installi il sistema in un rack a quattro montanti o in un armadio di sistema NetApp, a seconda dei casi.
...
--
Configurazioni di rete Ethernet:: Usa il cavo Cat 6 RJ45 per collegare le porte da e0c a e0f alla tua rete host, come mostrato nell'illustrazione seguente.
+
--
...
.. Seleziona *Network* nel riquadro a sinistra, fai clic con il pulsante destro del mouse e seleziona *refresh*.
