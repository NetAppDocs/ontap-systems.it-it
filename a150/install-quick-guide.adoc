...
---
= Installa il tuo sistema AFF A150 usando rapide istruzioni grafiche
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e collega il tuo sistema storage AFF A150 seguendo le rapide istruzioni grafiche.
