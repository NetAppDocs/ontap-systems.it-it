...
---
= Sostituisci un modulo DIMM nel tuo sistema AFF A150 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema AFF A150 quando il sistema storage rileva un numero eccessivo di errori di memoria correggibili (CECC) o non correggibili. Tali errori possono impedire al sistema storage di avviare ONTAP.
