...
summary: Per ripristinare il funzionamento completo del sistema, è necessario ripristinare la configurazione della NetApp Storage Encryption, installare le licenze per il nuovo controller e restituire il componente guasto a NetApp, come descritto nelle istruzioni RMA fornite con il kit. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
