...
---
= Sostituire un modulo DIMM - AFF A220 e FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Tornare a. link:dimm_replace.md["Sostituire i DIMM"] Di questa procedura per controllare nuovamente il LED NVMEM.
