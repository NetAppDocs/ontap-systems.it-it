...
---
= Sostituisci lo chassis nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo sistema AFF A150 quando un guasto hardware lo richiede. La procedura di sostituzione prevede lo spostamento degli alimentatori, delle unità disco e dei moduli controller dallo chassis guasto allo chassis di ricambio.
