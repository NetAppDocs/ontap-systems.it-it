...
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il boot media nel tuo sistema AFF A150 memorizza i dati essenziali del firmware e della configurazione. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del boot media danneggiato, l'installazione del nuovo boot media e poi il trasferimento dell'immagine ONTAP sul nuovo boot media usando una chiavetta USB.
