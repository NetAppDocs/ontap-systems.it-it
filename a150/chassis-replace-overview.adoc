...
---
= Esamina i requisiti per la sostituzione dello chassis nel tuo sistema AFF A150
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel tuo sistema AFF A150, assicurati di soddisfare i requisiti necessari per una sostituzione corretta. Questo include la verifica che tutti gli altri componenti del sistema funzionino correttamente e la consapevolezza che la procedura è dirompente e richiede lo spegnimento di entrambi i controller.
