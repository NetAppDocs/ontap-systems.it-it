---
permalink: asa800/chassis-replace-requirements.html 
sidebar: sidebar 
keywords: asa a800, replace the chassis 
summary: Prima di sostituire il telaio del sistema ASA A800, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita. Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del telaio sostitutivo corretto e degli strumenti necessari. 
---
= Rivedi i requisiti per la sostituzione di uno chassis in un sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il telaio del sistema ASA A800, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita. Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del telaio sostitutivo corretto e degli strumenti necessari.
