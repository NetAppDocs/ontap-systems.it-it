...
---
= Sostituisci a caldo un disco in un sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un drive nel tuo sistema ASA A800 quando un drive si guasta o necessita di un upgrade. Il processo di sostituzione prevede l'identificazione del drive guasto, la sua rimozione in sicurezza e l'installazione di un nuovo drive per garantire la continuità dell'accesso ai dati e le prestazioni del sistema.
