...
---
= Sostituisci lo chassis nel tuo sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il telaio ASA A800 danneggiato e reinstallato i componenti, è necessariolink:chassis-replace-complete-system-restore-rma.html["completare la sostituzione del telaio"]
