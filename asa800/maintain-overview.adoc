...
summary: 'Manutenzione dell"hardware ASA A800' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mantieni l'hardware del tuo sistema di archiviazione ASA A800 per garantire affidabilità a lungo termine e prestazioni ottimali. Eseguite regolarmente attività di manutenzione, come la sostituzione di componenti difettosi, per prevenire tempi di inattività e perdite di dati.

Le procedure di manutenzione presuppongono che il sistema di archiviazione ASA A800 sia già stato implementato come nodo di archiviazione nell'ambiente ONTAP .
...
Per il sistema storage ASA A800, è possibile eseguire le procedure di manutenzione sui seguenti componenti.
