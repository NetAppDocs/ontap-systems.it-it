...
summary: Per ripristinare il funzionamento completo del sistema, è necessario ripristinare la configurazione di NetApp Storage Encryption secondo necessità, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
