...
summary: 'Prima di sostituire il controller nel sistema AFF C80, assicurarsi di soddisfare i requisiti necessari per una sostituzione corretta. Ad esempio disporre del controller sostitutivo corretto, di un backup della configurazione del sistema e dell"accesso agli strumenti e al firmware necessari.' 
---
...
[role="lead"]
Prima di sostituire il controller nel sistema AFF C80, assicurarsi di soddisfare i requisiti necessari per una sostituzione corretta. Ad esempio disporre del controller sostitutivo corretto, di un backup della configurazione del sistema e dell'accesso agli strumenti e al firmware necessari.
...
Dopo aver esaminato i requisiti per sostituire il controller AFF C80, è necessario link:controller-replace-shutdown.html["spegnere i controller"].
