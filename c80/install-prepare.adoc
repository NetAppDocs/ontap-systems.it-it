...
---
= Preparati a installare il tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo che ti sei preparato per installare l'hardware AFF C80, link:install-hardware.html["Installazione dell'hardware per il sistema di storage AFF C80"].
