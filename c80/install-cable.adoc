...
---
= Collega l'hardware AFF C80 per la connettività di rete e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.A proposito di questa attività
Il sistema storage AFF C80 supporta gli shelf NS224 con il modulo NSM100 o NSM100B. Le principali differenze tra i moduli sono:
