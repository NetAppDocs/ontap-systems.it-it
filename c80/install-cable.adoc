...
--
Utilizzare il cavo 100 GbE per collegare le porte e1a ed e7a dei controller A e B agli switch di rete del cluster A e B. .Passaggi . Collegare la porta e1a sul Controller A e la porta e1a sul Controller B allo switch di rete del cluster A. Collegare la porta e7a sul Controller A e la porta e7a sul Controller B allo switch di rete del cluster B.
