...
summary: Completare il setup e la configurazione del sistema storage utilizzando il rilevamento del cluster solo in connessione con switch e laptop, oppure collegando direttamente a un controller del sistema storage e poi lo switch di gestione. 
---
= Configurazione e setup completi del sistema storage - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo l'accensione del sistema di storage AFF C80, sarai pronto per rilevare una rete di cluster e configurare un cluster ONTAP.
