...
summary: Sostituisci un modulo I/O nel tuo sistema AFF C80 quando il modulo si guasta o richiede un aggiornamento per supportare prestazioni superiori o funzionalità aggiuntive. 
---
= Sostituisci un modulo I/O nel tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo I/O nel tuo sistema AFF C80 quando il modulo si guasta o richiede un aggiornamento per supportare prestazioni più elevate o funzionalità aggiuntive. La procedura di sostituzione prevede lo spegnimento del controller, la sostituzione del modulo I/O guasto, il riavvio del controller e la restituzione del componente guasto a NetApp.  È possibile utilizzare questa procedura con tutte le versioni di ONTAP supportate dal sistema di archiviazione.
