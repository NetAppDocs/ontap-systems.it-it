...
summary: 'È necessario sostituire un"unità quando il sistema di archiviazione registra un messaggio di avviso alla console di sistema che indica che un"unità è guasta. Inoltre, sia il LED di guasto sul display operatore che il LED di guasto sul disco guasto si illuminano.' 
---
