...
---
= Sostituire il modulo controller - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema AFF C80 quando è necessario un errore hardware o un aggiornamento. Questo processo prevede la rimozione del controller danneggiato, lo spostamento dei componenti nel controller sostitutivo, l'installazione del controller sostitutivo e il riavvio del sistema.
