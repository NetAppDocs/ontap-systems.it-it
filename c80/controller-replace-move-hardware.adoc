...
sidebar: sidebar 
keywords: aff c80, move the controller module hardware 
...
---
= Sostituisci il controller nel tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il controller AFF C80 danneggiato, è necessariolink:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"] .
