...
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:system-management-replace.html["Modulo di gestione del sistema"]
 a| 
Il modulo di gestione del sistema fornisce l'interfaccia tra il controller e una console o un laptop per scopi di manutenzione del controller o del sistema.  Il modulo System Management contiene il supporto di avvio e memorizza il numero di serie del sistema (SSN).
