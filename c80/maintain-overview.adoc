...
---
= Eseguire la manutenzione dei sistemi di storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Le procedure di manutenzione presumono che i sistemi AFF C80 siano già stati implementati come nodo storage nell'ambiente ONTAP.
