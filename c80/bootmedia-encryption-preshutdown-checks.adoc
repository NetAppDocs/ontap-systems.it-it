...
---
= Verificare il supporto e lo stato della chiave di crittografia - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema di storage AFF C80, è necessario verificare il supporto e lo stato della chiave di crittografia. Verifica se la versione di ONTAP supporta la crittografia dei volumi di NetApp (NVE) e prima di arrestare il controller verifica se il gestore delle chiavi è attivo.
