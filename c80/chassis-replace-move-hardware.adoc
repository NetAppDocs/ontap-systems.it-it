...
summary: 'Sostituire lo chassis del sistema AFF C80 quando è necessario un errore hardware o un aggiornamento. Questo processo prevede lo spegnimento del sistema, la rimozione del telaio esistente, l"installazione del nuovo e la riconfigurazione dei componenti per garantire il corretto funzionamento del sistema.' 
---
...
[role="lead"]
Sostituire lo chassis del sistema AFF C80 quando è necessario un errore hardware o un aggiornamento. Questo processo prevede lo spegnimento del sistema, la rimozione del telaio esistente, l'installazione del nuovo e la riconfigurazione dei componenti per garantire il corretto funzionamento del sistema.
