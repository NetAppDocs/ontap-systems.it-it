...
sidebar: sidebar 
keywords: aff c80, replace a power supply 
summary: 'Sostituisci un"unità di alimentazione CA o CC nel tuo sistema AFF C80 quando si guasta o presenta un malfunzionamento, assicurandoti che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"unità di alimentazione difettosa dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"unità difettosa e quindi ricollegarla alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore nel tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
