...
summary: 'Come iniziare a sostituire i supporti di avvio nel sistema di storage AFF C80, preparare i supporti sostitutivi, installarli nel sistema, ripristinare l"immagine di avvio e verificare la funzionalità del sistema.' 
---
= Avvio rapido per la sostituzione dei supporti di avvio - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Come iniziare a sostituire i supporti di avvio nel sistema di storage AFF C80, preparare i supporti sostitutivi, installarli nel sistema, ripristinare l'immagine di avvio e verificare la funzionalità del sistema.
