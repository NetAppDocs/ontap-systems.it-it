...
summary: Arrestare il controller danneggiato nel sistema di archiviazione AFF C80 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio. 
---
