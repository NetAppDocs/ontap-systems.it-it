...
summary: Spegnere il controller danneggiato nel sistema di storage AFF C80 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del supporto di avvio. 
---
...
[role="lead"]
Spegnere il controller danneggiato nel sistema di storage AFF C80 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del supporto di avvio.
