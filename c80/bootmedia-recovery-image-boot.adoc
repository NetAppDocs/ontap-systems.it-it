...
summary: 'Se il supporto di avvio nel sistema AFF C80 è danneggiato, è possibile avviare l"immagine di ripristino da un"unità USB, ripristinare la configurazione dal nodo partner e verificare le variabili di ambiente' 
---
= Avviare l'immagine di ripristino - AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Se il supporto di avvio nel sistema AFF C80 è danneggiato, è possibile avviare l'immagine di ripristino da un'unità USB, ripristinare la configurazione dal nodo partner e verificare le variabili di ambiente.
