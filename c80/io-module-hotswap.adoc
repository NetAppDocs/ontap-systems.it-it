...
summary: È possibile eseguire lo swap a caldo di un modulo IO Ethernet nel sistema storage AFF C80 in caso di guasto di un modulo, a condizione che il sistema storage soddisfi tutti i requisiti della versione di ONTAP. 
---
= Sostituisci a caldo un modulo I/O nel tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFF C80 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
