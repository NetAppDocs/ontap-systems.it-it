...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFF C80 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
