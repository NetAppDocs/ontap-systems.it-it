...
+
image::../media/drw_a1k_70-90_power_source_icon_ieops-1700.svg[Schema di collegamento dell'alimentazione AFF A1K AFF A70 o AFF A90 o FAS70 o FAS90]
...
Dopo aver acceso il sistema di archiviazione AFF C80, https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura il tuo cluster"] .
