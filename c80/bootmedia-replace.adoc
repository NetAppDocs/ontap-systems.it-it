...
summary: Il supporto di avvio del sistema AFF C80 memorizza i dati di configurazione e il firmware essenziali. Se il supporto di avvio non funziona, è necessario scollegare il modulo controller, rimuovere il modulo di gestione del sistema, rimuovere il supporto di avvio danneggiato e installare il supporto di avvio sostitutivo nel modulo di gestione del sistema. 
---
...
[role="lead"]
Il supporto di avvio del sistema AFF C80 memorizza i dati di configurazione e il firmware essenziali. Se il supporto di avvio non funziona, è necessario scollegare il modulo controller, rimuovere il modulo di gestione del sistema, rimuovere il supporto di avvio danneggiato e installare il supporto di avvio sostitutivo nel modulo di gestione del sistema.
