...
summary: È possibile sostituire un modulo I/O guasto nel sistema storage AFF C80 con un modulo I/O dello stesso tipo o con un modulo I/O di tipo diverso. È inoltre possibile aggiungere un modulo I/O a un sistema con slot liberi. 
---
= Scopri come aggiungere e sostituire i moduli I/O nel tuo sistema storage AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
La sostituzione a caldo di un modulo I/O consente di sostituire un modulo guasto senza spegnere il sistema, riducendo al minimo i tempi di inattività e mantenendo la disponibilità del sistema.
