...
summary: Specifiche chiave per ASA A30 
---
= Specifiche principali per un sistema ASA A30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Di seguito sono riportate alcune specifiche per il sistema di archiviazione ASA A30 in una singola coppia ad alta disponibilità.  Per le specifiche complete di questo sistema di storage, visitare NetApp Hardware Universe (HWU).
...
* Configurazione della piattaforma: coppia HA a telaio singolo ASA A30
...
* Tipo: NAS
* Tipo: SAN; Coppie HA: 4; Capacità grezza: 4,4 PB / 3,9 PiB; Memoria massima: 512 GB
