...
image:../media/drw_A400_Replace-PCIe-cards_IEOPS-1008.svg["larghezza = 500 px"]
...
image::../media/drw_A400_Replace-mezz-card_IEOPS-1006.svg[Drw A400 Sostituisci la scheda di memoria IEOPS 1006]
