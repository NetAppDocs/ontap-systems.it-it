...
https://hwu.netapp.com/adapter/index["X91122A"]
 a| 
Modulo QSFP28 RoCE a 2 porte da 25 GbE
 a| 
* Networking
* HA/MetroCluster
...
https://hwu.netapp.com/Switch/Index["Switch Broadcom BES-53248 (X190005 e X190005R)"]
 a| 
Supporto dello switch di interconnessione cluster Broadcom BES-53248 per i controller AFF/FAS con porte 10/25 GbE.
 a| 
ONTAP 9.5P8
