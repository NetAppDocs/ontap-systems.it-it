...
Coppia HA
 a| 
link:controller_replace_complete_system_restoration.md#["Verifica della modifica dell'ID di sistema su un sistema ha"]
...
Standalone
 a| 
link:controller_replace_complete_system_restoration.md#["Riassegnazione manuale dell'ID di sistema su un sistema standalone in ONTAP"]
...
Configurazione MetroCluster a due nodi
 a| 
link:controller_replace_complete_system_restoration.md#["Riassegnazione manuale dell'ID di sistema sui sistemi in una configurazione MetroCluster a due nodi"]
