...
---
= Sostituisci un modulo I/O nel tuo sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire un modulo I/O nel tuo sistema FAS9500, devi arrestare il nodo guasto, rimuovere e installare il modulo I/O e poi riavviare il nodo.
