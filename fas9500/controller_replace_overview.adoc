...
---
= Esamina i requisiti per la sostituzione di un controller in un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* In questa procedura, il dispositivo di boot viene spostato dal nodo danneggiato al nodo sostitutivo in modo che quest'ultimo si avvii con la stessa versione di ONTAP del vecchio modulo controller.
