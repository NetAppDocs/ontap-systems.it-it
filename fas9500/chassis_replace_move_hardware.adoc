...
|===
 ...
 a| 
image:../media/legend_icon_01.svg["larghezza=20"]
 a| 
Pulsante di bloccaggio terracotta
 ...
 a| 
image:../media/legend_icon_02.svg["larghezza=20"]
 a| 
...
Dopo aver installato il modulo controller e qualsiasi altro componente nello chassis sostitutivo, avviarlo in uno stato in cui è possibile eseguire il test diagnostico di interconnessione.
