...
sidebar: sidebar 
keywords: fas9500, move hardware components, replace the chassis 
summary: Per sostituire il telaio, è necessario rimuovere i componenti dal telaio compromesso e installarli nel telaio sostitutivo. 
---
= Sostituisci lo chassis nel tuo sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Devi rimuovere i sei moduli delle ventole, situati nella parte anteriore dello chassis, quando sostituisci lo chassis.
...
. Metti da parte il modulo controller in un luogo sicuro e tieni traccia di da quale slot dello chassis proviene, così potrai installarlo nello stesso slot nel nuovo chassis.
...
Dopo aver installato il chassis di ricambio nel rack o nell'armadio di sistema, devi reinstallare al suo interno i moduli di alimentazione del controller di de-stage.
