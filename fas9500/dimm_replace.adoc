...
summary: È necessario sostituire un DIMM nel controller quando il sistema storage riscontra errori come un numero eccessivo di errori CECC basati sugli avvisi di Health Monitor o errori ECC non correggibili, in genere causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM nel tuo sistema FAS9500 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
