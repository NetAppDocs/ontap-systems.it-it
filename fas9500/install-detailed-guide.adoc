...
sidebar: sidebar 
keywords: FAS9500 
summary: Questa pagina fornisce istruzioni dettagliate passo passo per installare il tuo sistema FAS9500. 
---
= Installa un sistema storage FAS9500 seguendo le istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Questa pagina fornisce istruzioni dettagliate passo passo per installare il tuo sistema FAS9500. Usa queste istruzioni se vuoi istruzioni di installazione più dettagliate.
...
X66033A (112-00438), 3 m.
 a| 
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Connettore mini SAS]
 a| 
Storage
...
Collega le porte b lato host negli slot A4 e B4 (e4b) e negli slot A8 e B8 (e8b) allo switch host.
...
** Collega i cavi di alimentazione agli alimentatori e connettili a diverse fonti di alimentazione (non mostrate). PSU1 e PSU3 forniscono alimentazione a tutti i componenti del lato A, mentre PSU2 e PSU4 forniscono alimentazione a tutti i componenti del lato B.
...
* Assicurati di controllare la freccia nell'illustrazione per il corretto orientamento della linguetta di estrazione del connettore del cavo. La linguetta di estrazione del cavo per i moduli di storage è rivolta verso l'alto, mentre le linguette di estrazione sui shelf sono rivolte verso il basso.
...
.Fasi
. Usa la seguente animazione o i seguenti schemi per collegare i tuoi controller a tre shelf di dischi DS224C (uno stack con uno shelf di dischi e uno stack con due shelf di dischi).
+
...
+
image::../media/drw_a900_power-on_IEOPS-941.svg[Accendere il sistema]
