...
summary: Prima di sostituire il supporto di avvio nel sistema FAS9500 , accertarsi di soddisfare i requisiti necessari per una sostituzione corretta. 
---
= Requisiti per il ripristino automatico dei supporti di avvio - FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
