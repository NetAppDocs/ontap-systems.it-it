...
summary: 'Sostituire la batteria dell"orologio in tempo reale nel modulo controller.' 
---
= Sostituisci la batteria dell'orologio in real-time nel tuo sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_9500_remove_RTC_battery.svg[Sostituire la batteria RTC]
...
Dopo aver sostituito la batteria RTC, devi reinstallare il modulo controller. Se la batteria RTC è rimasta fuori dal modulo controller per più di 10 minuti, potresti dover reimpostare l'ora e la data.
