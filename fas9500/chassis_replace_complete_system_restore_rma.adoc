...
---
= Completa la sostituzione dello chassis del tuo sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per completare la sostituzione dello chassis nel tuo sistema FAS9500, devi verificare e impostare lo stato HA dello chassis, riavviare il sistema e restituire lo chassis a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
