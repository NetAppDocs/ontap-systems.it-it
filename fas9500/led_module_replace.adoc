...
---
= Sostituisci a caldo un modulo LED USB in un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il modulo LED USB nel tuo sistema FAS9500 fornisce connettività alle porte della console e allo stato del sistema. La sostituzione non richiede attrezzi e non interrompe il servizio.
...
+
.. Allinea il modulo all'alloggiamento con l'incavo nell'angolo del modulo posizionato vicino al fermo scorrevole sul chassis. L'alloggiamento impedisce di installare il modulo capovolto.
.. Spingere il modulo nell'alloggiamento fino a posizionarlo completamente a filo con lo chassis.
+
Il modulo emette un clic udibile quando è fissato correttamente e connesso al midplane.
