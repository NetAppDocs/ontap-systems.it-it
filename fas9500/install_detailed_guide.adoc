...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[drw autodiscovery controler selezionare ieops 1849]

+
.. Aprire file Explorer.
.. Fare clic su rete nel riquadro sinistro, quindi fare clic con il pulsante destro del mouse e selezionare Aggiorna.
