...
NOTE: Per ulteriori informazioni sul cablaggio SAS e per i fogli di lavoro, vedere https://docs.netapp.com/us-en/ontap-systems/sas3/overview-cabling-rules-examples.html["Panoramica su regole di cablaggio SAS, fogli di lavoro ed esempi: Shelf con moduli IOM12"^]

.Prima di iniziare
* Completare la scheda di lavoro relativa al cablaggio SAS del sistema. Vedere https://docs.netapp.com/us-en/ontap-systems/sas3/overview-cabling-rules-examples.html["Panoramica su regole di cablaggio SAS, fogli di lavoro ed esempi: Shelf con moduli IOM12"^].
