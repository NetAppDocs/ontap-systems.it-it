...
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema FAS9500 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver sostituito il supporto di avvio nel tuo sistema FAS9500, ripristina la crittografia completando i passaggi previsti per il tuo tipo di key manager, come l'Onboard Key Manager (OKM).
