...
summary: 'Dopo aver sostituito l"hardware e aver avviato la modalità di manutenzione, verificare la configurazione di sistema di basso livello del controller sostitutivo e riconfigurare le impostazioni di sistema secondo necessità.' 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware, verifichi la configurazione di basso livello del sistema del controller sostitutivo, inclusi l'orario di sistema e lo stato HA, e riconfiguri le impostazioni di sistema se necessario.
