...
+
image::../media/drw_9500_move-remove_NVRAM_module.svg[Drw 9500 spostare rimuovere il modulo NVRAM]
...
+
image::../media/drw_9500_remove_NVRAM_module_contents.svg[Drw 9500 rimuovere il contenuto del modulo NVRAM]
...
IMPORTANT: Questa operazione non si applica alla sostituzione del DIMM NVRAM.
