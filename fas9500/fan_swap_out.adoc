...
---
= Sostituisci a caldo un modulo ventola in un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire a caldo un modulo ventola nel tuo sistema FAS9500 senza interrompere il servizio, devi eseguire una sequenza specifica di operazioni.


IMPORTANT: È best practice sostituire il modulo ventola entro due minuti dalla sua rimozione dallo chassis. Il sistema continua a funzionare, ma ONTAP invia messaggi alla console relativi al modulo ventola danneggiato fino alla sua sostituzione.
