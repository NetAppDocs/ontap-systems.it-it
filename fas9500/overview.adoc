...
---
= Specifiche chiave per un sistema FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esamina le specifiche selezionate per il sistema storage FAS9500 in una singola coppia HA e visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche del FAS9500.
...
* Temperatura/altitudine/umidità di funzionamento: da 10°C a 35°C (da 50°F a 95°F) fino a 3048 m (10000 piedi) di altitudine; umidità relativa dall'8% al 90%, senza condensa
