...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema ASA C250 in modalità di manutenzione, è necessario verificare la configurazione di sistema di basso livello del controller sostitutivo e riconfigurare le impostazioni di sistema secondo necessità.
