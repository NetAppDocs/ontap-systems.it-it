...
summary: 'Inizia a sostituire il boot media nel tuo sistema storage ASA C250 esaminando i requisiti di sostituzione, spegnendo il controller, sostituendo il boot media, ripristinando l"immagine sul boot media e verificando la funzionalità del sistema.' 
---
= Flusso di lavoro per la sostituzione del supporto di avvio per un sistema ASA C250 utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
