...
summary: Per completare la sostituzione del controller per il sistema ASA C250 e ripristinarne il pieno funzionamento, è necessario ripristinare la configurazione di NetApp Storage Encryption secondo necessità, installare le licenze per il nuovo controller e restituire il componente guasto a NetApp, come descritto nelle istruzioni RMA fornite con il kit. 
---
= Completa la sostituzione del controller per il tuo sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per completare la sostituzione del controller per il sistema ASA C250 e ripristinarne la piena operatività, è necessario ripristinare la configurazione di NetApp Storage Encryption (se necessario), installare le licenze per il nuovo controller e restituire la parte guasta a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
