...
summary: 'Sostituire un alimentatore nel sistema ASA C250 scollegando l"alimentatore di destinazione dalla fonte di alimentazione, scollegando il cavo di alimentazione, rimuovendo la vecchia unità, installando l"unità di ricambio e quindi ricollegandola alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore in un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
