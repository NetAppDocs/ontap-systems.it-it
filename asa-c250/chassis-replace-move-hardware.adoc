...
summary: 'Sostituire lo chassis nel sistema ASA C250 quando un guasto hardware lo richiede. La procedura di sostituzione prevede la rimozione dei controller e degli alimentatori, la rimozione delle unità disco, l"installazione del nuovo chassis e la reinstallazione dei componenti dello chassis.' 
---
= Sostituisci lo chassis nel tuo sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
