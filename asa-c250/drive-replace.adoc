...
summary: 'Sostituisci un drive nel tuo sistema ASA C250 quando la piattaforma registra un messaggio di avviso nella console di sistema che indica che un drive ha avuto un guasto. Inoltre, sia il LED di errore sul pannello di visualizzazione dell"operatore sia il LED di errore sul drive guasto sono accesi.' 
---
= Sostituisci un'unità nel tuo sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un disco nel tuo sistema ASA C250 quando un disco si guasta. La procedura di sostituzione prevede l'identificazione del disco guasto, la sua rimozione in sicurezza e l'installazione di un nuovo disco per garantire la continuità dell'accesso ai dati e le prestazioni del sistema.
