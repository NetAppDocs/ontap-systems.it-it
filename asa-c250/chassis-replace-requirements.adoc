...
summary: Prima di sostituire lo chassis nel sistema ASA C250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, dello chassis di ricambio corretto e degli strumenti necessari. 
---
= Controlla i requisiti prima di sostituire lo chassis in un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel sistema ASA C250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, dello chassis di ricambio corretto e degli strumenti necessari.
