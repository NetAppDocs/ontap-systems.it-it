...
summary: Per sostituire una batteria NVMEM in un sistema ASA C250, devi rimuovere il modulo controller dal sistema, aprirlo, sostituire la batteria, quindi richiudere e riposizionare il modulo controller. 
---
= Sostituisci la batteria NVMEM in un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire una batteria NVMEM in un sistema ASA C250, devi rimuovere il modulo controller dal sistema, aprirlo, sostituire la batteria, quindi richiudere e riposizionare il modulo controller.
