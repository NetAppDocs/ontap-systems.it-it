...
summary: Sostituisci una ventola in un sistema ASA C250 rimuovendo il modulo ventola guasto e sostituendolo con un nuovo modulo ventola. 
---
= Sostituisci una ventola in un sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una ventola in un sistema ASA C250 rimuovendo il modulo ventola guasto e sostituendolo con un nuovo modulo ventola.
