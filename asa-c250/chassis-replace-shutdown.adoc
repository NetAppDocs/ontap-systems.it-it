...
---
= Spegni i controller ASA C250 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta i controller nel sistema storage AFF ASA C250 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
...
Dopo aver spento il controller, è necessario link:chassis-replace-move-hardware.html["Spostare l'hardware sul nuovo chassis"]
