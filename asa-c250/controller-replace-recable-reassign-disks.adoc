...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema ASA C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato il ripristino e la verifica della configurazione del sistema ASA C250, è necessario ricollegare il sistema e riassegnare i dischi.
