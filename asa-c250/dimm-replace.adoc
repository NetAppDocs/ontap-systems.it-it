...
summary: Sostituisci un DIMM in un sistema ASA C250 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili o errori ECC non correggibili. Se non sostituisci un DIMM difettoso, il sistema può andare in panic. 
---
= Sostituisci un modulo DIMM in un sistema ASA C250 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM in un sistema ASA C250 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili o errori ECC non correggibili. Se non sostituisci un DIMM difettoso, il sistema può andare in panic.
