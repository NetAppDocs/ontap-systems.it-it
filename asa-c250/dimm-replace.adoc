...
summary: Sostituisci un DIMM nel modulo controller ASA C250 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili o errori ECC non correggibili. La mancata sostituzione di un DIMM difettoso può causare un blocco del sistema. 
---
= Sostituisci un modulo DIMM nel tuo sistema ASA C250 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
