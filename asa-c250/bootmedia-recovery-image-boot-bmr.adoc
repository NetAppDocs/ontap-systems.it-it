...
summary: Dopo aver installato il nuovo dispositivo di boot media nel sistema ASA C250, è possibile avviare il processo di ripristino automatico del boot media per ripristinare la configurazione dal nodo partner. 
---
