...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema ASA A150 possa riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema ASA A150 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
