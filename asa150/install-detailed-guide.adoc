...
summary: 'Questi passaggi dettagliati ti guidano nell"installazione del tuo sistema ASA A150, inclusa la preparazione all"installazione, l"installazione dell"hardware, il cablaggio dei controller e il completamento della configurazione.' 
---
= Installa il tuo sistema storage ASA A150 con istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
