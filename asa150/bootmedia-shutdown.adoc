...
summary: Arresta il controller nel tuo sistema storage ASA A150 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot. 
---
= Spegni il controller nel tuo sistema ASA A150 prima di sostituire il supporto di avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage ASA A150 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot.
