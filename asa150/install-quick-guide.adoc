...
summary: 'Questi semplici passaggi forniscono istruzioni grafiche per l"installazione del sistema ASA A150, dal montaggio in rack e dal cablaggio fino all"avvio iniziale del sistema.' 
---
= Installa il tuo sistema storage ASA A150 in pochi semplici passaggi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
