...
---
= Sostituire un DIMM - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Il numero e la posizione dei moduli DIMM nel sistema dipendono dal modello del sistema. Per ulteriori informazioni, fare riferimento alla mappa FRU sul condotto dell'aria.
