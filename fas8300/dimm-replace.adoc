...
summary: Devi sostituire il DIMM nel controller quando il tuo sistema storage riscontra errori come errori di memoria ECC correggibili eccessivi o errori ECC non correggibili, tipicamente causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM in un sistema FAS8300 o FAS8700 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire il DIMM nel controller quando il tuo sistema storage riscontra errori come errori di memoria ECC correggibili eccessivi, segnalati dagli avvisi di Health Monitor, o errori ECC non correggibili. Questi errori sono di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.
