...
---
= Panoramica della sostituzione del modulo controller - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Il _nodo sostitutivo_ è il nuovo controller che sostituisce il controller compromesso.
