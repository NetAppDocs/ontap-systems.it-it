...
summary: Sostituire il controller nel sistema FAS8300 o FAS8700 quando un guasto hardware lo richiede. Rimuovere il controller guasto, trasferire i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo. 
---
= Sostituisci il controller nel tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema FAS8300 o FAS8700 quando un guasto hardware lo richiede. Rimuovere il controller guasto, trasferire i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo.


NOTE: Il modulo controller Ver2 nel FAS8300 ha un solo socket per modulo di caching (Slot 6). FAS8700 non ha un modulo controller Ver2. La funzionalità del modulo di caching non è influenzata dalla rimozione del socket.
...
Spostare i riser PCIe e la scheda mezzanine sul modulo controller di ricambio.
...
== Passaggio 6: Spostare il modulo cache

Spostare il modulo cache sul modulo controller sostitutivo.
...
Dopo aver sostituito il controller FAS8300 o FAS8700 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
