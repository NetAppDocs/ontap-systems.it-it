...
È possibile utilizzare le seguenti animazioni, illustrazioni. Oppure i passaggi scritti per spostare i riser PCIe e la scheda mezzanine dal modulo controller guasto al modulo controller sostitutivo.
