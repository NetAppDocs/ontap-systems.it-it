...
summary: Dopo aver installato il nuovo dispositivo di boot nel tuo sistema FAS8300 o FAS8700, puoi avviare il processo automatico di ripristino del boot media per ripristinare la configurazione dal nodo partner. 
---
= Avvia l'immagine di ripristino sul tuo sistema FAS8300 o FAS8700 utilizzando il processo di ripristino automatico all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
