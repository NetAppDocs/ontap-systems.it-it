...
summary: Arresta il controller nel tuo sistema storage FAS8300 o FAS8700 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio. 
---
= Arresta il controller nel tuo sistema FAS8300 o FAS8700 durante il processo di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage FAS8300 o FAS8700 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio.
...
Dopo aver completato le attività NVE o NSE, spegni il controller.
