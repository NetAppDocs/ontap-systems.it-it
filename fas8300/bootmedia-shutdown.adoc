...
---
= Arresta il controller danneggiato nel tuo sistema FAS8300 o FAS8700 durante il processo di ripristino manuale dal menu di boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato le attività NVE o NSE, spegni o prendi il controllo del controller danneggiato utilizzando la procedura appropriata per la tua configurazione.
...
Dopo aver completato le attività NVE o NSE, spegni il controller difettoso.
