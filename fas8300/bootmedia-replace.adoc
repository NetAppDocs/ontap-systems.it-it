...
sidebar: sidebar 
keywords: fas8300, fas8700, locate, boot, media, controller, module, fre, map, direction, replace, replace the boot media 
...
---
= Sostituisci il supporto di avvio in un sistema FAS8300 o FAS8700 utilizzando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Prima di iniziare
Sebbene il contenuto del supporto di avvio sia crittografato, è best practice cancellarne il contenuto prima di sostituirlo. Per ulteriori informazioni, consulta la  https://mysupport.netapp.com/info/web/ECMP1132988.html["Dichiarazione di volatilità"] per il tuo sistema sul sito di supporto NetApp.
