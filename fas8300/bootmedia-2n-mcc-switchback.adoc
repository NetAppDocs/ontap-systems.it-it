...
summary: 'Dopo aver completato la sostituzione dell"FRU in una configurazione MetroCluster a due nodi, è possibile eseguire l"operazione di switchback MetroCluster. Questa operazione riporta la configurazione al suo stato operativo normale, con le macchine virtuali di storage di origine di sincronizzazione nel sito precedentemente interessato ora attive e che forniscono dati dai pool di dischi locali.' 
---
= Commuta di nuovo gli aggregati in una configurazione MetroCluster a due nodi in un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
