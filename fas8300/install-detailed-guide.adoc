...
---
= Installa un sistema FAS8300 o FAS8700 seguendo istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste istruzioni dettagliate, passo passo, ti guidano nell'installazione del tuo sistema FAS8300 o FAS8700, dal montaggio in rack e cablaggio fino alla configurazione iniziale. Usa questi passaggi se vuoi una guida all'installazione più approfondita rispetto a quella fornita dai passaggi rapidi.
...
NOTE: In questo esempio, XXXXX rappresenta il numero di serie del sistema per il nodo di destinazione.
