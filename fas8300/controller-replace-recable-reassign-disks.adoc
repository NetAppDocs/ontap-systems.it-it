...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che i sistemi FAS8300 e FAS8700 possano riprendere il normale funzionamento. 
---
= Restituire il controller - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituire il controllo delle risorse di storage al controller sostitutivo in modo che i sistemi FAS8300 e FAS8700 possano riprendere il normale funzionamento.
