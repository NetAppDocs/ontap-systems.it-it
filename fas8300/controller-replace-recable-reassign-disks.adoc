...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo così il tuo sistema FAS8300 o FAS8700 può riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema FAS8300 o FAS8700 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo così il tuo sistema FAS8300 o FAS8700 può riprendere il normale funzionamento.
