...
---
= Spostare e sostituire l'hardware - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver installato i moduli controller nel nuovo chassis, è necessario avviarlo in uno stato in cui è possibile eseguire il test diagnostico.
