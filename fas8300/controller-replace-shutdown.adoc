...
summary: Arresta il controller nel tuo sistema storage FAS8300 o FAS8700 per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il controller. 
---
= Spegni il controller danneggiato nel tuo sistema FAS8300 o FAS8700 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage FAS8300 o FAS8700 per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il controller.
...
Dopo aver spento i controller FAS8300 e FAS8700, è necessario link:controller-replace-move-hardware.html["sostituire la centralina"].
