...
summary: Arresta il controller nel tuo sistema storage FAS8300 e FAS8700 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del controller. 
---
= Spegnere il controller compromesso - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage FAS8300 e FAS8700 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del controller.
