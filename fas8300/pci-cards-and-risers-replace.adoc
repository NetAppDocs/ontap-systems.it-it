...
---
= Sostituisci una scheda PCIe o mezzanine nel tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Solleva il supporto verticalmente e mettilo da parte su una superficie stabile e piana.
...
. Installa la scheda PCIe sostitutiva nel riser allineando la scheda con lo zoccolo, premendo la scheda nello zoccolo e poi chiudendo il pannello laterale del riser, se presente.
+
