...
---
= Sostituisci a caldo un modulo ventola in un sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un modulo ventola nel tuo sistema FAS8300 o FAS8700 senza interrompere il servizio. Per evitare il surriscaldamento, devi sostituire il modulo ventola entro due minuti dalla sua rimozione dallo chassis.
...
+
Utilizzare il messaggio BMC o il LED di attenzione per identificare il modulo ventola da sostituire. BMC mappa i moduli ventola come Fan#_#, dove il primo numero indica lo slot e il secondo la riga (1=superiore, 2=inferiore); ad esempio, slot 1, seconda riga = Fan1_2.
...
+
Il LED di attenzione si spegne dopo che la ventola si è posizionata correttamente e ha raggiunto la velocità operativa.
