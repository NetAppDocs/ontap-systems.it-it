...
---
= Sostituisci a caldo l'alimentatore nel tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
L'alimentatore si innesta nel connettore interno e si blocca in posizione in un solo modo.
