...
---
= Sostituisci lo chassis nel tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se non si è già collegati a terra, mettere a terra l'utente.
. Con l'aiuto di due persone, installa il chassis nel rack delle apparecchiature o nell'armadio di sistema guidando il chassis sulle guide del rack nel sistema cabinet o nel rack delle apparecchiature.
...
Per le coppie HA con due moduli controller nello stesso chassis, installa i moduli controller nella sequenza corretta. Ogni controller tenta di riavviarsi non appena è completamente inserito nello chassis.
