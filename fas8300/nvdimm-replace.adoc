...
---
= Sostituire un modulo NVDIMM - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per sostituire il modulo NVDIMM, individuarlo nel modulo controller utilizzando la mappa FRU sulla parte superiore del condotto dell'aria della mappa FRU sulla parte superiore del riser dello slot 1.
