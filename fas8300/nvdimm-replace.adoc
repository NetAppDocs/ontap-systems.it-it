...
summary: È necessario sostituire il modulo NVDIMM nel controller quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM identificato non è in buone condizioni generali. 
---
= Sostituisci il modulo NVDIMM nel tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per sostituire il modulo NVDIMM, devi individuarlo nel modulo controller utilizzando la mappa FRU presente sulla parte superiore del riser dello slot 1.
...
* Sebbene il contenuto dell'NVDIMM sia crittografato, è best practice cancellarne il contenuto prima di sostituirlo. Per ulteriori informazioni, consulta l' https://mysupport.netapp.com/info/web/ECMP1132988.html["Dichiarazione di volatilità"]articolo sul sito di supporto NetApp.
+
...
+
Il modulo NVDIMM si inserisce saldamente nello slot, ma dovrebbe entrare facilmente. Se non entra, riallinea il modulo NVDIMM con lo slot e reinseriscilo.
