...
---
= Specifiche chiave per un sistema FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esamina le specifiche selezionate del sistema storage FAS8700 in una singola coppia ad alta disponibilità (HA) e visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema.
