...
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema FAS8300 o FAS8700 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo che hai sostituito il boot media nel tuo sistema FAS8300 o FAS8700, ripristina la crittografia completando i passaggi previsti per il tuo tipo di key manager, come ad esempio l'Onboard Key Manager (OKM).
