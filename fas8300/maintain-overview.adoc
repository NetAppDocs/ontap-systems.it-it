...
sidebar: sidebar 
keywords: fas8300 maintenance, fas8700 maintenance, maintenance, repairing fas8300, repairing fas8700, replace fas8300 components, replace fas8700 components 
summary: 'Mantieni l"hardware del tuo sistema storage FAS8300 o FAS8700 per garantire affidabilità a lungo termine e prestazioni ottimali. Esegui regolarmente attività di manutenzione, come la sostituzione dei componenti difettosi, perché questo aiuta a prevenire downtime e perdita di dati.' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Mantieni l'hardware del tuo sistema storage FAS8300 o FAS8700 per garantire affidabilità a lungo termine e prestazioni ottimali. Esegui regolarmente attività di manutenzione, come la sostituzione dei componenti difettosi, perché questo aiuta a prevenire downtime e perdita di dati.

Le procedure di manutenzione presuppongono che il sistema di archiviazione FAS8300 e FAS8700 sia già stato distribuito come nodo di archiviazione nell'ambiente ONTAP .
...
Per i sistemi di archiviazione FAS8300 e FAS8700 , è possibile eseguire procedure di manutenzione sui seguenti componenti.
...
link:nvdimm-battery-replace.html["Batteria NVDIMM"]
 a| 
La batteria NVDIMM è responsabile del mantenimento dell'alimentazione al modulo NVDIMM.
