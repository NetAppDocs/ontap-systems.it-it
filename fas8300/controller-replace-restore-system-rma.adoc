...
summary: 'Completa la sostituzione del controller per il tuo sistema FAS8300 o FAS8700. Installa le licenze per il controller sostitutivo, verifica che le interfacce logiche (LIF) stiano segnalando alle rispettive porte di origine ed esegui un controllo dello stato del cluster. Infine, restituisci il componente guasto a NetApp.' 
---
= Completa la sostituzione del controller per il tuo sistema FAS8300 o FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
