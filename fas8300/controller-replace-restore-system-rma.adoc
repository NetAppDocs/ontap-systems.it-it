...
summary: 'Completa la sostituzione del controller per il tuo sistema FAS8300 e FAS8700. Installa le licenze per il controller sostitutivo, verifica che le interfacce logiche (LIF) stiano segnalando alle loro porte di origine e esegui un controllo dello stato del cluster. Infine, restituisci il componente guasto a NetApp.' 
---
= Sostituzione completa del controller - FAS8300 e FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
