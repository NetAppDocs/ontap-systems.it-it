...
summary: 'Sostituire un modulo DIMM nel sistema di archiviazione ASA C30 se vengono rilevati troppi errori di memoria correggibili o non correggibili. Tali errori possono impedire al sistema di archiviazione di avviare ONTAP. Il processo di sostituzione prevede l"arresto del controller danneggiato, la sua rimozione, la sostituzione del modulo DIMM, la reinstallazione del controller e la restituzione del componente guasto a NetApp.' 
---
= Sostituisci un modulo DIMM nel tuo sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un modulo DIMM nel sistema di archiviazione ASA C30 se vengono rilevati troppi errori di memoria correggibili o non correggibili. Tali errori possono impedire al sistema di archiviazione di avviare ONTAP. Il processo di sostituzione prevede l'arresto del controller danneggiato, la sua rimozione, la sostituzione del modulo DIMM, la reinstallazione del controller e la restituzione del componente guasto a NetApp.
