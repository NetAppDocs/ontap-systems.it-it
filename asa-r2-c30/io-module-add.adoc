...
summary: Aggiungi un modulo I/O al tuo sistema di archiviazione ASA C30 per migliorare la connettività di rete ed espandere la capacità del tuo sistema di gestire il traffico dati. 
---
= Aggiungi un modulo I/O a un sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo I/O al tuo sistema di archiviazione ASA C30 per migliorare la connettività di rete ed espandere la capacità del tuo sistema di gestire il traffico dati.
