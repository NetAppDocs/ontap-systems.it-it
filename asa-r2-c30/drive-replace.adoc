...
summary: 'Sostituisci a caldo un disco nel tuo sistema storage ASA C30 quando un disco si guasta o necessita di un aggiornamento. La procedura di sostituzione prevede l"identificazione del disco difettoso, la sua rimozione in sicurezza e l"installazione di un nuovo disco per garantire la continuità dell"accesso ai dati e le prestazioni del sistema.' 
---
= Sostituisci a caldo un disco in un sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puoi sostituire un'unità a caldo senza interrompere l'I/O.
