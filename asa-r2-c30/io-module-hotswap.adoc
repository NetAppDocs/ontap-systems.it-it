...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage ASA C30 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Sostituisci a caldo un modulo I/O nel tuo sistema ASA C30 senza spegnerlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage ASA C30 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
