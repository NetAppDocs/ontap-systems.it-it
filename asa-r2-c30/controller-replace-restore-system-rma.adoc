...
summary: Per completare la sostituzione del controller per il sistema storage ASA C30, ripristina innanzitutto la configurazione di NetApp Storage Encryption, se necessario, e installa le licenze richieste sul nuovo controller. Successivamente, conferma che le interfacce logiche stiano riportando alle rispettive porte home ed esegui un controllo dello stato di salute del cluster. Infine, registra il numero di serie del nuovo controller e poi restituisci la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
