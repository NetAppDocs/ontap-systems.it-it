...
summary: Prima di sostituire il supporto di avvio nel sistema storage ASA C30, assicurarsi di soddisfare i requisiti e le considerazioni necessarie per una sostituzione corretta. Ciò include la verifica di disporre del supporto di avvio sostitutivo corretto, la conferma che la porta wrench e0M sul controller danneggiato funzioni correttamente e la determinazione se Onboard Key Manager o External Key Manager siano abilitati. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
