...
summary: Dopo aver installato il nuovo dispositivo di supporto di avvio nel sistema di archiviazione ASA C30, è possibile avviare il processo di ripristino automatico del supporto di avvio per ripristinare la configurazione dal nodo funzionante. 
---
= Ripristinare l'immagine ONTAP sul supporto di avvio - ASA C30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato il nuovo dispositivo di supporto di avvio nel sistema di archiviazione ASA C30, è possibile avviare il processo di ripristino automatico del supporto di avvio per ripristinare la configurazione dal nodo funzionante.
