...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il tuo ASA C30 sistema storage possa riprendere il normale funzionamento. La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema, che può includere nessuna crittografia, crittografia con Onboard Key Manager o crittografia con External Key Manager. 
---
= Restituisci il controller nel tuo sistema ASA C30 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
