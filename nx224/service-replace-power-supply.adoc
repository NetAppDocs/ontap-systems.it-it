...
sidebar: sidebar 
keywords: nx224, shelves, shelf, nx224 shelves, replace, fail, power, supply, nondisruptive, drive, io, progress, hot-swap, hot-swap a power supply 
...
---
= Sostituire un alimentatore in uno shelf NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
