...
sidebar: sidebar 
keywords: nx224, shelves, shelf, nx224 shelves, fail, replace, drive, nondisruptive, io, hot-swap, hot-swap a drive 
...
---
= Sostituisci a caldo un drive in uno shelf NX224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
