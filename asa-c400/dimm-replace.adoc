...
summary: Sostituisci un DIMM nel modulo controller ASA C400 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili o errori ECC non correggibili. La mancata sostituzione di un DIMM difettoso può causare un blocco del sistema. 
---
= Sostituisci un modulo DIMM nel tuo sistema ASA C400 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema ASA C400 quando il sistema storage rileva un numero eccessivo di errori ECC (Error Correction Code) correggibili o un errore ECC non correggibile, che di solito è causato dal guasto di un singolo DIMM.
