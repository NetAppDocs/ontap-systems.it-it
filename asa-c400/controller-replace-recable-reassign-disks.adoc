...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il sistema ASA C400 possa riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema ASA C400 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il sistema ASA C400 possa riprendere il normale funzionamento.
