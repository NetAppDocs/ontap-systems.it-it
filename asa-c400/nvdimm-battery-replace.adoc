...
---
= Sostituisci la batteria NVDIMM nel tuo sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVDIMM nel tuo sistema ASA C400 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller.
