...
---
= Completa la sostituzione dello chassis per un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis per un sistema ASA C400 verificando lo stato HA, ripristinando gli aggregati se il sistema è in una configurazione MetroCluster a due nodi e rispedendo lo chassis guasto a NetApp.
