...
---
= Sostituisci a caldo una ventola nel tuo sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un modulo ventola guasto nel tuo sistema ASA C400 senza interrompere il servizio, per mantenere un corretto flusso d'aria e il raffreddamento del sistema.
