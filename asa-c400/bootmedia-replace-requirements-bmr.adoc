...
summary: Prima di sostituire il supporto di avvio nel vostro ASA C400, assicuratevi di soddisfare i requisiti necessari per una sostituzione corretta. Ciò include la verifica di disporre del supporto di avvio sostitutivo corretto, la conferma che la porta wrench e0S o e0M sul controller danneggiato non sia difettosa e la determinazione se Onboard Key Manager o External Key Manager sono abilitati. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
