...
summary: 'Sostituire un alimentatore nel sistema ASA C400 scollegando l"alimentatore di destinazione dalla fonte di alimentazione, scollegando il cavo di alimentazione, rimuovendo il vecchio alimentatore, installando quello di ricambio e quindi ricollegandolo alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore in un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un alimentatore guasto in un sistema ASA C400 senza spegnere il controller.
