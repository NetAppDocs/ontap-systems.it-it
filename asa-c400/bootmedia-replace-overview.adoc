...
summary: 'Il supporto di avvio memorizza un set primario e secondario di file immagine di avvio che il sistema utilizza al momento dell"avvio.' 
---
= Scopri come sostituire il supporto di avvio in un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Scopri cosa fa il supporto di avvio e cosa aspettarti prima di sostituirlo in un sistema ASA C400, inclusi i requisiti relativi all'unità flash USB e alla rete.
