...
---
= Sostituisci lo chassis in un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Trasferisci i componenti hardware dallo chassis guasto al nuovo chassis e reinstalla i moduli controller in un sistema ASA C400.
