...
---
= Flusso di lavoro per la sostituzione dello chassis ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esamina cosa aspettarti, incluso il livello di interruzione e i prerequisiti, prima di sostituire lo chassis in un sistema ASA C400.
