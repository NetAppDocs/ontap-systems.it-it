...
summary: Per ripristinare il sistema ASA C400 alla piena operatività, ripristina la configurazione di NetApp Storage Encryption se necessario, installa le licenze per il nuovo controller e restituisci la parte guasta a NetApp. 
---
