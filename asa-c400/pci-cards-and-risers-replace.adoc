...
---
= Sostituisci una scheda PCIe o mezzanine in un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Rimuovi e sostituisci una scheda PCIe o mezzanine guasta nel modulo controller di un sistema ASA C400.
