...
summary: 'Sostituisci la batteria dell"orologio in tempo reale nel modulo controller ASA C400 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.' 
---
= Sostituisci la batteria RTC in un sistema ASA C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina la corretta sincronizzazione dell'ora su un sistema ASA C400 sostituendo la batteria RTC nel modulo controller.
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[Rimuovere il modulo controller]
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[Rimuovere la batteria RTC]
