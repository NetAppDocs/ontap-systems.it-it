...
summary: Sostituire il controller nel sistema AFF C400 quando un guasto hardware lo richiede. Rimuovere il controller guasto, spostare i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo. 
---
= Sostituisci il controller nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema AFF C400 quando un guasto hardware lo richiede. Rimuovere il controller guasto, spostare i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo.
...
Dopo aver sostituito il controller AFF C400 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
