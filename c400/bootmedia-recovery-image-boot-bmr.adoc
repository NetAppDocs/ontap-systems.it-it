...
---
= Ripristino automatico del supporto di avvio dal nodo partner - AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato il nuovo supporto di avvio nel sistema AFF C400 , è possibile avviare il processo di ripristino automatico del supporto di avvio per ripristinare la configurazione dal nodo partner.
