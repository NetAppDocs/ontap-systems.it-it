...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema storage AFF C400 dopo aver completato i controlli di crittografia e prima di sostituire il supporto di avvio.
