...
summary: Ripristinare la crittografia sul supporto di avvio sostitutivo. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema storage AFF C400 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema storage AFF C400 per garantire un accesso sicuro ai dati e il corretto funzionamento del sistema.
