...
---
= Sostituisci l'hardware dello chassis nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci l'hardware dello chassis nel tuo sistema storage AFF C400 spostando le ventole, i dischi rigidi e i moduli controller dallo chassis guasto a quello di ricambio.
