...
---
= Riporta gli aggregati in una configurazione MetroCluster a due nodi nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione del supporto di avvio nel tuo sistema storage AFF C400 in una configurazione MetroCluster a due nodi, esegui l'operazione di switchback MetroCluster per ripristinare la configurazione al suo stato operativo normale.
