...
---
= Installa e configura il tuo sistema storage AFF C400 utilizzando la guida rapida
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e configura il tuo sistema storage AFF C400 utilizzando la guida rapida, che fornisce istruzioni grafiche dal montaggio su rack e dal cablaggio fino all'avvio iniziale del sistema.
