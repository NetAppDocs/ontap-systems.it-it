...
---
= Sostituisci a caldo l'alimentatore nel sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un alimentatore nel sistema storage AFF C400 per mantenere un'erogazione continua di energia senza interrompere il servizio.
