...
summary: 'È necessario sostituire un modulo DIMM nel modulo controller quando il sistema registra un numero crescente di codici di correzione degli errori correggibili (ECC), o il mancato intervento può causare un arresto anomalo del sistema.' 
---
= Sostituisci un modulo DIMM nel tuo sistema storage AFF C400 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema storage AFF C400 quando il sistema rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, che di solito è causato dal guasto di un singolo DIMM.
