...
summary: 'Per sostituire il supporto di avvio, è necessario rimuovere il modulo controller compromesso, installare il supporto di avvio sostitutivo e trasferire l"immagine di avvio su un"unità flash USB.' 
---
= Sostituisci il supporto di avvio nel sistema storage AFF C400 utilizzando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il supporto di avvio nel tuo sistema storage AFF C400 rimuovendo il modulo controller danneggiato, installando il supporto di avvio sostitutivo e trasferendo l'immagine di avvio utilizzando un'unità flash USB.
...
+
image::../media/drw_c400_open_air_duct_IEOPS-1215.svg[Drw C400 condotto aria aperto IEOPS 1215]
