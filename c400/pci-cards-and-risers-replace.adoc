...
---
= Sostituisci una scheda PCIe o mezzanine nel sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe o mezzanine nel tuo sistema storage AFF C400 scollegando i cavi e i moduli SFP/QSFP dalle schede, sostituendo la scheda guasta e ricablando.
...
NOTE: Serrare completamente le viti a testa zigrinata della scheda mezzanine. Se sono allentate, le porte da e0e a e0h potrebbero non essere rilevate, il LED potrebbe lampeggiare continuamente e i registri potrebbero mostrare un errore "unsupported cable".
