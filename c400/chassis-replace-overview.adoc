...
---
= Scopri come sostituire lo chassis nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Scopri come sostituire lo chassis nel tuo sistema storage AFF C400. La procedura di sostituzione dello chassis prevede lo spostamento di tutti i componenti dallo chassis guasto a quello di ricambio ed è un'operazione che comporta interruzioni.
