...
---
= Completa la sostituzione dello chassis del tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis per il tuo sistema storage AFF C400 verificando lo stato HA dello chassis e restituendo il componente guasto a NetApp.
