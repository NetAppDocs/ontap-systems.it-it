...
---
= Installa e configura il tuo sistema storage AFF C400 utilizzando la guida dettagliata
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e configura il tuo sistema storage AFF C400 seguendo la guida dettagliata, che fornisce istruzioni passo passo dal montaggio in rack e dal cablaggio fino all'avvio iniziale del sistema.
