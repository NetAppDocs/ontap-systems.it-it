...
---
= Installa un sistema AFF C400 seguendo le istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e configura il tuo sistema storage AFF C400 seguendo le istruzioni dettagliate, dal montaggio nei rack e dal cablaggio fino all'avvio iniziale del sistema.
