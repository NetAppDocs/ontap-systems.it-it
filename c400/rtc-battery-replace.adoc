...
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema storage AFF C400 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.
