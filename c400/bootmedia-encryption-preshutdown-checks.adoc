...
---
= Verifica il supporto di crittografia sul supporto di avvio nel tuo sistema storage AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica il supporto della crittografia sul supporto di avvio del tuo sistema storage AFF C400 prima di spegnere il controller guasto. Questo include la verifica della compatibilità della versione di ONTAP con NetApp Volume Encryption (NVE) e la conferma della configurazione del key manager.
