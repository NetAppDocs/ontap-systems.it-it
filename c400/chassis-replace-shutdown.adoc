...
---
= Spegni i controller AFF C400 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni i controller AFF C400 per sostituire lo chassis utilizzando la procedura appropriata per la tua configurazione.
