...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema AFF C400 possa riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema storage AFF C400 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema AFF C400 possa riprendere il normale funzionamento.
