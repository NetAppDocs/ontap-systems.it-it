...
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A250 utilizzando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il supporto di avvio nel tuo sistema AFF A250 memorizza i dati essenziali del firmware e della configurazione. La procedura di sostituzione prevede la rimozione del modulo di gestione del sistema, la rimozione del supporto di avvio danneggiato, l'installazione del supporto di avvio sostitutivo e quindi il trasferimento manuale dell'immagine di ONTAP sul supporto di avvio sostitutivo utilizzando un'unità flash USB.
