...
---
= Sostituisci a caldo un disco in un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un'unità guasta nel tuo sistema AFF A250 senza interruzioni mentre è in corso l'I/O, per ripristinare la capacità e le prestazioni dello storage.
