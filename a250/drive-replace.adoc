...
---
= Sostituisci un'unità nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità guasta nel tuo AFF A250 in modo non disruptive mentre è in corso l'I/O per ripristinare la capacità e le prestazioni dello storage.
