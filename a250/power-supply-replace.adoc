...
summary: 'Sostituire un alimentatore nel sistema AFF A250 scollegando l"alimentatore di destinazione dalla fonte di alimentazione, scollegando il cavo di alimentazione, rimuovendo il vecchio alimentatore, installando quello di ricambio e quindi ricollegandolo alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci l'alimentatore nel tuo sistema AFF A250 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per effettuare questa sostituzione.
...
--
Per sostituire a caldo un alimentatore CA, completare i seguenti passaggi.
