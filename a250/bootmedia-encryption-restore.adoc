...
summary: Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema AFF A250. Completa i passaggi specifici per i sistemi che hanno abilitato Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A250 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema AFF A250 per garantire la protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell’accesso sicuro ai tuoi dati.
...
Dopo aver ripristinato la crittografia sul supporto di boot, link:bootmedia-complete-rma.html["Restituire la parte guasta a NetApp"].
