...
---
= Sostituisci o installa una scheda mezzanine in un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda mezzanine guasta nel tuo AFF A250 o installane una nuova per espandere le opzioni di connettività. La procedura di sostituzione prevede la rimozione dei cavi e dei moduli SFP o QSFP, la sostituzione della scheda e il ricablaggio.
