...
summary: Sostituire un modulo DIMM nel controller AFF A250 quando il sistema riscontra un numero eccessivo di errori CECC, come indicato dagli avvisi di Health Monitor, oppure errori ECC non correggibili che impediscono al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM nel tuo sistema AFF A250 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema AFF A250 quando il sistema storage rileva un numero eccessivo di errori di memoria correggibili (CECC) o non correggibili. Tali errori possono impedire al sistema storage di avviare ONTAP.
