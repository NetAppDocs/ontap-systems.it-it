...
---
= Sostituisci a caldo una ventola nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo ventola guasto nel tuo AFF A250 per mantenere un raffreddamento adeguato e prevenire problemi di prestazioni. I moduli ventola sono hot-swappable e possono essere sostituiti senza spegnere il sistema.
