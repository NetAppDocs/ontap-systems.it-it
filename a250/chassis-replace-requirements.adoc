...
summary: Prima di sostituire lo chassis nel sistema AFF A250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, il corretto chassis di ricambio e gli strumenti necessari. 
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel sistema AFF A250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, il corretto chassis di ricambio e gli strumenti necessari.
