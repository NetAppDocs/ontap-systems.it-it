...
---
= Installa il tuo sistema AFF A250 seguendo le rapide istruzioni grafiche
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e collega il tuo sistema storage AFF A250 usando le rapide istruzioni grafiche.
