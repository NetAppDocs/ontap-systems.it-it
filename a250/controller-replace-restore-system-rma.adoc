...
---
= Completa la sostituzione del controller per il tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per completare la sostituzione del controller per il tuo sistema AFF A250, ripristina la configurazione di NetApp Storage Encryption (se necessario), conferma che le interfacce logiche (LIF) siano attestate sulle proprie porte home, esegui un controllo dello stato del cluster e restituisci il componente guasto a NetApp.
