...
summary: Per completare la sostituzione del controller per il sistema AFF A250, ripristinare la configurazione NetApp Storage Encryption se necessario, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Sostituzione completa del controller - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
