...
summary: Sostituisci la batteria del real-time clock nel modulo controller AFF A250 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio real-time nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
