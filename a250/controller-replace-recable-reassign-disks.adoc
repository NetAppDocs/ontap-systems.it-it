...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ricollega i cavi dello storage, conferma la riassegnazione dei dischi e ripristina NetApp Storage Encryption per riportare il tuo sistema AFF A250 alla piena operatività.
