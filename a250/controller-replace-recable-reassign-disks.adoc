...
---
= Ricable the system and reassign disks - AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato il ripristino e la verifica della configurazione del sistema A250, è necessario ricollegare il sistema e riassegnare i dischi.
