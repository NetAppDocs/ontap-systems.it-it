...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema storage AFF A250 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio.
