...
summary: 'Inizia a sostituire il boot media nel tuo sistema storage AFF A250 esaminando i requisiti di sostituzione, controllando lo stato della crittografia, spegnendo il controller, sostituendo il boot media, avviando l"immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.' 
---
= Flusso di lavoro per la sostituzione del supporto di avvio AFF A250 utilizzando la procedura manuale di ripristino dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
