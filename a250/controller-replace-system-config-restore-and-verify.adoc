...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema AFF A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e avviato la modalità di manutenzione, verifica la configurazione di sistema di basso livello del controller sostitutivo e riconfigura le impostazioni di sistema se necessario.
