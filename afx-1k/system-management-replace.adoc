...
---
= Sostituisci il modulo di gestione del sistema nel tuo sistema storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Il modulo di gestione del sistema, situato sul retro del controller a sinistra dello slot 8, contiene componenti integrati per la gestione del sistema, nonché porte per la gestione esterna. Il controller di destinazione deve essere spento e disattivato per sostituire un modulo di gestione del sistema danneggiato o sostituire il supporto di avvio.
