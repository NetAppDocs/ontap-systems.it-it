...
summary: Arresta il controller nel tuo sistema storage AFX 1K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il boot media. 
---
...
[role="lead"]
Arresta il controller nel tuo sistema storage AFX 1K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il boot media.
