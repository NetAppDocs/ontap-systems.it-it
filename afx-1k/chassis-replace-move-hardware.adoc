...
summary: 'Sostituire lo chassis del sistema storage AFX 1K quando un guasto hardware lo richiede. La procedura di sostituzione prevede la rimozione del controller dalla parte anteriore dello chassis, la rimozione delle unità di alimentazione, della NVRAM12, dei moduli I/O e degli alloggiamenti vuoti, del modulo di gestione del sistema e quindi l"installazione dello chassis di ricambio e la reinstallazione dei componenti dello chassis.' 
---
= Sostituisci lo chassis del tuo sistema storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[step-2-remove-the-io-cards-nvram12-and-system-management-module]]
...
Dopo aver sostituito lo chassis AFX 1K e reinstallato i suoi componenti, completare la link:chassis-replace-complete-system-restore-rma.html["sostituzione del telaio"].
