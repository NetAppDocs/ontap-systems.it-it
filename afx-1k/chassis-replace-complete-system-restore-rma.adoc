...
summary: Riavviare il controller, verificare lo stato del sistema e restituire la parte guasta a NetApp per completare il passaggio finale della procedura di sostituzione dello chassis AFX 1K. 
---
= Completa la sostituzione dello chassis del tuo sistema storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
