...
summary: Spegnere il controller nel sistema di archiviazione AFX 1K per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis. 
---
= Spegnere il controller per sostituire il telaio - AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere il controller nel sistema di archiviazione AFX 1K per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
