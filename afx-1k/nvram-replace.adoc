...
summary: Sostituisci la NVRAM nel tuo sistema di archiviazione AFX 1K quando la memoria non volatile diventa difettosa o necessita di un aggiornamento. 
---
= Sostituisci la NVRAM nel tuo sistema storage AFX 1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la NVRAM nel tuo sistema di archiviazione AFX 1K quando la memoria non volatile diventa difettosa o necessita di un aggiornamento.  Il processo di sostituzione prevede lo spegnimento del controller danneggiato, la sostituzione del modulo NVRAM o del DIMM NVRAM e la restituzione della parte guasta a NetApp.
...
. Se i collegamenti di interconnessione HA sono stati interrotti, riattivali:
+
