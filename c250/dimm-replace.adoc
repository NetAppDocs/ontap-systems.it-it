...
---
= Sostituisci un modulo DIMM in un sistema AFF C250 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo DIMM in un sistema AFF C250 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili, per evitare un blocco del sistema.
