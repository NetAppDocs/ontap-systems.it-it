...
---
= Installa un sistema storage AFF C250 usando passaggi rapidi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utilizza il poster con le istruzioni rapide per installare un sistema storage AFF C250, dal montaggio in rack e dal cablaggio fino all'avvio iniziale del sistema. Questo formato funziona meglio se hai già familiarità con l'installazione di sistemi NetApp.
