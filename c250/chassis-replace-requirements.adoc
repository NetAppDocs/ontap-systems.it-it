---
permalink: c250/chassis-replace-requirements.html 
sidebar: sidebar 
keywords: aff c250, replace the chassis 
summary: Prima di sostituire lo chassis nel sistema AFF C250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, dello chassis di ricambio corretto e degli strumenti necessari. 
---
= Esamina i requisiti per la sostituzione di un chassis in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel sistema AFF C250, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, dello chassis di ricambio corretto e degli strumenti necessari.
