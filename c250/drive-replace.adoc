...
---
= Sostituisci a caldo un disco SSD in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un disco SSD guasto in un sistema AFF C250 senza interrompere le operazioni di I/O in corso.
