...
summary: Per completare la sostituzione del controller per il sistema AFF C250 e ripristinarne il pieno funzionamento, è necessario ripristinare la configurazione di NetApp Storage Encryption, installare le licenze per il nuovo controller e restituire il componente guasto a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema storage AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
