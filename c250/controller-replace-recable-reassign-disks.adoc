...
---
= Ricollega i cavi di un sistema AFF C250 e riassegna i dischi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato le fasi di ripristino e verifica della configurazione del sistema AFF C250, devi ricablare il sistema e riassegnare i dischi.
