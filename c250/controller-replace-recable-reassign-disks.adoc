...
---
= Ricollega i cavi del tuo sistema storage AFF C250 e riassegna i dischi
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato il ripristino e la verifica della configurazione del sistema AFF C250, è necessario ricollegare il sistema e riassegnare i dischi.
