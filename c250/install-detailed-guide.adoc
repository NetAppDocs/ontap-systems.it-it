...
image:../media/oie_legend_icon_1_lg.png[""]
 a| 
Collegare le porte di interconnessione del cluster l'una all'altra con il cavo di interconnessione del cluster da 25 GbEimage:../media/oie_cable_sfp_gbe_copper.png[""]:
...
1
 a| 
Collegare le porte da 2a a 2d agli switch host FC.image:../media/drw_affa250_fc_host_cabling.png[""]
...
1
 a| 
Collegare le porte da e4a a e4d agli switch di rete host da 10 GbE.image:../media/drw_affa250_25gbe_host_cabling.png[""]
