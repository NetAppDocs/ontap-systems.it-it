...
---
= Installa un sistema storage AFF C250 usando passaggi dettagliati
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa un sistema storage AFF C250 seguendo istruzioni dettagliate e passo passo che coprono l'installazione nel rack, il cablaggio e l'avvio iniziale del sistema.
...
.Fasi
. Collegare le porte di interconnessione del cluster e0c a e0c ed e0d a e0d con i cavi di interconnessione del cluster da 25 GbE.
+
