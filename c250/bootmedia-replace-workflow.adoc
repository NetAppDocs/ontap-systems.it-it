...
summary: 'Inizia a sostituire il supporto di boot nel sistema storage AFF C250 esaminando i requisiti di sostituzione, controllando lo stato della crittografia, spegnendo il controller, sostituendo il supporto di boot, avviando l"immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema AFF C250 utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Inizia a sostituire il supporto di boot nel sistema storage AFF C250 esaminando i requisiti di sostituzione, controllando lo stato della crittografia, spegnendo il controller, sostituendo il supporto di boot, avviando l'immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.
