...
---
= Sostituisci la batteria NVMEM in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una batteria NVMEM guasta in un sistema AFF C250 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller.
