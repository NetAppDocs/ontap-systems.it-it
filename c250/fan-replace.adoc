...
---
= Sostituisci una ventola in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo ventola guasto in un sistema AFF C250 rimuovendolo e installando un nuovo modulo ventola.
