...
---
= Ripristina e verifica la configurazione del controller in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema AFF C250 in modalità Maintenance, devi verificare la configurazione di basso livello del controller sostitutivo e riconfigurare le impostazioni di sistema se necessario.
