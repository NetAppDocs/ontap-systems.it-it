...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema storage AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema AFF C250 in modalità di manutenzione, è necessario verificare la configurazione di sistema di basso livello del controller sostitutivo e riconfigurare le impostazioni di sistema secondo necessità.
...
Dopo aver ripristinato e verificato la configurazione del sistema, è necessario link:controller-replace-recable-reassign-disks.html["ricollega il sistema e riassegna i dischi"].
