...
---
= Sostituisci o installa una scheda mezzanine in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda mezzanine guasta o installane una nuova in un sistema AFF C250 rimuovendo i cavi e gli eventuali moduli SFP o QSFP, sostituendo la scheda e ricablando.
