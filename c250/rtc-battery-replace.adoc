...
---
= Sostituisci la batteria RTC in un sistema AFF C250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria RTC in un sistema AFF C250 così che i servizi e le applicazioni che dipendono da una sincronizzazione accurata dell'ora continuino a funzionare.
