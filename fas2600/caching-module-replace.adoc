...
summary: Sostituisci il modulo di caching nel tuo sistema FAS2600 quando il sistema registra un singolo messaggio AutoSupport che indica che il modulo è andato offline. Se non lo fai, si verifica un peggioramento delle performance. 
---
= Sostituisci il modulo di caching nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo di caching nel tuo sistema FAS2600 quando il sistema registra un singolo messaggio AutoSupport (ASUP) che indica che il modulo è offline. Se non lo fai, si verifica un peggioramento delle performance.
...
Il modulo di caching è indicato come scheda M.2 PCIe sull'etichetta del controller. Individua lo slot all'interno del controller e segui questa sequenza di passaggi.
