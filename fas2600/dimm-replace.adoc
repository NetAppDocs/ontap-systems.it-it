...
summary: 'Sostituisci un DIMM nel tuo sistema FAS2600 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili in base agli avvisi di Health Monitor, oppure errori ECC non correggibili causati dal guasto di un singolo DIMM che impedisce l"avvio di ONTAP.' 
---
= Sostituisci un modulo DIMM nel tuo sistema FAS2600 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema FAS2600 quando il sistema storage rileva un numero eccessivo di errori CECC (Correctable Error Correction Codes) in base agli avvisi di Health Monitor, oppure errori ECC non correggibili, di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.

Se un qualsiasi altro componente non funziona correttamente, contatta il supporto tecnico.

È necessario sostituire il componente guasto con un componente FRU sostitutivo ricevuto dal provider.

link:https://youtu.be/ywwsMltvuXg["Video di sostituzione dei moduli DIMM AFF FAS2600"^]
