...
summary: È necessario sostituire un DIMM nel controller quando il sistema storage riscontra errori come un numero eccessivo di errori ECC correggibili basati sugli avvisi di Health Monitor o errori ECC non correggibili, in genere causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP. 
---
= Sostituire un DIMM - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
