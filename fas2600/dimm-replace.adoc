...
summary: 'Sostituisci il DIMM nel tuo sistema FAS2600 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili in base agli avvisi di Health Monitor, oppure errori ECC non correggibili causati dal guasto di un singolo DIMM che impedisce l"avvio di ONTAP.' 
---
= Sostituisci un modulo DIMM in un sistema FAS2600 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
