...
summary: Per ripristinare il funzionamento completo del sistema, è necessario ripristinare la configurazione di NetApp Storage Encryption, se necessario, installare le licenze per il nuovo controller e restituire il componente guasto a NetApp come descritto nelle istruzioni RMA fornite con il kit. 
---
= Ripristino completo del sistema - FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
