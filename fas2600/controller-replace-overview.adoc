...
summary: Prima di sostituire il controller nel sistema FAS2600, verifica i prerequisiti per la procedura di sostituzione e seleziona quella corretta per la tua versione del sistema operativo ONTAP. 
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel sistema FAS2600, verifica i prerequisiti per la procedura di sostituzione e seleziona quella corretta per la tua versione del sistema operativo ONTAP.
