...
summary: Sostituisci la batteria NVMEM nel tuo sistema FAS2600 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller. 
---
= Sostituisci la batteria NVMEM nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema FAS2600 rimuovendo il modulo controller, aprendolo, sostituendo la batteria, quindi richiudendo e reinstallando il modulo controller.

Se altri componenti del sistema non funzionano correttamente, contatta il supporto tecnico.

link:https://youtu.be/dgEMcYxya5M["Video sulla sostituzione della batteria NVMEM di AFF FAS2600"^]
