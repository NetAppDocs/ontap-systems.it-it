...
summary: 'Trasferisci gli alimentatori, i dischi rigidi e i moduli controller dallo chassis guasto allo chassis di ricambio nel tuo sistema FAS2600, quindi sostituisci il vecchio chassis nello spazio rack o nell"armadio di sistema con quello nuovo dello stesso modello.' 
---
= Sostituisci lo chassis nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Trasferisci gli alimentatori, i dischi rigidi e i moduli controller dallo chassis guasto allo chassis di ricambio nel tuo sistema FAS2600, quindi sostituisci il vecchio chassis nello spazio rack o nell'armadio di sistema con quello nuovo dello stesso modello.
...
Per le configurazioni HA con due moduli controller nello stesso chassis, l'ordine di installazione è importante perché ogni controller si riavvia non appena è completamente inserito nello chassis.
