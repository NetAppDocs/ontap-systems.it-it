...
summary: Ripristinare la configurazione di crittografia sul supporto di avvio sostitutivo per un sistema FAS2600. Questa procedura include il completamento dei passaggi successivi alla sostituzione per i sistemi con Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption abilitati, al fine di garantire un accesso sicuro ai dati e il corretto funzionamento del sistema. 
---
= Ripristina la crittografia sul supporto di boot nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
