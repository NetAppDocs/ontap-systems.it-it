...
summary: 'Dopo aver completato la sostituzione dell"hardware e aver avviato il sistema FAS2600 in modalità manutenzione, ripristina e verifica la configurazione del controller.' 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e avviato il sistema in modalità manutenzione, ripristina e verifica la configurazione del controller nel tuo sistema FAS2600, verificando la configurazione di basso livello del controller sostitutivo e riconfigurando le impostazioni di sistema se necessario.
