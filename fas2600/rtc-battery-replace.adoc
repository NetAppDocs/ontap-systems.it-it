...
summary: 'Sostituisci la batteria dell"orologio real-time nel tuo sistema FAS2600 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.' 
---
= Sostituisci la batteria del real-time clock nel tuo sistema FAS2600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in real-time (RTC) nel tuo sistema FAS2600 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.
