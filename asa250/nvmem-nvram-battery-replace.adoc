...
---
= Sostituisci la batteria NVMEM in un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una batteria NVMEM guasta in un sistema ASA A250 spegnendo il controller danneggiato, aprendo il modulo del controller e installando la batteria di ricambio. Questa procedura protegge i dati di scrittura memorizzati nella cache dalla perdita dovuta a una batteria degradata.
