...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema ASA A250 in modalità di manutenzione, è necessario verificare la configurazione di basso livello del sistema del controller sostitutivo e riconfigurare le impostazioni di sistema secondo necessità.
