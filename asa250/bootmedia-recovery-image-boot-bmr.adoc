...
summary: Dopo aver installato il nuovo boot media device nel sistema ASA A250, puoi avviare il processo di ripristino automatico del boot media per ripristinare la configurazione dal nodo partner. 
---
= Ripristina l'immagine di avvio sul tuo sistema ASA A250 utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
