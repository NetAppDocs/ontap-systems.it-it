...
summary: 'Una volta verificate le variabili d"ambiente, è necessario completare i passaggi specifici per i sistemi che hanno Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE abilitati.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema ASA A250 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
