...
---
= Sostituisci lo chassis nel tuo sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il chassis ASA A250 e reinstallato i componenti, è necessario link:chassis-replace-complete-system-restore-rma.html["completare la sostituzione del telaio"]
