...
summary: È necessario sostituire un modulo DIMM nel modulo controller quando il sistema registra un numero crescente di codici di correzione degli errori correggibili ECC. In caso contrario, si verifica un panic di sistema. 
---
= Sostituisci un modulo DIMM in un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo DIMM in un sistema ASA A250 quando il sistema segnala un numero crescente di errori ECC correggibili. Questa procedura include lo spegnimento del controller guasto, l'apertura del modulo controller e l'installazione del modulo DIMM sostitutivo per evitare un panic del sistema.
