...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema ASA A250 possa riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema ASA A250 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato il ripristino e la verifica della configurazione del sistema ASA A250, è necessario ricollegare il sistema e riassegnare i dischi.
