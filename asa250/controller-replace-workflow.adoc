...
summary: Inizia a sostituire il controller nel tuo sistema storage ASA A250 spegnendo il controller danneggiato, rimuovendo e sostituendo il controller, riconfigurando le impostazioni di sistema e verificando le operazioni del sistema. 
---
= Flusso di lavoro per la sostituzione del controller ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema storage ASA A250 spegnendo il controller danneggiato, rimuovendo e sostituendo il controller, ripristinando la configurazione del sistema e restituendo il controllo delle risorse di storage al controller sostitutivo.
