...
---
= Sostituisci a caldo un alimentatore in un ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un alimentatore (PSU) guasto in un sistema ASA A250 senza spegnere il controller. I PSU sono ridondanti e a selezione automatica della tensione, quindi sostituire un PSU guasto con uno dello stesso tipo mantiene il sistema in funzione senza interruzioni.
