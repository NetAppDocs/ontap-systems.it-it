...
---
= Completa la sostituzione dello chassis del tuo sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Riavvia i controller, verifica lo stato del sistema e restituisci la parte guasta a NetApp per completare il passaggio finale della procedura di sostituzione dello chassis ASA A250.
