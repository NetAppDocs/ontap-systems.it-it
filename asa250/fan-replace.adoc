...
---
= Sostituisci una ventola in un sistema ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo ventola guasto in un sistema ASA A250 spegnendo il controller danneggiato, aprendo il modulo del controller e installando la ventola di ricambio. Questa procedura mantiene i componenti del controller raffreddati e previene guasti di sistema dovuti al surriscaldamento.
