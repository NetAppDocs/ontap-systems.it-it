...
---
= Spegni i controller ASA A250 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni i controller nel tuo sistema storage ASA A250 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
