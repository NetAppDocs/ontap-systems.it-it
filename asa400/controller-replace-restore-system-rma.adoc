...
summary: Per ripristinare il sistema al funzionamento completo, è necessario ripristinare la configurazione NetApp Storage Encryption se necessario, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp, come descritto nelle istruzioni RMA fornite con il kit. 
---
= Ripristino completo del sistema - ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
