...
summary: Arresta il controller nel tuo sistema storage ASA A400 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot. 
---
= Arresta il controller nel tuo sistema ASA A400 durante il processo di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage ASA A400 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot.
