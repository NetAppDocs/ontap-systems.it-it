...
summary: Dopo aver installato il nuovo supporto di boot nel sistema ASA A400, puoi avviare il processo automatico di ripristino del supporto di boot per ripristinare la configurazione dal nodo partner. 
---
= Ripristina l'immagine di avvio sul tuo sistema ASA A400 utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
