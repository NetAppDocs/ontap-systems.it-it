...
summary: 'Per iniziare a sostituire il supporto di avvio nel sistema di archiviazione ASA A400 , è necessario esaminare i requisiti di sostituzione, controllare lo stato della crittografia, spegnere il controller, sostituire il supporto di avvio, avviare l"immagine di ripristino, ripristinare la crittografia e verificare la funzionalità del sistema.' 
---
= Flusso di lavoro per la sostituzione del supporto di avvio per un sistema ASA A400 utilizzando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per iniziare a sostituire il supporto di avvio nel sistema di archiviazione ASA A400 , è necessario esaminare i requisiti di sostituzione, controllare lo stato della crittografia, spegnere il controller, sostituire il supporto di avvio, avviare l'immagine di ripristino, ripristinare la crittografia e verificare la funzionalità del sistema.
