...
summary: Sostituisci il controller nel tuo sistema ASA A400 quando un guasto hardware lo richiede. Rimuovi il controller guasto, trasferisci i suoi componenti sul controller di ricambio, installa il nuovo controller e riavvialo. 
---
= Sostituisci il controller nel tuo sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo sistema ASA A400 quando un guasto hardware lo richiede. Rimuovi il controller guasto, trasferisci i suoi componenti sul controller di ricambio, installa il nuovo controller e riavvialo.
...
Dopo aver sostituito il controller ASA A400 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
