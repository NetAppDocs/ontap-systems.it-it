...
summary: È necessario sostituire il modulo NVDIMM nel controller quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM identificato non è in buone condizioni, per evitare un blocco del sistema. 
---
= Sostituisci un modulo NVDIMM nel tuo sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
