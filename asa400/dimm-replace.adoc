...
summary: È necessario sostituire un DIMM nel modulo controller quando il sistema registra un numero crescente di codici di correzione degli errori correggibili ECC per evitare il blocco del sistema. 
---
= Sostituisci un modulo DIMM nel tuo sistema ASA A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
