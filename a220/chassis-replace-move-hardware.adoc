...
---
= Sostituisci lo chassis nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo AFF A220 spostando gli alimentatori, i dischi rigidi e i moduli controller dallo chassis guasto a quello di ricambio.
