...
summary: È necessario individuare il supporto di avvio nel controller e seguire le istruzioni per sostituirlo. Il sistema AFF A220 supporta solo procedure di ripristino manuale tramite supporti di avvio. 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
