...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller del tuo AFF A220 ricablando lo storage e confermando la riassegnazione dei dischi.
