...
---
= Sostituisci a caldo un disco in un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un'unità guasta nel tuo sistema AFF A220 senza interrompere l'I/O. AFF A220 supporta sia SSD che HDD, ognuno con una procedura di sostituzione dedicata.
