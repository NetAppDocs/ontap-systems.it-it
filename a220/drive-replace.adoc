...
---
= Sostituisci un'unità nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un disco guasto nel tuo sistema AFF A220 senza interrompere l'I/O. AFF A220 supporta sia dischi SSD che HDD, ognuno con una procedura di sostituzione dedicata.
