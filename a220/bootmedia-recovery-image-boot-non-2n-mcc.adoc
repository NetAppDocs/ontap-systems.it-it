...
summary: 'È necessario avviare l"immagine ONTAP dall"unità USB, ripristinare il file system e verificare le variabili ambientali. Il sistema AFF A220 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Avvia l'immagine di ripristino sul tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Avvia l'immagine di ripristino ONTAP dall'unità USB sul tuo AFF A220 per ripristinare il supporto di avvio utilizzando la procedura di ripristino manuale.
