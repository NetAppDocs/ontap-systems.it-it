...
summary: 'Il supporto di avvio memorizza un set primario e secondario di file di sistema \(immagine di avvio\) che il sistema utilizza all"avvio. A seconda della configurazione della rete, è possibile eseguire una sostituzione non distruttiva o distruttiva. Il sistema AFF A220 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
