...
summary: 'Il supporto di avvio memorizza un set primario e uno secondario di file di sistema che il sistema utilizza durante l"avvio. Il sistema AFF A220 supporta solo procedure manuali di ripristino del supporto di avvio.' 
---
= Scopri come sostituire il supporto di avvio nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il sistema AFF A220 supporta solo procedure di ripristino manuale tramite supporti di avvio.
