...
summary: 'Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema storage AFF A220. L"AFF A220 supporta solo procedure manuali di ripristino del supporto di avvio.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
