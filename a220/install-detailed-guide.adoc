...
---
= Installa il tuo sistema storage AFF A220 utilizzando istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A220 seguendo le istruzioni dettagliate passo passo, dal montaggio nei rack e dal cablaggio fino alla messa in funzione iniziale del sistema.
