...
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel tuo sistema AFF A220, verifica i requisiti per una sostituzione corretta. La procedura di sostituzione dello chassis prevede lo spostamento di tutti gli alimentatori, le unità e i moduli controller dallo chassis guasto allo chassis di ricambio ed è un'operazione che comporta interruzioni.
