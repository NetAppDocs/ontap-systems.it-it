...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema AFF A220 in modalità Manutenzione, ripristina e verifica la configurazione del controller.
