...
---
= Sostituisci a caldo un alimentatore in un sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un alimentatore nel tuo sistema AFF A220 spegnendo, scollegando e rimuovendo l'unità guasta, quindi installando e ricollegando quella di ricambio.
