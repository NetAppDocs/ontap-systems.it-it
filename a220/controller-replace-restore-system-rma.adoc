...
summary: 'Per ripristinare il funzionamento completo del sistema, è necessario ripristinare la configurazione crittografia dello storage NetApp (se necessario), installare le licenze per il nuovo controller e restituire la parte guasta a NetApp.' 
---
