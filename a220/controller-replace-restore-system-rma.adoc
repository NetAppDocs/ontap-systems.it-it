...
summary: Per ripristinare il funzionamento completo del sistema, ripristinare la configurazione di NetApp Storage Encryption, se necessario, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller per il tuo sistema AFF A220 ripristinando la configurazione di crittografia dello storage NetApp (se necessario), installando le licenze per il nuovo controller e restituendo il componente guasto a NetApp.
