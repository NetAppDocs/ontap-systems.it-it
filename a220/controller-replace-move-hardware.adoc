...
---
= Sostituisci il controller nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo AFF A220 rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller di ricambio, installandolo nello chassis e avviando la modalità di manutenzione.
