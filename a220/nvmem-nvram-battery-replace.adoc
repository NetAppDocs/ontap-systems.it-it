...
---
= Sostituisci la batteria NVMEM nel tuo sistema AFF A220
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema AFF A220 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller.
