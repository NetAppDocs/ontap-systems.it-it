...
summary: Prima di sostituire lo chassis nel tuo sistema FAS2820, devi arrestare correttamente i controller per evitare la perdita di dati e garantire la stabilità del sistema. 
---
= Spegni il controller FAS2820 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel tuo sistema FAS2820, devi arrestare correttamente i controller per evitare la perdita di dati e garantire la stabilità del sistema.
