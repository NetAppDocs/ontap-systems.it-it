...
NOTE: L'esempio utilizza DS224C. Il cablaggio è simile agli altri shelf di dischi supportati. Vedere https://docs.netapp.com/us-en/ontap-systems/sas3/install-new-system.html["Installazione e shelf per l'installazione di un nuovo sistema - shelf con moduli IOM12/IOM12B"^] per ulteriori informazioni.
...
IMPORTANT: Non utilizzare la porta 0b2 su FAS2800. Questa porta SAS non viene utilizzata da ONTAP ed è sempre disattivata. Vedere https://docs.netapp.com/us-en/ontap-systems/sas3/install-new-system.html["Installare uno shelf in un nuovo sistema storage"^] per ulteriori informazioni.
