...
summary: Per garantire la sicurezza dei dati sul sistema storage FAS2820, devi verificare il supporto e lo stato della chiave di crittografia sul supporto di boot. Controlla se la versione di ONTAP supporta NetApp Volume Encryption e, prima di spegnere il controller, verifica che il key manager sia attivo. 
---
= Verifica il supporto della crittografia sul supporto di avvio in un sistema FAS2820 usando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul tuo sistema storage FAS2820, verifica il supporto e lo stato della chiave di crittografia sul supporto di boot. Controlla se la versione di ONTAP supporta NetApp Volume Encryption (NVE). Prima di spegnere il controller, controlla se il key manager è attivo.
