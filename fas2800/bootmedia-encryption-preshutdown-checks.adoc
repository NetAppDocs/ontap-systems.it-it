...
---
= Controllare le chiavi di crittografia integrate - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Se nell'output del comando viene visualizzato <lno-DARE> o <1Ono-DARE>, il sistema non supporta NVE, passare a. https://docs.netapp.com/us-en/ontap-systems/fas2800/bootmedia-impaired-controller-shutdown.html["Spegnere il controller compromesso"].
