...
summary: 'Mantenete l"hardware del vostro sistema storage FAS2820 per garantirne l"affidabilità a lungo termine e prestazioni ottimali.' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puoi eseguire procedure di manutenzione su questi componenti del tuo sistema storage FAS2820.
...
link:pci-cards-and-risers-replace.html["Scheda mezzanino"]
 a| 
Una scheda mezzanine è una scheda di espansione che si inserisce in uno slot specializzato sulla scheda madre e ospita le schede di I/O.
