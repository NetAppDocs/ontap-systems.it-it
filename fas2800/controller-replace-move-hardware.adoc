...
sidebar: sidebar 
keywords: fas2820, move the controller module hardware 
summary: 'Nel tuo sistema FAS2820, sostituisci l"hardware del modulo controller danneggiato rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller sostitutivo, installando il modulo controller sostitutivo nello chassis e poi avviando il modulo controller sostitutivo.' 
---
= Sostituisci il controller nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nel tuo sistema FAS2820, sostituisci l'hardware del modulo controller danneggiato rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller sostitutivo, installando il modulo controller sostitutivo nello chassis e poi avviando il modulo controller sostitutivo.
...
NOTE: Non collegare ancora la batteria. La collegherai dopo aver spostato tutti gli altri componenti nel modulo controller sostitutivo.
...
. Installa il supporto di boot nel modulo controller sostitutivo:
+
...
Rimuovi il modulo di caching dal modulo controller danneggiato e installalo nel modulo controller sostitutivo.
...
. Capovolgi il modulo di controllo.
