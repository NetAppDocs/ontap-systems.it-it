...
summary: Ripristina il funzionamento completo del sistema ripristinando le configurazioni di NetApp Storage Encryption o Volume Encryption, installando le licenze per il controller sostitutivo e restituendo il componente guasto a NetApp, come descritto nelle istruzioni RMA fornite con il kit. 
---
= Ripristino completo del sistema - FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristinare il funzionamento completo del sistema ripristinando le configurazioni crittografia dello storage NetApp o crittografia del volume (se necessario), installando le licenze per il controller sostitutivo e restituendo il componente guasto a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
