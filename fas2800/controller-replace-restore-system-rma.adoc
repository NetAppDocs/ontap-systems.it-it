...
sidebar: sidebar 
keywords: fas2820, how to restore NetApp Storage Encryption, how to complete the replacement process 
summary: 'Ripristina il funzionamento completo del tuo sistema FAS2820 ripristinando le configurazioni di NetApp Storage Encryption o Volume Encryption (se necessario), installando le licenze per il controller sostitutivo e restituendo la parte guasta a NetApp, come descritto nelle istruzioni RMA spedite con il kit.' 
---
= Completa la sostituzione del controller per il tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
