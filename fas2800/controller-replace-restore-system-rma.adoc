...
---
= Ripristino completo del sistema - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Fase 2: Ripristino delle funzionalità di storage e crittografia dei volumi
...
== Fase 3: Verificare i file LIF e registrare il numero di serie
