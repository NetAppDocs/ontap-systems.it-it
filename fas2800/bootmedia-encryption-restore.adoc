...
summary: Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema FAS2820. 
---
= Ripristina la crittografia sul supporto di avvio in un sistema FAS2820 dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver sostituito il boot media nel tuo sistema FAS2820, ripristina la crittografia sul nuovo dispositivo per mantenere la sicurezza dei dati e riportare il sistema alla configurazione originale.
