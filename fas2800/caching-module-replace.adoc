...
sidebar: sidebar 
keywords: replace, caching, module,  fas2820, shut, down, impaired, controller, controller, aggregates, metrocluster, configuration, replace, reinstall 
summary: Devi sostituire il modulo di caching nel modulo controller del tuo sistema FAS2820 quando viene registrato un singolo messaggio AutoSupport che indica che il modulo è andato offline. Se non sostituisci il modulo guasto, il tuo sistema storage subirà un peggioramento delle performance. 
---
= Sostituisci il modulo di caching nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire il modulo di caching nel modulo controller del tuo sistema FAS2820 quando viene registrato un singolo messaggio AutoSupport (ASUP) che indica che il modulo è andato offline. Se non sostituisci il modulo guasto, il tuo sistema storage subirà un peggioramento delle performance.
