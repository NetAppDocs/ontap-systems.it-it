...
summary: È necessario sostituire il modulo di caching nel modulo controller quando il sistema registra un singolo AutoSupport ASUP messaggio che indica che il modulo è offline. Se non si sostituisce il modulo guasto, il sistema storage subirà peggioramento delle performance. 
---
