...
summary: 'Nel tuo sistema FAS2820, sposta gli alimentatori, i dischi rigidi e il modulo o i moduli controller dallo chassis guasto al nuovo chassis, e sostituisci lo chassis guasto nel rack delle apparecchiature o nell"armadio di sistema con il nuovo chassis dello stesso modello dello chassis guasto.' 
---
= Sostituisci lo chassis nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nel tuo sistema FAS2820, sposta gli alimentatori, i dischi rigidi e il modulo o i moduli controller dallo chassis guasto al nuovo chassis, e sostituisci lo chassis guasto nel rack delle apparecchiature o nell'armadio di sistema con il nuovo chassis dello stesso modello dello chassis guasto.
...
. Con l'aiuto di due o tre persone, fai scivolare lo chassis danneggiato fuori dalle guide del rack in un armadio di sistema o dalle staffe a L in un rack per apparecchiature, quindi mettilo da parte.
. Se non si è già collegati a terra, mettere a terra l'utente.
. Installa il chassis di ricambio nel rack delle apparecchiature o nell'armadio di sistema con l'aiuto di due o tre persone, guidando il chassis sulle guide del rack in un armadio di sistema o sulle staffe a L in un rack delle apparecchiature.
...
Installa il modulo controller e tutti gli altri componenti nel chassis, poi avvialo in modalità Maintenance.
...
+
.. Quando ogni controller inizia l'avvio, premi  `Ctrl-C` per interrompere il processo di avvio quando vedi il messaggio  `Press Ctrl-C for Boot Menu`.
+
