...
summary: 'Devi sostituire un DIMM nel controller del tuo sistema FAS2820 quando si verificano errori come un numero eccessivo di errori CECC (Correctable Error Correction Codes) segnalati dagli avvisi di Health Monitor o errori ECC non correggibili, di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.' 
---
= Sostituisci un modulo DIMM nel tuo sistema FAS2820 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire un DIMM nel controller del tuo sistema FAS2820 quando si verificano errori come un numero eccessivo di errori CECC (Correctable Error Correction Codes) segnalati dagli avvisi di Health Monitor o errori ECC non correggibili, di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.
...
+
Il modulo DIMM ruota leggermente verso l'alto.
