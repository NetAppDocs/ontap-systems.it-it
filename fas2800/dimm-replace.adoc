...
summary: Devi sostituire il DIMM nel controller del tuo sistema FAS2820 quando si verificano errori come errori di memoria ECC correggibili eccessivi segnalati dagli avvisi di Health Monitor o errori ECC non correggibili, di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM in un sistema FAS2820 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire il DIMM nel controller del tuo sistema FAS2820 quando si verificano errori come errori di memoria ECC correggibili eccessivi segnalati dagli avvisi di Health Monitor o errori ECC non correggibili, di solito causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.
