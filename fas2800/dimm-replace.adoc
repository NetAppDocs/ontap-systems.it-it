...
summary: È necessario sostituire un DIMM nel controller quando il sistema storage riscontra errori quali un numero eccessivo di errori ECC correggibili, in base agli avvisi di Health Monitor, oppure errori ECC non correggibili che impediscono al sistema storage di avviare ONTAP. 
---
