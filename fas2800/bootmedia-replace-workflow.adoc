...
sidebar: sidebar 
keywords: aff fas2820, replace the boot media 
summary: 'Inizia a sostituire il supporto di avvio nel tuo sistema storage FAS2820 esaminando i requisiti di sostituzione, controllando lo stato della crittografia, arrestando il controller, sostituendo il supporto di avvio, avviando l"immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema FAS2820 utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
