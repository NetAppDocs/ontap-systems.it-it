...
sidebar: sidebar 
keywords: fas2820, restore and verify the system configuration, verify and set the ha state of the controller module 
summary: 'Dopo aver completato la sostituzione dell"hardware e avviato il controller sostitutivo nel tuo sistema FAS2820, verifica la configurazione di basso livello del controller sostitutivo e riconfigura le impostazioni di sistema, se necessario.' 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e avviato il controller sostitutivo nel tuo sistema FAS2820, verifica la configurazione di basso livello del controller sostitutivo e riconfigura le impostazioni di sistema, se necessario.
