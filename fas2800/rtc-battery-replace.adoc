...
summary: Sostituisci la batteria del real-time clock nel modulo controller del tuo sistema FAS2820 così che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria del real-time clock (RTC) nel modulo controller del tuo sistema FAS2820, così i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuano a funzionare.
...
Sostituisci la batteria RTC individuandola all'interno del controller e seguendo la sequenza specifica di passaggi.
...
Reinstalla il modulo controller e avvialo fino al prompt LOADER.
