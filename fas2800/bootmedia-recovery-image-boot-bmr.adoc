...
sidebar: sidebar 
keywords: fas2820, boot the recovery image 
summary: 'Ripristina l"immagine ONTAP sul supporto di boot sostitutivo nel tuo sistema FAS2820. La procedura prevede l"avvio del processo di ripristino del boot dal prompt LOADER e il monitoraggio del processo di ripristino fino al completamento e al riavvio del nodo.' 
---
= Ripristina l'immagine di boot sul tuo sistema FAS2820 utilizzando il processo di ripristino automatico del boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
