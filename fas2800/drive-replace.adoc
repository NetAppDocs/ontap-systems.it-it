...
sidebar: sidebar 
keywords: fas2820, replace the drives 
summary: 'Devi sostituire un drive nel tuo sistema FAS2820 quando la piattaforma registra un messaggio di avviso sulla console di sistema che indica che un drive si è guastato. Sia il LED di errore sul pannello di visualizzazione dell"operatore che il LED di errore sul drive guasto sono accesi.' 
---
= Sostituisci un'unità nel tuo sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire un drive nel tuo sistema FAS2820 quando la piattaforma registra un messaggio di avviso sulla console di sistema che indica che un drive si è guastato. Sia il LED di errore sul pannello di visualizzazione dell'operatore che il LED di errore sul drive guasto sono accesi.
