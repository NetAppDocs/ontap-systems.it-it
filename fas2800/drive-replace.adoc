...
summary: 'Puoi sostituire a caldo un drive in un sistema FAS2820 quando la piattaforma registra un messaggio di avviso sulla console di sistema e i LED di errore sul pannello di controllo dell"operatore e sul drive guasto si illuminano. Puoi sostituire il drive senza interrompere l"I/O e i passaggi variano leggermente a seconda che il drive sia un SSD o un HDD.' 
---
