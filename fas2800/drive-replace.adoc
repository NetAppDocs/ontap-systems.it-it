...
summary: 'Devi sostituire a caldo un disco nel tuo sistema FAS2820 quando la piattaforma registra un messaggio di avviso sulla console di sistema che indica che un disco si è guastato. Sia il LED di errore sul pannello di controllo dell"operatore sia il LED di errore sul disco guasto sono accesi.' 
---
= Sostituisci a caldo un'unità in un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un disco guasto nel tuo sistema FAS2820 senza interrompere l'I/O per ripristinare la capacità e le prestazioni dello storage.
