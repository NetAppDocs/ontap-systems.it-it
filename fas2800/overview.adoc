...
summary: Specifiche chiave per il gruppo di piattaforme FAS2820 
---
= Specifiche chiave per un sistema FAS2820
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage FAS2820 in una singola coppia ad alta disponibilità. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] per le specifiche complete di questo sistema storage.
...
* Versione minima ONTAP : ONTAP 9.13.1RC1
