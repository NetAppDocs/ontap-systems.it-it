...
summary: Spegni il controller danneggiato nel tuo sistema storage FAS2820 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale dal boot. 
---
= Arresta il controller danneggiato nel tuo sistema FAS2820 durante il processo di ripristino manuale dal menu di boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni il controller danneggiato nel tuo sistema storage FAS2820 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale dal boot.
