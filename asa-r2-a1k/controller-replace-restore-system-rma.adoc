...
summary: Per completare la sostituzione del controller per il sistema ASA A1K, ripristina innanzitutto la configurazione di NetApp Storage Encryption, se necessario. Successivamente, conferma che le interfacce logiche stiano riportando alle loro porte home ed esegui un controllo dello stato di salute del cluster. Infine, restituisci la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
