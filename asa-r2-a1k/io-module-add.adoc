...
[role="lead"]
È possibile aggiungere un modulo i/o al sistema di archiviazione ASA A1K quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati.
