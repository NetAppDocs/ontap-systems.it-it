...
summary: 'Sostituire lo chassis del sistema ASA A1K quando un guasto hardware lo richiede. La procedura di sostituzione prevede la rimozione del controller, delle schede I/O, del modulo NVRAM12, del modulo di gestione del sistema e delle unità di alimentazione, l"installazione dello chassis di ricambio e la reinstallazione dei componenti dello chassis.' 
---
= Sostituisci lo chassis nel tuo sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
