...
. Recupera e verifica la passphrase a livello di cluster dal controller funzionante.
+
.. Eseguire il seguente comando per recuperare la passphrase a livello di cluster:
+
`security key-manager onboard show-backup`

.. Verifica la passphrase a livello di cluster utilizzando il seguente comando:
+
