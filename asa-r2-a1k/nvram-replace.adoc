...
---
= Sostituisci il modulo NVRAM in un sistema ASA A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il componente, è necessario riavviare il modulo controller ricollegando i cavi di alimentazione all'alimentatore.
