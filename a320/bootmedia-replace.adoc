...
summary: 'Il supporto di avvio memorizza un set primario e uno secondario di file immagine di avvio che il sistema utilizza all"avvio. Il sistema AFF A320 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire il supporto di avvio, è necessario rimuovere il modulo controller danneggiato, installare il supporto di avvio sostitutivo e trasferire l'immagine di avvio su un'unità flash USB. Il sistema AFF A320 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
...
== Passaggio 3: trasferire l'immagine di avvio utilizzando un'unità flash USB
