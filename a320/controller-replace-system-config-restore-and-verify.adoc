...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina e verifica la configurazione del controller nel tuo sistema AFF A320 dopo aver completato la sostituzione dell'hardware e l'avvio in modalità Manutenzione.
