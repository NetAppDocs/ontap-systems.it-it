...
---
= Sostituisci lo chassis nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo sistema AFF A320 trasferendo le ventole, i dischi rigidi e i moduli controller dallo chassis guasto a quello di ricambio.
