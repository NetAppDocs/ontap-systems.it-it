...
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel tuo sistema AFF A320, verifica i requisiti per una sostituzione corretta. La procedura prevede lo spostamento di tutte le ventole e i moduli controller dallo chassis guasto a quello di ricambio ed è un'operazione che comporta interruzioni.
