...
summary: Sostituire il NVDIMM nel modulo controller AFF A320 quando il sistema rileva che la durata della memoria flash sta per terminare o che il NVDIMM identificato non è integro. La mancata sostituzione di un NVDIMM difettoso può causare un system panic. 
---
= Sostituisci un modulo NVDIMM nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un NVDIMM nel tuo sistema AFF A320 quando il sistema rileva che la durata della flash sta per terminare o che l'NVDIMM identificato non è integro. La mancata sostituzione di un NVDIMM difettoso può causare un system panic.
