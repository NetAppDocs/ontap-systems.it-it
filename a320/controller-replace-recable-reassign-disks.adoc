...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller del tuo sistema AFF A320 ricablando lo storage e confermando la riassegnazione dei dischi.
