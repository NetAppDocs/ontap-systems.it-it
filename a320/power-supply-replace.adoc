...
summary: 'Sostituire un alimentatore nel sistema AFF A320 scollegando l"alimentatore di destinazione dalla fonte di alimentazione, scollegando il cavo di alimentazione, rimuovendo il vecchio alimentatore, installando l"alimentatore sostitutivo e quindi ricollegando l"alimentatore sostitutivo alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore in un sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire a caldo un alimentatore nel tuo sistema AFF A320, scollega, rimuovi e sostituisci l'unità guasta, quindi ricollegala per ripristinare l'alimentazione.
...
.Fasi
image::../media/drw_a320_psu_replace_animated_gif.png[Sostituire l'alimentatore]
