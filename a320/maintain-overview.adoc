...
summary: 'Mantieni l"hardware AFF A320' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per il sistema storage AFF A320, è possibile eseguire le procedure di manutenzione sui seguenti componenti.
