...
summary: Dopo aver verificato le variabili di ambiente, è necessario completare i passaggi specifici per i sistemi in cui sono abilitati Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption. Il sistema AFF A320 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristinare la crittografia sul supporto di avvio sostitutivo. Il sistema AFF A320 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
