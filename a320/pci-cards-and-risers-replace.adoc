...
---
= Sostituisci una scheda PCIe nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe nel tuo sistema AFF A320 scollegando i cavi e i moduli SFP/QSFP, rimuovendo il riser, sostituendo la scheda e ricablando.
