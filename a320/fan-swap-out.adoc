...
---
= Sostituisci a caldo una ventola nel tuo sistema AFF A320
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un modulo ventola nel tuo sistema AFF A320 senza interrompere il servizio, per mantenere un flusso d'aria e un raffreddamento del sistema adeguati.
...
image::../media/drw_A320_Replace_fan.png[Sostituire una ventola]
