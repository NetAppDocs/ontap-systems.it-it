...
summary: Sostituire il NVRAM nel sistema FAS70 o FAS90 quando la memoria non volatile si guasta o richiede un aggiornamento. 
---
= Sostituisci la NVRAM nel tuo sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il NVRAM nel sistema FAS70 o FAS90 quando la memoria non volatile si guasta o richiede un aggiornamento. Il processo di sostituzione prevede l'arresto del controller danneggiato, la sostituzione del modulo NVRAM o del modulo DIMM NVRAM, la riassegnazione dei dischi e la restituzione del componente guasto a NetApp.
...
Dopo aver sostituito la FRU, è necessario riavviare il modulo controller ricollegando i cavi di alimentazione all'alimentatore.
