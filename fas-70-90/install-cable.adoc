...
---
= Collega il tuo hardware FAS70 o FAS90 per la connettività di rete e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.A proposito di questa attività
I sistemi storage FAS70 e FAS90 supportano shelf DS212C, DS224C, DS460C e NS224 con modulo NSM100 o NSM100B.
