...
summary: Aggiungete un modulo I/O al vostro sistema FAS70 e FAS90 per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati. 
---
= Aggiungere un modulo i/o FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo di i/o a un sistema yourFAS70 e FAS90 per migliorare la connettività di rete e espandere la capacità del sistema di gestire il traffico dati.

È possibile aggiungere un modulo i/o al sistema di archiviazione FAS70 e FAS90 quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati.
