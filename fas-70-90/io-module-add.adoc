...
summary: Aggiungi un modulo I/O al tuo sistema FAS70 o FAS90 per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati. 
---
= Aggiungi un modulo I/O a un sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo I/O al tuo sistema FAS70 o FAS90 per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati.

Puoi aggiungere un modulo I/O al tuo sistema storage FAS70 o FAS90 quando ci sono slot liberi disponibili o quando tutti gli slot sono completamente occupati.
