...
summary: Installa il tuo sistema storage in un armadio o in un rack per telecomunicazioni. 
---
= Installa l'hardware FAS70 o FAS90 in un cabinet o rack
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver preparato l'installazione del sistema di archiviazione FAS70 o FAS90, installare l'hardware per il sistema. Per prima cosa, montare i kit guide. Quindi installare e fissare la piattaforma in un cabinet o in un rack per telecomunicazioni.
...
Dopo che hai installato l'hardware per il tuo sistema storage FAS70 o FAS90, link:install-cable.html["cablare l'hardware per il tuo sistema storage FAS70 o FAS90"].
