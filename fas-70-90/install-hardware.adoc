...
Dopo aver installato l'hardware per il sistema di storage FAS70 o FAS90, si link:install-cable.html["Collegare l'hardware per il sistema di storage FAS70 o FAS90."].
