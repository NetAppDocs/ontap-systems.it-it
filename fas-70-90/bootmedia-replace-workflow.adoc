...
summary: 'Questo workflow utilizza un"unità USB per reinstallare ONTAP sul supporto di boot sostitutivo nel tuo sistema FAS70 o FAS90. Scarica l"immagine di ripristino ONTAP appropriata dal NetApp Support Site, copiala sull"unità USB e usala per ripristinare il sistema allo stato operativo.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema FAS70 o FAS90 utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Questo workflow utilizza un'unità USB per reinstallare ONTAP sul supporto di boot sostitutivo nel tuo sistema FAS70 o FAS90. Scarica l'immagine di ripristino ONTAP appropriata dal NetApp Support Site, copiala sull'unità USB e usala per ripristinare il sistema allo stato operativo.
