...
summary: Per garantire la sicurezza dei dati sul sistema di storage FAS70 o FAS90, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Verificare se la versione di ONTAP supporta NetApp Volume Encryption e, prima di arrestare il controller, verificare che il gestore delle chiavi sia attivo. 
---
= Controlla il supporto della crittografia sul supporto di avvio in un sistema FAS70 o FAS90 usando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema di storage FAS70 o FAS90, è necessario verificare il supporto della chiave di crittografia e lo stato sul supporto di avvio. Verifica se la versione di ONTAP supporta la crittografia dei volumi di NetApp (NVE) e prima di arrestare il controller verifica se il gestore delle chiavi è attivo.
