...
summary: Sostituisci il DIMM nel tuo sistema FAS70 o FAS90 se vengono rilevati errori di memoria correggibili o non correggibili in eccesso. Tali errori possono impedire al sistema storage di avviare ONTAP. La procedura di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e poi la restituzione del componente guasto a NetApp. 
---
= Sostituisci un modulo DIMM in un sistema FAS70 o FAS90 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Le posizioni dei moduli DIMM dipendono dal modello di sistema:
...
| FAS70 | Slot 3, 10, 19, 26 


| FAS90 | Slot 3, 7, 10, 14, 19, 23, 26, 30 
|===
