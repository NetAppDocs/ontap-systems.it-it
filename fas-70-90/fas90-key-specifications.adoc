...
---
= Specifiche chiave per un sistema FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage FAS90 in una singola coppia ad alta disponibilità. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema storage.
...
* Fattore di forma: chassis 2U con un controller HA
* Slot di espansione PCIe: 18
* Versione minima ONTAP : ONTAP 9.15.1
...
* Profondità: 30,0" (35,2" con staffa per la gestione dei cavi)
