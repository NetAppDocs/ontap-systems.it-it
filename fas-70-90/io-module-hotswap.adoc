...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage FAS 70 o FAS 90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Hot swap di un modulo I/O - FAS 70 e FAS 90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage FAS 70 o FAS 90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
