...
summary: Puoi effettuare lo swap a caldo di un modulo I/O Ethernet nel tuo sistema storage FAS70 o FAS90 se un modulo si guasta e il tuo sistema storage soddisfa tutti i requisiti di versione di ONTAP. 
---
= Sostituisci a caldo un modulo I/O nel tuo sistema FAS70 o FAS90 senza spegnerlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi effettuare lo swap a caldo di un modulo I/O Ethernet nel tuo sistema storage FAS70 o FAS90 se un modulo si guasta e il tuo sistema storage soddisfa tutti i requisiti di versione di ONTAP.
...
* Assicurati di applicare i comandi al controller corretto e allo slot I/O durante lo swap a caldo:
+
...
== Passaggio 3: sostituire il modulo I/O guasto
