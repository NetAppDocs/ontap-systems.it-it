...
summary: 'Il ripristino automatico dell"immagine di boot prevede che il sistema identifichi e selezioni automaticamente l"opzione appropriata dal menu di boot. Utilizza l"immagine di boot presente sul nodo partner per reinstallare ONTAP sul supporto di boot sostitutivo nel tuo sistema storage FAS70 o FAS90.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema FAS70 o FAS90 tramite il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il ripristino automatico dell'immagine di boot prevede che il sistema identifichi e selezioni automaticamente l'opzione appropriata dal menu di boot. Utilizza l'immagine di boot presente sul nodo partner per reinstallare ONTAP sul supporto di boot sostitutivo nel tuo sistema storage FAS70 o FAS90.
