...
---
= Accendi il tuo sistema storage FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato l'hardware del rack per il tuo sistema storage FAS70 o FAS90 e aver collegato i cavi per i controller e gli shelf di storage, dovresti accendere gli shelf di storage e i controller.
