...
---
= Specifiche chiave per un sistema FAS70
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste sono alcune specifiche del sistema storage FAS70 in una singola coppia ad alta disponibilità. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema storage.
