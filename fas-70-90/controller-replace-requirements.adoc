...
summary: 'Prima di sostituire il controller nel tuo sistema FAS70 o FAS90, assicurati di soddisfare i requisiti necessari per una sostituzione riuscita. Questo include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la conferma di avere il controller di ricambio corretto e il salvataggio dell"output della console del controller in un file di log di testo.' 
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver esaminato i requisiti per sostituire il controller FAS70 o FAS90, è necessario link:controller-replace-shutdown.html["spegnere il controller danneggiato"].
