...
summary: 'Sostituire l"alimentatore CA o CC (PSU) del sistema FAS70 o FAS90 quando si guasta o presenta malfunzionamenti, per garantire che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"alimentatore difettoso dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"alimentatore difettoso e quindi ricollegarlo alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
