...
---
= Preparati a installare il tuo sistema storage FAS70 o FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo che ti sei preparato per installare l'hardware FAS70 o FAS90, link:install-hardware.html["Installazione dell'hardware per il sistema di storage FAS70 o FAS90"].
