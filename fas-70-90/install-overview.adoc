...
---
= Flusso di lavoro per l'installazione e la configurazione di FAS70 e FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Esamina l'attrezzatura e gli strumenti necessari per installare il sistema storage e le scaffalature. Esamina anche le precauzioni di sollevamento e sicurezza.
...
[role="quick-margin-para"]
Per prepararti all'installazione del sistema, devi predisporre il sito, verificare i requisiti ambientali ed elettrici e accertarti che ci sia abbastanza spazio rack. Poi, disimballa l'hardware, confronta il contenuto con la bolla di accompagnamento e registra l'hardware per accedere ai vantaggi del supporto.
...
[role="quick-margin-para"]
Prima di accendere i controller, accendi ciascun shelf NS224 e assegna un ID shelf univoco così che ogni shelf sia identificato in modo univoco. Poi collega il laptop o la console al controller e collega i controller alle fonti di alimentazione.
