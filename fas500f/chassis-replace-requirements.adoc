...
summary: Prima di sostituire lo chassis nel sistema FAS500f, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del corretto chassis di ricambio e degli strumenti necessari. 
---
= Requisiti per la sostituzione del chassis - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel sistema FAS500f, assicurati di soddisfare i requisiti necessari per una sostituzione di successo. Ciò include la verifica che tutti gli altri componenti del sistema funzionino correttamente, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del corretto chassis di ricambio e degli strumenti necessari.
