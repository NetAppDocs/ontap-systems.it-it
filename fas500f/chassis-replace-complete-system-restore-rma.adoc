...
---
= Completa la sostituzione dello chassis del tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Riavviare i controller, verificare lo stato del sistema e restituire la parte guasta a NetApp per completare il passaggio finale nella procedura di sostituzione dello chassis FAS500f.
