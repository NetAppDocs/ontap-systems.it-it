...
---
= Sostituisci a caldo l'alimentatore nel tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Ruota la maniglia a camma per estrarre l'alimentatore dal modulo di controllo mentre premi la linguetta di bloccaggio.
+
[CAUTION]
====
...
+
Gli alimentatori si innestano nel connettore interno e si bloccano in posizione in un solo modo.
