...
summary: Specifiche chiave per il sistema storage FAS500f 
---
= Specifiche chiave per un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Esamina le specifiche selezionate del sistema storage FAS500f, relative a una singola coppia ad alta disponibilità. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per l'elenco completo delle specifiche del FAS500f.



[[key-specifications-for-fas500f]]
=== Specifiche chiave per FAS500f

Configurazione della piattaforma: FAS500f coppia HA a chassis singolo
