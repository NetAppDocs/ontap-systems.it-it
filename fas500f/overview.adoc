...
[role="lead"]
Di seguito sono riportate alcune specifiche per il FAS500f. Visita https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche del FAS500f. Questa pagina si riferisce a una singola coppia ad alta disponibilità.
