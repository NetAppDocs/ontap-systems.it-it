...
summary: 'Inizia a sostituire il supporto di avvio nel tuo sistema storage FAS500f esaminando i requisiti di sostituzione, controllando lo stato della crittografia, arrestando il controller, sostituendo il supporto di avvio, avviando l"immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema FAS500f utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Inizia a sostituire il supporto di avvio nel tuo sistema storage FAS500f esaminando i requisiti di sostituzione, controllando lo stato della crittografia, arrestando il controller, sostituendo il supporto di avvio, avviando l'immagine di ripristino, ripristinando la crittografia e verificando la funzionalità del sistema.
