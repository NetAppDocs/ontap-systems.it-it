...
---
= Spegni il controller FAS500f per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta i controller nel tuo sistema storage FAS500f per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
