...
---
= Sostituzione completa del controller - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per completare la sostituzione del controller per il tuo sistema FAS500f e ripristinarne la piena operatività, è necessario ripristinare la configurazione NetApp Storage Encryption (se necessario), installare le licenze per il nuovo controller e restituire la parte guasta a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
