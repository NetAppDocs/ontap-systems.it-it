...
summary: Per completare la sostituzione del controller per il sistema FAS500f, ripristina la configurazione di NetApp Storage Encryption se necessario, installa le licenze per il nuovo controller e restituisci il componente guasto a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per completare la sostituzione del controller per il tuo sistema FAS500f, ripristina la configurazione di NetApp Storage Encryption (se necessario), installa le licenze per il nuovo controller e restituisci il componente guasto a NetApp come descritto nelle istruzioni RMA fornite con il kit.
