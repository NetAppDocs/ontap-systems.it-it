...
summary: 'Sostituisci un"unità guasta nel tuo sistema storage FAS500f in modo non distruttivo mentre l"I/O è in corso. La piattaforma registra un messaggio di avviso e accende i LED di errore quando un"unità si guasta, e la procedura di sostituzione varia leggermente a seconda che l"unità sia un SSD o un HDD.' 
---
= Sostituisci a caldo un'unità nel tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità guasta nel tuo sistema storage FAS500f in modo non distruttivo mentre l'I/O è in corso. La piattaforma registra un messaggio di avviso e accende i LED di errore quando un'unità si guasta, e la procedura di sostituzione varia leggermente a seconda che l'unità sia un SSD o un HDD.
