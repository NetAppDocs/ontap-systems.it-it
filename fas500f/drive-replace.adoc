...
summary: Sostituisci a caldo un disco guasto nel tuo sistema storage FAS500f senza interrompere le operazioni di I/O. La piattaforma registra un messaggio di avviso e accende i LED di errore quando un disco si guasta, e la procedura di sostituzione varia leggermente a seconda che il disco sia un SSD o un HDD. 
---
= Sostituisci a caldo un'unità in un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un disco guasto nel tuo sistema storage FAS500f senza interrompere le operazioni di I/O. La piattaforma registra un messaggio di avviso e accende i LED di errore quando un disco si guasta, e la procedura di sostituzione varia leggermente a seconda che il disco sia un SSD o un HDD.
