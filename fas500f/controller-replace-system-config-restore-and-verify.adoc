...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema FAS500f in modalità di manutenzione, è necessario verificare la configurazione di basso livello del sistema del controller sostitutivo e riconfigurare le impostazioni di sistema secondo necessità.
