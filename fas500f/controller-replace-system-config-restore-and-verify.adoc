...
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema FAS500f in modalità Maintenance, devi verificare la configurazione di basso livello del controller sostitutivo e riconfigurare le impostazioni di sistema se necessario.
