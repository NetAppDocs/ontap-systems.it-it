...
summary: Sostituisci il DIMM in un sistema FAS500f quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili o non correggibili tramite gli avvisi di Health Monitor. Un DIMM guasto può impedire al sistema storage di avviare ONTAP, quindi la sostituzione ripristina il funzionamento stabile. Questa procedura include lo spegnimento del controller compromesso, la sostituzione del DIMM e la restituzione della parte guasta a NetApp. 
---
= Sostituisci un modulo DIMM in un sistema FAS500f per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il DIMM in un sistema FAS500f quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili o non correggibili tramite gli avvisi di Health Monitor. Un DIMM guasto può impedire al sistema storage di avviare ONTAP, quindi la sostituzione ripristina il funzionamento stabile. Questa procedura include lo spegnimento del controller compromesso, la sostituzione del DIMM e la restituzione della parte guasta a NetApp.
