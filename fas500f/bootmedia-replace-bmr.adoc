...
summary: 'Il boot media nel tuo sistema FAS500f memorizza dati essenziali del firmware e della configurazione. La sostituzione comporta la rimozione del modulo controller, la rimozione del boot media danneggiato, l"installazione del boot media sostitutivo e la reinstallazione del modulo controller.' 
---
= Sostituisci il supporto di avvio nel tuo sistema FAS500f utilizzando la procedura di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il boot media nel tuo sistema FAS500f memorizza dati essenziali del firmware e della configurazione. La sostituzione comporta la rimozione del modulo controller, la rimozione del boot media danneggiato, l'installazione del boot media sostitutivo e la reinstallazione del modulo controller.
