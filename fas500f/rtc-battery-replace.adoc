...
summary: È necessario sostituire la batteria del real-time clock nel modulo controller affinché i servizi e le applicazioni del sistema che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio in tempo reale in un sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tutti gli altri componenti del sistema devono funzionare correttamente. In caso contrario, contatta il supporto tecnico.
...
Per sostituire la batteria RTC, è possibile utilizzare il seguente video o la procedura riportata in tabella:
...
+
image::../media/drw_a250_remove_rtc_batt.png[Come rimuovere la batteria RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Numero di didascalia 1"]
| Estrarre delicatamente la linguetta dall'alloggiamento della batteria. NOTA: Se tirata in modo aggressivo, la linguetta potrebbe spostarsi. 
...
NOTE: Prendere nota della polarità della batteria.
...
+
image::../media/drw_a250_install_rtc_batt.png[Installazione della batteria RTC]
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Numero di didascalia 1"]
| Fai scorrere la batteria sotto la linguetta dell'alloggiamento della batteria con la polarità positiva rivolta verso l'alto. 
