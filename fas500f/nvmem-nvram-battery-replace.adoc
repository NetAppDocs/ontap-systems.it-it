...
---
= Sostituisci la batteria NVMEM nel tuo sistema FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il componente nel modulo controller, devi reinstallare il modulo controller nello chassis e poi avviarlo.
