...
---
= Installa un sistema FAS500f usando istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:../media/icon_square_1_green.png["Fase 1"]
 a| 
Collegare tra loro le porte di interconnessione del cluster con il cavo di interconnessione del cluster da 25 GbE
...
.. Seleziona *Network* nel riquadro a sinistra.
