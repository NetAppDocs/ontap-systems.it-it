...
---
= Restituisci il controller nel tuo sistema FAS500f per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo così il tuo sistema FAS500f può riprendere il normale funzionamento. Dopo che hai ripristinato e verificato la configurazione del sistema, ricollega il sistema e riassegna i dischi.
