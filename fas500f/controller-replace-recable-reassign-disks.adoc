...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo così il tuo sistema FAS500f può riprendere le normali operazioni. 
---
= Restituisci il controller in un sistema FAS500f per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il sistema FAS500f possa riprendere le normali operazioni. Dopo che hai ripristinato e verificato la configurazione del sistema, ricollega il sistema e riassegna i dischi.
...
Dopo aver ricablato il sistema e riassegnato i dischi, è necessario link:controller-replace-restore-system-rma.html["completare la sostituzione della centralina"].
