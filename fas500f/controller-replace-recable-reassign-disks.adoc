...
---
= Riscrivere il sistema e riassegnare i dischi - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato il ripristino e la verifica della configurazione del sistema FAS500f, è necessario ricollegare il sistema e riassegnare i dischi.
