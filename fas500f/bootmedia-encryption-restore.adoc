...
summary: 'Dopo aver verificato le variabili d"ambiente, devi completare i passaggi specifici per i sistemi che hanno Onboard Key Manager OKM, NetApp Storage Encryption NSE o NetApp Volume Encryption NVE abilitati.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema FAS500f dopo la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver sostituito il boot media, ripristina la crittografia se il tuo sistema FAS500f utilizza Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption per proteggere i tuoi dati.
