...
---
= Scopri come aggiungere e sostituire i moduli I/O nei tuoi sistemi ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Per utilizzare questa procedura, il tuo sistema storage deve essere in esecuzione con ONTAP 9.18.1.
