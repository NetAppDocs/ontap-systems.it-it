...
summary: Spegnere i controller del sistema storage ASA A70 o ASA A90 quando è necessario sostituire lo chassis. È fondamentale spegnere i controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema. 
---
...
[role="lead"]
Spegnere i controller del sistema storage ASA A70 o ASA A90 quando è necessario sostituire lo chassis. È fondamentale spegnere i controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema.
