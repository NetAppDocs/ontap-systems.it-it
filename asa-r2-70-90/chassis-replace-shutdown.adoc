...
summary: Spegnere i controller del sistema di storage ASA A70 o ASA A90 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis. 
---
= Spegnere i controller per sostituire lo chassis - ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere i controller del sistema di storage ASA A70 o ASA A90 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
...
Una volta arrestati i controller, è necessario link:chassis-replace-move-hardware.html["sostituire il telaio"].
