...
---
= Sostituisci il modulo di gestione del sistema nel tuo sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
WARNING: Il modulo di gestione del sistema non è hot-swappable. Prima di sostituirlo, reinserisci le unità, spegni il nodo, scollega l'alimentazione del controller ed estrai il controller di qualche centimetro dallo chassis.
