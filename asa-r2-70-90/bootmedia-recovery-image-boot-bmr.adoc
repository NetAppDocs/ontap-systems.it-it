...
summary: 'Se il supporto di avvio nel sistema ASA A70 o ASA A90 è danneggiato, è possibile avviare l"immagine di ripristino, ripristinare la configurazione dal nodo partner e verificare le variabili di ambiente.' 
---
