...
summary: 'Sostituire un modulo ventola nel sistema ASA A70 o ASA A90 in caso di guasto o funzionamento non efficiente di una ventola, in quanto ciò può influire sul raffreddamento del sistema e sulle prestazioni generali. Il processo di sostituzione prevede l"arresto del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp.' 
---
= Sostituisci un modulo ventola nel tuo sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un modulo ventola nel sistema ASA A70 o ASA A90 in caso di guasto o funzionamento non efficiente di una ventola, in quanto ciò può influire sul raffreddamento del sistema e sulle prestazioni generali. Il processo di sostituzione prevede l'arresto del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp.
