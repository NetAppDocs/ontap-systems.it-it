...
---
= Sostituisci il controller nel tuo sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver sostituito il controller ASA A70 o ASA A90 danneggiato, è necessariolink:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"] .
