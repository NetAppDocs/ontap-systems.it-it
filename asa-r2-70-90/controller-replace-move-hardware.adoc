...
summary: 'Sostituire il controller nel sistema ASA A70 o ASA A90 quando è necessario eseguire un aggiornamento o un guasto hardware. Questo processo prevede la rimozione del controller danneggiato, lo spostamento dei componenti nel controller sostitutivo, l"installazione del controller sostitutivo e il riavvio del sistema.' 
---
= Sostituire l'hardware del modulo controller - ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema ASA A70 o ASA A90 quando è necessario eseguire un aggiornamento o un guasto hardware. Questo processo prevede la rimozione del controller danneggiato, lo spostamento dei componenti nel controller sostitutivo, l'installazione del controller sostitutivo e il riavvio del sistema.
