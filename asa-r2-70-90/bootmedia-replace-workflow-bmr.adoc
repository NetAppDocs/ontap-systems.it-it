...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Quattro"]link:bootmedia-recovery-image-boot-bmr.html["Ripristino dell'immagine sul supporto di avvio (ripristino automatico dell'avvio)"]
[role="quick-margin-para"]
