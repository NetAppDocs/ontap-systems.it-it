...
---
= Sostituisci un modulo I/O nel tuo sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Puoi utilizzare questa procedura con tutte le versioni di ONTAP supportate dal tuo sistema di archiviazione.
