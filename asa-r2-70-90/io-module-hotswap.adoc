...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage ASA A70 o ASA A90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Eseguire lo swap a caldo di un modulo I/O - ASA A70 e ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage ASA A70 o ASA A90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
