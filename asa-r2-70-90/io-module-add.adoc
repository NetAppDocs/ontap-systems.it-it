...
summary: Aggiungi un modulo i/o al sistema ASA A70 o ASA A90 per migliorare la connettività di rete e ampliare la capacità del sistema di gestire il traffico dei dati. 
---
= Aggiungi un modulo I/O a un sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo i/o al sistema ASA A70 o ASA A90 per migliorare la connettività di rete e ampliare la capacità del sistema di gestire il traffico dei dati.

È possibile aggiungere un modulo I/O al sistema di archiviazione ASA A70 e ASA A90 quando sono disponibili slot vuoti o quando tutti gli slot sono completamente occupati.
