...
È possibile aggiungere un modulo i/o al sistema di archiviazione ASA A70 e ASA A90 quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati. .Informazioni su questa attività
