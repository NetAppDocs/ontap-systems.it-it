...
[role="lead"]
È necessario rimuovere componenti specifici dai moduli controller prima di rimuovere il telaio danneggiato, sostituire il telaio, reinstallare i componenti nei moduli controller corretti, quindi riportare le centraline al normale funzionamento.
