...
summary: 'Sostituire lo chassis del sistema ASA A70 o ASA A90 quando un guasto hardware lo richiede. Questo processo prevede lo spegnimento del sistema, la rimozione del telaio esistente, l"installazione del nuovo e la riconfigurazione dei componenti per garantire il corretto funzionamento del sistema.' 
---
...
[role="lead"]
Sostituire lo chassis del sistema ASA A70 o ASA A90 quando un guasto hardware lo richiede. Questo processo prevede lo spegnimento del sistema, la rimozione del telaio esistente, l'installazione del nuovo e la riconfigurazione dei componenti per garantire il corretto funzionamento del sistema.
