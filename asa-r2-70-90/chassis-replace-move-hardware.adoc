...
summary: 'Sostituire lo chassis del sistema ASA A70 o ASA A90 quando un guasto hardware lo richiede. La procedura di sostituzione prevede la rimozione dei controller e delle unità di alimentazione, la rimozione dei dischi, l"installazione dello chassis di ricambio e la reinstallazione dei componenti dello chassis.' 
---
= Sostituisci lo chassis nel tuo sistema ASA A70 o ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il telaio del tuo ASA A70 e ASA A90 quando un guasto hardware lo richiede.  Rimuovere i controller e gli alimentatori (PSU), rimuovere le unità, installare il telaio sostitutivo e reinstallare tutti i componenti.
...
== Fase 3: sostituire il telaio e installare i componenti

Rimuovere il telaio danneggiato, installare il telaio sostitutivo e reinstallare tutti i componenti.
...
Dopo aver sostituito il telaio danneggiato e reinstallato i componenti,link:chassis-replace-complete-system-restore-rma.html["completare la sostituzione del telaio"] .
