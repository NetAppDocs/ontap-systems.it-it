...
summary: Inizia a sostituire lo chassis del sistema di storage ASA A70 o ASA A90 spegnendo i controller, rimuovendo e sostituendo lo chassis e verificando il funzionamento del sistema. 
---
...
[role="lead"]
Inizia a sostituire lo chassis del sistema di storage ASA A70 o ASA A90 spegnendo i controller, rimuovendo e sostituendo lo chassis e verificando il funzionamento del sistema.
