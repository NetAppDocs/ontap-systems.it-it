...
summary: Spegnere il controller danneggiato nel sistema di storage AFF A70 o AFF A90 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del supporto di avvio. 
---
