...
summary: Spegnere i controller del sistema storage AFF A70 o AFF A90 quando è necessario sostituire lo chassis. Prima di eseguire la manutenzione o la sostituzione dei componenti, è fondamentale spegnere il controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema. 
---
= Spegnere le centraline - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere i controller del sistema storage AFF A70 o AFF A90 quando è necessario sostituire lo chassis. Prima di eseguire la manutenzione o la sostituzione dei componenti, è fondamentale spegnere il controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema.
