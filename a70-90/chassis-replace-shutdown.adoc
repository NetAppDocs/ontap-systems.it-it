...
summary: Arrestare i controller nel sistema di storage AFF A70 o AFF A90 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis. 
---
= Spegnere i controller per sostituire lo chassis - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrestare i controller nel sistema di storage AFF A70 o AFF A90 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
...
Dopo aver spento i controller,link:chassis-replace-move-hardware.html["sostituire il telaio"] .
