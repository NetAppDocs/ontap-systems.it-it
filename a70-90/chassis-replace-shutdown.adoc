...
summary: Spegnere i controller del sistema storage AFF A70 o AFF A90 quando è necessario sostituire lo chassis. È fondamentale spegnere il controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema. 
---
...
[role="lead"]
Spegnere i controller del sistema storage AFF A70 o AFF A90 quando è necessario sostituire lo chassis. È fondamentale spegnere i controller in modo sicuro per evitare perdite di dati e garantire la stabilità del sistema.
