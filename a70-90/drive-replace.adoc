...
summary: 'Sostituire un"unità nel sistema AFF A70 o AFF A90 quando un"unità si guasta o richiede un aggiornamento. Questo processo prevede l"identificazione dell"unità guasta, la rimozione sicura e l"installazione di una nuova unità per garantire l"accesso continuo ai dati e le prestazioni del sistema.' 
---
= Sostituire l'unità SSD - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un'unità nel sistema AFF A70 o AFF A90 quando un'unità si guasta o richiede un aggiornamento. Questo processo prevede l'identificazione dell'unità guasta, la rimozione sicura e l'installazione di una nuova unità per garantire l'accesso continuo ai dati e le prestazioni del sistema.
