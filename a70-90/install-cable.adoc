...
---
= Collega il tuo hardware AFF A70 o AFF A90 per la connettività di rete e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Non utilizzare le porte e1b ed e7b per le connessioni di rete host. Usa una scheda host separata.
...
. Collega le tue schede 10/25 GbE agli switch della rete host.
+
...
Le seguenti procedure di cablaggio mostrano come collegare i controller a uno shelf di storage. Scegli una delle seguenti opzioni di cablaggio che corrispondono alla tua configurazione.
...
.A proposito di questa attività
I sistemi di storage AFF A70 e AFF A90 supportano gli shelf NS224 con il modulo NSM100 o NSM100B. Le principali differenze tra i moduli sono:
...
.. Collega la porta e11b allo shelf 2, porta e0b dell'NSM A.
+
...
Dopo che hai collegato l'hardware per il tuo sistema AFF A70 o AFF A90, link:install-power-hardware.html["Accendere il sistema di archiviazione AFF A70 o AFF A90"].
