...
[role="lead"]
Sostituire lo chassis del sistema AFF A70 o AFF A90 quando è necessario un errore hardware o un aggiornamento. Il processo di sostituzione prevede la rimozione delle unità di alimentazione (PSU), la rimozione del telaio esistente, l'installazione di quello nuovo e la reinstallazione dei componenti del telaio.
