...
---
= Sostituisci un modulo DIMM nel tuo sistema AFF A70 o AFF A90 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Prima di iniziare
* Assicurati che tutti gli altri componenti del sistema funzionino correttamente. In caso contrario, contatta il supporto tecnico.
...
Per sostituire il modulo DIMM, individualo all'interno del controller e segui la sequenza specifica di passaggi.
