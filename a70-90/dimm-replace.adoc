...
summary: Sostituire un modulo DIMM nel sistema AFF A70 o AFF A90 quando vengono rilevati errori correggibili o non correggibili eccessivi. Questi problemi, spesso causati da un errore di un singolo DIMM, possono impedire al sistema di storage di avviare ONTAP. 
---
...
[role="lead"]
Sostituire un modulo DIMM nel sistema AFF A70 o AFF A90 quando vengono rilevati errori correggibili o non correggibili eccessivi. Questi problemi, spesso causati da un errore di un singolo DIMM, possono impedire al sistema di storage di avviare ONTAP.
