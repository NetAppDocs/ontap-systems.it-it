...
summary: 'Se il supporto di avvio nel sistema AFF A70 o AFF A90 è danneggiato, è possibile avviare l"immagine di ripristino da un"unità USB e ripristinare la configurazione dal nodo partner.' 
---
...
[role="lead"]
Se il supporto di avvio nel sistema AFF A70 o AFF A90 è danneggiato, è possibile avviare l'immagine di ripristino da un'unità USB e ripristinare la configurazione dal nodo partner.
