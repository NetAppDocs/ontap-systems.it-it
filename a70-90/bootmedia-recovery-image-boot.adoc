...
summary: 'Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema AFF A70 o AFF A90, è possibile avviare l"immagine di ripristino da un"unità USB e ripristinare la configurazione dal nodo partner.' 
---
...
[role="lead"]
Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema AFF A70 o AFF A90, è possibile avviare l'immagine di ripristino da un'unità USB e ripristinare la configurazione dal nodo partner.
