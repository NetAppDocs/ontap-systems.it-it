...
summary: 'Se il supporto di avvio nel sistema AFF A70 o AFF A90 è danneggiato, è possibile avviare l"immagine di ripristino da un"unità USB, ripristinare la configurazione dal nodo partner e verificare le variabili di ambiente.' 
---
...
[role="lead"]
Se il supporto di avvio nel sistema AFF A70 o AFF A90 è danneggiato, è possibile avviare l'immagine di ripristino da un'unità USB, ripristinare la configurazione dal nodo partner e verificare le variabili di ambiente.
