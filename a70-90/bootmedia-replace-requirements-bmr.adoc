...
summary: Prima di sostituire il supporto di avvio nel sistema di archiviazione AFF A70 o AFF A90 , accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita. 
---
