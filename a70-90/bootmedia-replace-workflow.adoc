...
---
= Avvio rapido per la sostituzione dei supporti di avvio - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire i supporti di avvio nel sistema di storage AFF A70 o AFF A90 preparando i supporti sostitutivi, installandoli nel sistema, ripristinando l'immagine di avvio e verificando la funzionalità del sistema.
