...
---
= Flusso di lavoro per la sostituzione dei supporti di avvio - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Prima di iniziare
Per sostituire i supporti di avvio, il deve soddisfare determinati requisiti. Esaminare la link:bootmedia-replace-requirements.html["requisiti e considerazioni sui supporti di avvio"].
