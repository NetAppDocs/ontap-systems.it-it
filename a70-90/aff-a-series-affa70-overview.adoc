...
[role="lead"]
Consulta le specifiche selezionate per il sistema storage AFF A70 in una configurazione a coppia HA singola. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche di AFF A70.
...
* Profondità: 34,5" (36,6" con staffa di gestione dei cavi)
