...
[role="lead"]
Per completare il processo di sostituzione dello chassis, è necessario eseguire il boot da ONTAP, restituire lo storage, verificare lo stato di salute del sistema storage e restituire lo chassis guasto a NetApp.
