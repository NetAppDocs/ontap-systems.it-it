...
---
= Procedura di installazione e configurazione di AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Prima di accendere i controller, accendi ogni shelf NS224 e assegna un ID shelf univoco. Poi collega il laptop o la console al controller e collega i controller alle fonti di alimentazione.
