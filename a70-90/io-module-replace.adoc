...
[role="lead"]
Sostituire un modulo i/o nel sistema AFF A70 o AFF A90 in caso di guasto del modulo o se è necessario un aggiornamento per supportare prestazioni più elevate o funzioni aggiuntive.
