...
---
= Sostituire il modulo i/o - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se il sistema di storage è dotato di alimentatori CC, scollegare il blocco cavi di alimentazione dalle PSU.
...
+
Il dispositivo di chiusura della camma si allontana dal modulo di controllo.
...
NOTE: Se si dispone di alimentatori CC, ricollegare i blocchi cavi alle PSU.
