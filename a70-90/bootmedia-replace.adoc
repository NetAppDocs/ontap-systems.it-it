...
summary: Il supporto di avvio del sistema AFF A70 o AFF A90 memorizza i dati di configurazione e il firmware essenziali. Se il supporto di avvio non funziona, è necessario scollegare il modulo controller, rimuovere il modulo di gestione del sistema, rimuovere il supporto di avvio danneggiato e sostituire il supporto di avvio nel modulo di gestione del sistema. 
---
...
[role="lead"]
Il supporto di avvio del sistema AFF A70 o AFF A90 memorizza i dati di configurazione e il firmware essenziali. Se il supporto di avvio non funziona, è necessario scollegare il modulo controller, rimuovere il modulo di gestione del sistema, rimuovere il supporto di avvio danneggiato e sostituire il supporto di avvio nel modulo di gestione del sistema.
