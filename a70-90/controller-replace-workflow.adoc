...
summary: La sostituzione del controller AFF A70 e AFF A90 include le operazioni necessarie per arrestare il controller, rimuovere e sostituire il controller, riconfigurare le impostazioni di sistema e verificare il funzionamento del sistema. 
---
= Avvio rapido per la sostituzione della centralina - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La sostituzione del controller AFF A70 e AFF A90 include le operazioni necessarie per arrestare il controller, rimuovere e sostituire il controller, riconfigurare le impostazioni di sistema e verificare il funzionamento del sistema.
