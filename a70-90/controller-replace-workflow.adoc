...
[role="lead"]
Inizia a sostituire il controller nel sistema di storage AFF A70 o AFF A90 spegnendo il controller danneggiato, rimuovendo e sostituendo il controller, ripristinando la configurazione del sistema e verificando il funzionamento del sistema.
