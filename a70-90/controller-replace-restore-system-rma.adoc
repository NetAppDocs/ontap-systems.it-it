...
[role="lead"]
Verificare che le interfacce logiche riportino la porta home, eseguire un controllo dello stato di salute del cluster e restituire il componente guasto a NetApp per completare l'ultima fase della procedura di sostituzione dei controller AFF A70 e AFF A90.
