...
[role="lead"]
Consulta le specifiche selezionate per il sistema storage AFF A90 in una configurazione a coppia HA singola. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche di AFF A90.
