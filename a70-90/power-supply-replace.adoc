...
summary: 'Sostituire un"unità di alimentazione CA o CC (PSU) nel sistema AFF A70 o AFF A90 in caso di guasto o guasto, assicurandosi che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. Il processo di sostituzione prevede lo scollegamento dell"alimentatore difettoso dalla fonte di alimentazione, lo scollegamento del cavo di alimentazione, la sostituzione dell"alimentatore difettoso e il ricollegamento alla fonte di alimentazione.' 
---
