...
summary: 'Sostituire un"unità di alimentazione CA o CC nel sistema AFF A70 o AFF A90 quando si guasta o presenta un malfunzionamento, assicurando che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"unità di alimentazione difettosa dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"unità di alimentazione difettosa e quindi ricollegarla alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un'unità di alimentazione CA o CC (PSU) nel sistema AFF A70 o AFF A90 in caso di guasto o guasto, assicurandosi che il sistema continui a ricevere l'alimentazione necessaria per un funzionamento stabile. Il processo di sostituzione prevede lo scollegamento dell'alimentatore difettoso dalla fonte di alimentazione, lo scollegamento del cavo di alimentazione, la sostituzione dell'alimentatore difettoso e il ricollegamento alla fonte di alimentazione.
...
Questa procedura è scritta per sostituire un alimentatore alla volta. Utilizzare la procedura appropriata per il tipo di PSU: AC o DC.
...
+
Per evitare di danneggiare il connettore interno, non esercitare una forza eccessiva quando si inserisce l'alimentatore nel sistema.
