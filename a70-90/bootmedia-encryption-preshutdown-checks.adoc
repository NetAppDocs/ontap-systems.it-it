...
summary: Per garantire la sicurezza dei dati sul sistema storage AFF A70 o AFF A90, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Controlla se la versione di ONTAP supporta NetApp Volume Encryption e, prima di spegnere il controller, verifica che il key manager sia attivo. 
---
= Verifica il supporto della crittografia sul supporto di avvio in un sistema AFF A70 o AFF A90 utilizzando la procedura di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema storage AFF A70 o AFF A90, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Controlla se la versione di ONTAP supporta NetApp Volume Encryption (NVE). Prima di spegnere il controller, controlla se il key manager è attivo.
