...
summary: 'Per garantire la sicurezza dei dati sul sistema storage AFF A70 e AFF A90, è necessario verificare il supporto e lo stato della chiave di crittografia. Verifica se la versione di ONTAP supporta la crittografia dei volumi di NetApp (NVE) e prima di arrestare il controller verifica se il gestore delle chiavi è attivo.' 
---
= Verificare il supporto e lo stato della chiave di crittografia - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema storage AFF A70 e AFF A90, è necessario verificare il supporto e lo stato della chiave di crittografia. Verifica se la versione di ONTAP supporta la crittografia dei volumi di NetApp (NVE) e prima di arrestare il controller verifica se il gestore delle chiavi è attivo.
