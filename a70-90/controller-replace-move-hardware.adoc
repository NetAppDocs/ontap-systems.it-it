...
summary: 'Sostituire il controller nel sistema AFF A70 o AFF A90 quando è necessario un aggiornamento o un guasto hardware. Questo processo prevede la rimozione del controller danneggiato, lo spostamento dei componenti nel controller sostitutivo, l"installazione del controller sostitutivo e il riavvio.' 
---
= Sostituire il modulo centralina - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema AFF A70 o AFF A90 quando è necessario un aggiornamento o un guasto hardware. Questo processo prevede la rimozione del controller danneggiato, lo spostamento dei componenti nel controller sostitutivo, l'installazione del controller sostitutivo e il riavvio.
