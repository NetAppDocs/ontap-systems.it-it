...
---
= Sostituisci il controller nel tuo sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Rimuovi il modulo controller dallo chassis prima di sostituirlo o un componente interno.
...
Dopo aver sostituito il controller AFF A70 o AFF A90 danneggiato, è necessariolink:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"] .
