...
---
= Specifiche principali per un sistema AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta le specifiche selezionate per il sistema storage AFF A90 in una configurazione a coppia HA singola. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema storage.
