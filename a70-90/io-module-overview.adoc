...
+
Puoi sostituire a caldo determinati moduli I/O con moduli I/O equivalenti per ripristinare il sistema storage al suo stato operativo ottimale. Puoi sostituire a caldo il modulo senza eseguire un takeover manuale.
