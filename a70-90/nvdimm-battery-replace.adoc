...
summary: Per sostituire la batteria NV, rimuovere il modulo controller, rimuovere la batteria, sostituire la batteria e reinstallare il modulo controller. 
---
...
| image:../media/legend_icon_01.png["Numero di didascalia 1"]  a| 
