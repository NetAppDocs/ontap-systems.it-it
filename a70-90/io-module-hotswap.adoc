...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFF A70 o AFF A90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Sostituisci a caldo un modulo I/O nel tuo sistema AFF A70 o AFF A90 senza spegnerlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFF A70 o AFF A90 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
...
== Fase 1: Conferma che il sistema storage soddisfa i requisiti della procedura
