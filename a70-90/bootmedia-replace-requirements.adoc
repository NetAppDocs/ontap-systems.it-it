...
---
= Verifica i requisiti per il ripristino manuale del supporto di avvio nel tuo sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Se il tuo sistema esegue ONTAP 9.17.1 o versioni successive, usa il link:bootmedia-replace-workflow-bmr.html["procedura di ripristino automatico dell'avvio"].
