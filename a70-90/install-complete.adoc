...
summary: Dopo aver acceso il sistema di storage AFF A70 o AFF A90, sei pronto per rilevare una rete di cluster e configurare un cluster ONTAP. 
---
= Configurazione e setup completi del sistema storage - AFF A70 e AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver acceso il sistema di storage AFF A70 o AFF A90, sei pronto per rilevare una rete di cluster e configurare un cluster ONTAP.
