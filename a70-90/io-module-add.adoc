...
---
= Modulo i/o aggiuntivo - AFF A70, AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se il sistema di storage è dotato di alimentatori CC, scollegare il blocco cavi di alimentazione dall'alimentatore.
