...
. Dal nodo integro, ripristinare il giveback automatico se è stato disattivato utilizzando il `storage failover modify -node local -auto-giveback true` comando.
