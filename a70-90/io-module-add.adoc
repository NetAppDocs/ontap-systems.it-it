...
[role="lead"]
È possibile aggiungere un modulo i/o al sistema di archiviazione AFF A70 e AFF A90 quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati.
