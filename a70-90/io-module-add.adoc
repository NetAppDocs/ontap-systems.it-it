...
summary: È possibile aggiungere un modulo i/o al sistema di archiviazione AFF A70 e AFF A90 quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati. 
---
= Aggiungi un modulo I/O a un sistema AFF A70 o AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungere un modulo i/o al sistema AFF A70 o AFF A90 per migliorare la connettività di rete e ampliare la capacità del sistema di gestire il traffico dati.

È possibile aggiungere un modulo i/o al sistema quando sono disponibili slot vuoti o quando tutti gli slot sono completamente popolati.
...
Arrestare o rilevare il modulo controller danneggiato utilizzando una delle seguenti opzioni.
