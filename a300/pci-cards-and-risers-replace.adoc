...
summary: Per sostituire una scheda PCIe, è necessario eseguire una sequenza specifica di attività. 
---
= Sostituisci una scheda PCIe nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe nel tuo sistema AFF A300 scollegando i cavi, rimuovendo la scheda, installando quella di ricambio e ricollegando i cavi.
