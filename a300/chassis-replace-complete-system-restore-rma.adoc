...
---
= Completa la sostituzione dello chassis del tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis per il tuo sistema AFF A300 verificando lo stato HA dello chassis, ripristinando gli aggregati se necessario e restituendo il componente guasto a NetApp.
...
.. Passare a. <<Fase 3: Restituire la parte guasta a NetApp>>.
