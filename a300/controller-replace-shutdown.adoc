...
---
= Spegni il controller danneggiato in un sistema AFF A300 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni il controller guasto nel tuo sistema AFF A300 prima della sostituzione, utilizzando la procedura appropriata per la tua configurazione.
