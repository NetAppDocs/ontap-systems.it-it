...
---
= Sostituisci a caldo una ventola nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un modulo ventola nel tuo sistema AFF A300 senza interrompere il servizio, per mantenere un flusso d'aria e un raffreddamento del sistema adeguati.
