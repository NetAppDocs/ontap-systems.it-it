...
summary: 'Una volta verificate le variabili di ambiente, è necessario completare i passaggi specifici per i sistemi in cui è abilitato Onboard Key Manager \(OKM\), NetApp Storage Encryption \(NSE\) o NetApp Volume Encryption \(NVE\). Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Ripristinare la crittografia - AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
