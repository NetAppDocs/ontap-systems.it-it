...
summary: Ripristina la crittografia sul supporto di avvio sostitutivo. Completa i passaggi specifici per i sistemi che hanno Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption abilitati. Il sistema AFF A300 supporta solo procedure manuali di ripristino del supporto di avvio. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristinare la crittografia sul supporto di avvio sostitutivo. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
