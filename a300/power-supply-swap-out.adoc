...
---
= Sostituisci a caldo un alimentatore in un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire a caldo un alimentatore nel tuo sistema AFF A300, spegni, scollega e rimuovi l'unità guasta, quindi installa e ricollega quella di ricambio.
