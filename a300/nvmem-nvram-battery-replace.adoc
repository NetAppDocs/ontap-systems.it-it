...
---
= Sostituisci la batteria NVMEM nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema AFF A300 rimuovendo il modulo controller, aprendolo, sostituendo la batteria e reinstallando il modulo controller.
