...
summary: È possibile arrestare o riprendere il controllo del controller danneggiato utilizzando procedure diverse, a seconda della configurazione hardware del sistema di archiviazione. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. 
---
= Arresta il controller danneggiato nel tuo sistema AFF A300 durante il processo di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arrestare o riprendere il controllo del controller danneggiato utilizzando la procedura appropriata per la propria configurazione. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
