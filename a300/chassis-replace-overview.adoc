...
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire lo chassis nel tuo sistema AFF A300, verifica i requisiti per una sostituzione riuscita. La procedura prevede lo spostamento di tutti gli alimentatori, le ventole e i moduli controller dallo chassis guasto allo chassis di ricambio ed è di tipo disruptive.
