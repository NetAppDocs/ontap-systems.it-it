...
summary: 'La procedura per avviare il controller danneggiato dall"immagine di ripristino varia a seconda che il sistema si trovi in ​​una configurazione MetroCluster a due nodi. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio.' 
---
= Avvia l'immagine di ripristino sul tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La procedura per avviare il controller danneggiato dall'immagine di ripristino varia a seconda che il sistema si trovi in ​​una configurazione MetroCluster a due controller. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
