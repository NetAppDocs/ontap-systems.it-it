...
---
= Spegni i controller AFF A300 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Opzione 1: Spegnere il controller
...
== Opzione 2: I controller sono in una configurazione MetroCluster a due nodi
