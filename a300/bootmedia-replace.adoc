...
summary: È necessario individuare il supporto di avvio nel controller e seguire le istruzioni per sostituirlo. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire il supporto di avvio, è necessario rimuovere il modulo controller danneggiato, installare il supporto di avvio sostitutivo e trasferire l'immagine di avvio su un'unità flash USB. Il sistema AFF A300 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato.
