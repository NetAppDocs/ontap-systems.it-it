...
summary: 'Dopo aver completato la sostituzione del supporto di avvio in una configurazione MetroCluster a due nodi, eseguire l"operazione di switchback MetroCluster per riportare la configurazione al suo stato operativo normale. Il sistema AFF A300 supporta solo procedure manuali di ripristino del supporto di avvio.' 
---
= Commuta gli aggregati in una configurazione MetroCluster a due nodi per il tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
