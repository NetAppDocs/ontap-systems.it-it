...
---
= Sostituisci lo chassis nel tuo sistema AFF A300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis nel tuo sistema AFF A300 spostando gli alimentatori, le ventole e i moduli controller dallo chassis guasto a quello di ricambio.
