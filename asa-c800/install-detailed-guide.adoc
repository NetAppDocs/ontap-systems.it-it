...
summary: 'Segui istruzioni dettagliate, passo dopo passo, per prepararti all"installazione, installare l"hardware, cablare il sistema e completare la configurazione iniziale di un sistema ASA C800.' 
---
= Installa e configura un sistema ASA C800 usando istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui istruzioni dettagliate, passo dopo passo, per prepararti all'installazione, installare l'hardware, cablare il sistema e completare la configurazione iniziale di un sistema ASA C800.
