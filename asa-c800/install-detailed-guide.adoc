...
+
image::../media/drw_asac800_weight_caution.png[drw asac800 peso attenzione]

. Collegare i dispositivi di gestione dei cavi (come illustrato).
+
image::../media/drw_asac800_install_cable_mgmt.png[gestione cavi di installazione drw asac800]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
Collegare le porte di gestione agli switch della rete di gestione    image:../media/drw_asac800_mgmt_cabling.png["Immagine che mostra la posizione delle porte di gestione sul retro del sistema"]
...
1
 a| 
Collegare le porte da 2a a 2d agli switch host FC.image:../media/drw_asac800_fc_host_cabling.png[""]
...
1
 a| 
Collegare le porte da e4a a e4d agli switch di rete host da 10 GbE.image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Collegare il controller del cavo A allo shelf:    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Collegare il controller del cavo B allo shelf:    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
Collegare il controller dei cavi A agli shelf:    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
Collegare il controller dei cavi B agli shelf:    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[connettore console drw asac800]

.. Collegare il laptop o la console allo switch sulla subnet di gestione.
+
image::../media/drw_client_mgmt_subnet_asac800.png[subnet di gestione client drw asac800]
