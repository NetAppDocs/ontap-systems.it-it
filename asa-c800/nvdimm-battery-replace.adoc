...
---
= Sostituisci la batteria NVDIMM in un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVDIMM nel tuo sistema ASA C800 quando la batteria inizia a scaricarsi o si guasta, poiché è responsabile della conservazione dei dati di sistema critici durante le interruzioni di corrente. La procedura di sostituzione prevede lo spegnimento del controller danneggiato, la rimozione del modulo controller, la sostituzione della batteria NVDIMM, la reinstallazione del modulo controller e la restituzione del componente guasto a NetApp.
