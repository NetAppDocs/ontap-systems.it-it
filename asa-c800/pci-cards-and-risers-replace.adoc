...
---
= Sostituisci o aggiungi una scheda PCIe in un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe nel tuo sistema ASA C800 quando si guasta, oppure aggiungi o aggiorna una scheda per supportare prestazioni superiori o funzionalità aggiuntive. La procedura di sostituzione prevede lo spegnimento del controller, la sostituzione della scheda PCIe guasta, il riavvio del controller e la restituzione del componente guasto a NetApp.
