...
summary: 'Per iniziare, sostituire il controller nel sistema di archiviazione ASA C800: spegnere il controller danneggiato, rimuoverlo e sostituirlo, riconfigurare le impostazioni di sistema e verificarne il funzionamento.' 
---
= Flusso di lavoro per la sostituzione del controller - ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema di archiviazione ASA C800 spegnendo il controller danneggiato, rimuovendo e sostituendo il controller, ripristinando la configurazione del sistema e restituendo il controllo delle risorse di archiviazione al controller sostitutivo.
