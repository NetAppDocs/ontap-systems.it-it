...
summary: 'Sostituisci un"unità nel tuo sistema ASA C800 quando la piattaforma registra un messaggio di avviso nella console di sistema che indica che un"unità si è guastata. Inoltre, sia il LED di errore sul pannello di visualizzazione dell"operatore sia il LED di errore sull"unità guasta sono accesi.' 
---
= Sostituisci un'unità nel tuo sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità nel tuo sistema ASA C800 quando un'unità si guasta o richiede un aggiornamento. Il processo di sostituzione prevede l'identificazione dell'unità difettosa, la sua rimozione sicura e l'installazione di una nuova unità per garantire l'accesso continuo ai dati e le prestazioni del sistema.
