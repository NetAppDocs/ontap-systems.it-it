...
summary: Per ripristinare il sistema ASA C800 alla piena operatività, ripristina la configurazione di NetApp Storage Encryption se necessario, installa le licenze per il nuovo controller e restituisci la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
