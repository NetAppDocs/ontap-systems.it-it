...
---
= Restituisci il controller in un sistema ASA C800 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituire il controllo delle risorse di archiviazione al controller sostitutivo in modo che il sistema ASA C800 possa riprendere il normale funzionamento.  La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema: nessuna crittografia o crittografia Onboard Key Manager (OKM).
