...
summary: Prima di sostituire il telaio del sistema ASA C800, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita. Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del telaio sostitutivo corretto e degli strumenti necessari. 
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema ASA C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il telaio del sistema ASA C800, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita. Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre delle credenziali di amministratore locale per ONTAP, del telaio sostitutivo corretto e degli strumenti necessari.
