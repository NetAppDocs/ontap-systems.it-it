...
I sistemi AFF serie A e AFF serie C sono compatibili con le seguenti versioni di ONTAP.
...
I sistemi ASA R2 sono compatibili con le seguenti versioni di ONTAP.
...
I sistemi ASA sono compatibili con le seguenti versioni di ONTAP.
...
I sistemi FAS sono compatibili con le seguenti versioni di ONTAP.
