...
summary: Verificare che le interfacce logiche stiano inviando report alla loro porta home, eseguire un controllo dello stato del cluster e quindi restituire la parte guasta a NetApp per completare il passaggio finale della procedura di sostituzione del controller AFX 2K. 
---
= Completa la sostituzione del controller per il tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che le interfacce logiche (LIF) stiano riportando alla loro porta home, esegui un controllo dello stato del cluster e poi restituisci la parte guasta a NetApp per completare il passaggio finale della procedura di sostituzione del controller AFX 2K.
