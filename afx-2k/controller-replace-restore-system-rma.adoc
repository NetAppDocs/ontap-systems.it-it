...
summary: Verifica che le interfacce logiche stiano riportando alla loro porta home, esegui un controllo dello stato del cluster e poi restituisci la parte guasta a NetApp per completare il passaggio finale della procedura di sostituzione del controller afx 2k. 
---
= Sostituzione completa del controller - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
