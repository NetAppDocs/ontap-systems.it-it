...
summary: 'Riavvia il controller, verifica l"integrità del sistema e restituisci il componente guasto a NetApp per completare l"ultimo passaggio della procedura di sostituzione dello chassis AFX 2K.' 
---
= Completa la sostituzione dello chassis del tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Riavvia il controller, verifica l'integrità del sistema e restituisci il componente guasto a NetApp per completare l'ultimo passaggio della procedura di sostituzione dello chassis AFX 2K.
