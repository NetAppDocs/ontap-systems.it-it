...
summary: 'Sostituisci la batteria dell"orologio in tempo reale nel tuo sistema storage afx 2k per garantire che i servizi e le applicazioni che si basano su una sincronizzazione oraria precisa rimangano operativi.' 
---
= Sostituisci la batteria del real-time clock - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
