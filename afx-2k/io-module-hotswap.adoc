...
summary: Puoi effettuare lo swap a caldo di un modulo I/O Ethernet nel tuo sistema storage afx 2k se un modulo si guasta e il tuo sistema storage soddisfa tutti i requisiti di versione di ONTAP. 
---
= Hot swap di un modulo I/O - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
