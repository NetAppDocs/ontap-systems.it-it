...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFX 2K se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Sostituisci a caldo un modulo I/O nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage AFX 2K se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP.
...
NOTE: L'illustrazione seguente mostra la rimozione di un modulo I/O verticale. Di solito, rimuovi solo un modulo I/O.
