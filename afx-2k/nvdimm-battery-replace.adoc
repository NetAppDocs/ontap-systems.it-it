...
Questa procedura si applica alla sostituzione di una batteria NV guasta per il modulo NVRAM negli slot 4 e 5 del controller AFX 2K. Per informazioni su come sostituire la batteria NV per il modulo NVRAM12-EX negli slot 6 e 7 del controller AFX 2K, consulta link:nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["Sostituisci la batteria NV per la NVRAM12-EX"].
