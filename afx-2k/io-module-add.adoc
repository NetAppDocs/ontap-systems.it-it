...
summary: Aggiungi un modulo I/O al tuo sistema storage AFX 2K per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati. 
---
= Aggiungi un modulo I/O a un sistema AFX 2K per migliorare la connettività di rete
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo I/O al tuo sistema storage AFX 2K per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati.

Puoi aggiungere un modulo I/O al tuo sistema storage AFX 2K quando ci sono slot liberi disponibili o quando tutti gli slot sono completamente occupati.
...
.Prima di iniziare
* Controlla il https://hwu.netapp.com["NetApp Hardware Universe"^] per assicurarti che il nuovo modulo I/O sia compatibile con il tuo sistema storage e la versione di ONTAP.
