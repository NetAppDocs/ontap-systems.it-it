...
summary: Sostituisci un modulo I/O nel tuo sistema storage AFX 2K quando il modulo si guasta o richiede un aggiornamento per supportare prestazioni superiori o funzionalità aggiuntive. La procedura di sostituzione prevede lo spegnimento del controller, la sostituzione del modulo I/O guasto, il riavvio del controller e la restituzione del componente guasto a NetApp. 
---
= Sostituisci un modulo I/O nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo I/O nel tuo sistema storage AFX 2K quando il modulo si guasta. La procedura di sostituzione prevede lo spegnimento del controller, la sostituzione del modulo I/O guasto, il riavvio del controller e la restituzione del componente guasto a NetApp.
...
NOTE: L'illustrazione seguente mostra la rimozione di un modulo I/O verticale. Di solito, rimuovi un solo modulo I/O.
