...
summary: 'Sostituisci l"alimentatore CA nel tuo sistema storage AFX 2K quando si guasta o presenta un malfunzionamento, garantendo che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"alimentatore da sostituire, scollegare il cavo di alimentazione, rimuovere l"alimentatore difettoso e installare quello nuovo, quindi ricollegarlo alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci l'alimentatore CA (PSU) nel tuo sistema storage AFX 2K quando si guasta o presenta un malfunzionamento, così il sistema continuerà a ricevere l'alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l'alimentatore da sostituire, scollegare il cavo di alimentazione, rimuovere l'alimentatore difettoso e installare quello nuovo, quindi ricollegarlo alla fonte di alimentazione.
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[Sostituire la scheda PSU]
