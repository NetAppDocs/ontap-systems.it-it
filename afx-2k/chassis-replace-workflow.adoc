...
summary: Inizia a sostituire lo chassis del tuo sistema storage afx 2k esaminando i requisiti di sostituzione, spegnendo il controller, sostituendo lo chassis e verificando il funzionamento del sistema. 
---
= Flusso di lavoro per la sostituzione dello chassis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Inizia a sostituire lo chassis del tuo sistema storage AFX 2K esaminando i requisiti di sostituzione, spegnendo il controller, sostituendo lo chassis e verificando il funzionamento del sistema.
