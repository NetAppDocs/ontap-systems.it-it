...
summary: Arresta il controller danneggiato nel tuo sistema storage AFX 2K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il supporto di avvio. 
---
= Arresta il controller nel tuo sistema storage AFX 2K durante il processo di ripristino automatico all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema storage AFX 2K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci il supporto di avvio.
