...
summary: 'Il supporto di avvio nel tuo sistema storage AFX 2K memorizza dati essenziali del firmware e della configurazione. La procedura di sostituzione prevede la rimozione del modulo di gestione del sistema, la rimozione del supporto di avvio danneggiato, l"installazione del nuovo supporto di avvio nel modulo di gestione del sistema e poi la reinstallazione del modulo di gestione del sistema.' 
---
= Sostituisci il supporto di avvio nel tuo sistema storage AFX 2K utilizzando il processo di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
