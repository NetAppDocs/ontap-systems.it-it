...
summary: 'Sostituisci lo chassis del tuo sistema storage AFX 2K quando è necessario a causa di un guasto hardware. La procedura di sostituzione prevede la rimozione del controller dalla parte anteriore dello chassis, la rimozione degli alimentatori, della NVRAM12, dei moduli I/O e degli slot vuoti, e del modulo di gestione del sistema, quindi l"installazione dello chassis di ricambio e la reinstallazione dei componenti dello chassis.' 
---
= Sostituisci lo chassis del tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo sistema storage AFX 2K quando è necessario a causa di un guasto hardware. La procedura di sostituzione prevede la rimozione del controller, delle schede I/O, del modulo NVRAM12, del modulo di gestione del sistema e delle unità di alimentazione (PSU), l'installazione dello chassis di ricambio e la reinstallazione dei componenti dello chassis.
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[Rimuovere o sostituire l'alimentatore]
...
[[step-2-remove-the-io-cards-nvram12-nvram12-ex-and-system-management-module]]
== Passaggio 2: Rimuovi le schede I/O, NVRAM12, NVRAM12-EX e il modulo di gestione del sistema

. Rimuovere il modulo i/o di destinazione dallo chassis:
+
image:../media/drw_afx_2k_io_remove_replace_ieops-2878.svg["Rimuovere il modulo di i/O."]
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[Rimuovi il modulo NVRAM12]
...
. Rimuovi il modulo NVRAM12-EX:
+
.. Afferra la maniglia del modulo e premi il pulsante di bloccaggio a camma.
.. Estrai il modulo NVRAM12-EX dallo chassis sostenendo la parte inferiore del modulo con l'altra mano.
+
...
|===
 ...
 a| 
image:../media/icon_round_1.png["Numero di didascalia 1"]
| Maniglia e pulsante a camme NVRAM12-EX 
|===
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[Rimozione della gestione del sistema]
...
Dopo aver sostituito lo chassis AFX 2K e reinstallato i suoi componenti, completare la link:chassis-replace-complete-system-restore-rma.html["sostituzione del telaio"].
