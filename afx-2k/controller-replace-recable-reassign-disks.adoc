...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il tuo sistema storage AFX 2K possa riprendere il normale funzionamento. 
---
= Restituisci il controller al tuo sistema storage AFX 2K per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il tuo sistema storage AFX 2K possa riprendere il normale funzionamento. La procedura di restituzione varia in base al tipo di crittografia utilizzato dal tuo sistema: nessuna crittografia o crittografia con Onboard Key Manager (OKM).
