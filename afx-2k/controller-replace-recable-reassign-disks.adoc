...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo, così il tuo sistema storage afx 2k può riprendere il normale funzionamento. 
---
= Restituisci il controller - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
