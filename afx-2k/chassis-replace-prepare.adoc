...
summary: Preparati a sostituire lo chassis compromesso nel tuo sistema storage AFX 2K identificando lo chassis compromesso, verificando i componenti di ricambio ed etichettando i cavi e i moduli controller. 
---
= Preparati a sostituire il tuo chassis AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Preparati a sostituire lo chassis compromesso nel tuo sistema storage AFX 2K identificando lo chassis compromesso, verificando i componenti di ricambio ed etichettando i cavi e il modulo controller.
...
Dopo che ti sei preparato a sostituire l'hardware dello chassis AFX 2K, devi link:chassis-replace-shutdown.html["spegnere il controller"].
