...
summary: Preparati a sostituire lo chassis guasto nel tuo sistema storage afx 2k identificando lo chassis guasto, verificando i componenti di ricambio ed etichettando i cavi e i moduli controller. 
---
= Preparati a sostituire lo chassis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
