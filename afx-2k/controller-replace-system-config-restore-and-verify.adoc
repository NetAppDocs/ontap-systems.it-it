...
summary: Verifica che la configurazione HA del controller sia attiva e funzioni correttamente nel tuo sistema storage AFX 2K e conferma che gli adattatori del sistema elenchino tutti i percorsi ai dischi. 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
