...
summary: Sostituisci un modulo DIMM nel tuo sistema storage afx 2k se vengono rilevati errori di memoria correggibili o non correggibili eccessivi. Tali errori possono impedire al sistema storage di avviare ONTAP. La procedura di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del DIMM, la reinstallazione del controller e poi la restituzione del componente guasto a NetApp. 
---
= Sostituisci un modulo DIMM - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo DIMM nel tuo sistema storage AFX 2K se vengono rilevati errori di memoria correggibili o non correggibili in eccesso. Tali errori possono impedire al sistema storage di avviare ONTAP. La procedura di sostituzione prevede lo spegnimento del controller danneggiato, la sua rimozione, la sostituzione del modulo DIMM, la reinstallazione del controller e poi la restituzione del componente guasto a NetApp.
