---
permalink: afx-2k/fan-replace.html 
sidebar: sidebar 
keywords: afx 2k, replace a fan 
summary: Sostituisci un modulo ventola guasto o difettoso nel tuo sistema AFX 2K per mantenere un raffreddamento adeguato e prevenire problemi di prestazioni del sistema. Le ventole sono hot-swappable e possono essere sostituite senza spegnere il sistema. 
---
= Sostituisci a caldo una ventola nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo ventola guasto o difettoso nel tuo sistema AFX 2K per mantenere un raffreddamento adeguato e prevenire problemi di prestazioni del sistema. Le ventole sono hot-swappable e possono essere sostituite senza spegnere il sistema. Questa procedura include l'identificazione della ventola difettosa tramite i messaggi di errore della console e gli indicatori LED, la rimozione della cornice, la sostituzione del modulo ventola e la restituzione del componente guasto a NetApp.
