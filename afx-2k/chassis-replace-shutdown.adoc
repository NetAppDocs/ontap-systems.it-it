...
summary: Spegni il controller nel tuo sistema storage afx 2k per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci lo chassis. 
---
= Spegni il controller per sostituire lo chassis - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
