...
summary: Arresta il controller nel tuo sistema storage AFX 2K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci lo chassis. 
---
= Spegni il controller AFX 2K per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller nel tuo sistema storage AFX 2K per evitare la perdita di dati e garantire la stabilità del sistema quando sostituisci lo chassis.
