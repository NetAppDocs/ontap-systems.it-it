...
summary: Sostituisci la NVRAM nel tuo sistema storage AFX 2K quando la memoria non volatile risulta difettosa o necessita di un aggiornamento. 
---
= Sostituisci la NVRAM nel tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Rimuovere il modulo NVRAM12 e i DIMM]
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Rimuovere il modulo NVRAM 12 e i DIMM]
...
NOTE: L'Override system ID è necessario solo per la sostituzione del modulo NVRAM e non per la sostituzione del DIMM NVRAM.
