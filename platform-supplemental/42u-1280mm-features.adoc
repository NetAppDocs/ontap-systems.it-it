...
---
= Caratteristiche del cabinet del sistema hardware ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
L'armadio del sistema hardware ONTAP è composto da pannelli laterali, porte anteriori e posteriori, un kit di fissaggio a bulloni opzionale, un kit di interconnessione opzionale, PDU per le tue apparecchiature e un sistema integrato di gestione dei cavi.
