...
summary: 'L"armadio di sistema supporta diversi tipi di Power Distribution Unit (PDU). Le PDU sono conformi a NEMA o IEC.' 
---
= Tipi e specifiche di PDU supportati per un cabinet di sistema hardware ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
