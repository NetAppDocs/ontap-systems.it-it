...
---
= Aggiungi un modulo I/O a un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Prima di iniziare
* Controlla il https://hwu.netapp.com["NetApp Hardware Universe"^] per assicurarti che il nuovo modulo I/O sia compatibile con il tuo sistema e con la versione di ONTAP che stai utilizzando.
