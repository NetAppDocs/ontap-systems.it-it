...
X66240A-5 (112-00600), 5 m.
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[GbE rame SFP]
 a| 
Cavo di rete
...
X66100-5 (112-00544), 5 m.
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE rame SFP]
 a| 
...
X66033A (112-00438), 3 m.
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[Connettore in fibra LC]
 a| 
Rete ottica FC
...
X6562-R6 (112-00196), 5 m.
 a| 
image::../media/oie_cable_rj45.svg[Connettore del cavo RJ-45]
 a| 
...
Non applicabile
 a| 
image::../media/oie_cable_micro_usb.svg[Connettore micro USB]
 a| 
...
Non applicabile
 a| 
image::../media/oie_cable_power.svg[Connettore del cavo di alimentazione]
 a| 
...
| Fase | Eseguire su ciascun controller 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[Icona di didascalia uno]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Connettore da 100 GB]



 a| 
image::../media/oie_legend_icon_2_lp.svg[Icona due didascalie]
 a| 
...
image::../media/oie_cable_rj45.svg[Connettore del cavo RJ-45]
 ...
 a| 
image::../media/oie_legend_icon_3_o.svg[Icona della didascalia tre]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 connettore di cavo GbE]



 a| 
image:../media/oie_legend_icon_4_dr.svg["Icona quattro didascalie"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.svg["GbE rame SFP"]
 ...
 a| 
image::../media/oie_legend_icon_5_lp.png[Icona cinque didascalie]
 a| 
...
image:../media/oie_cable_power.svg["Cavo di alimentazione"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["Cavo 100 GbE"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["Icona due didascalie"]
 a| 
Porte per la gestione del controller dei cavi (chiave).
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[Drw a900fas9500 icona di alimentazione IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[direzione della linguetta di estrazione del cavo]
...
| Fase | Eseguire su ciascun controller 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Didascalia numero uno]
 a| 
...
image::../media/oie_cable100_gbe_qsfp28.svg[Connettore QSFP 100 GbE]
...
Cavo da 100 GbE
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[Didascalia numero due]
 a| 
...
| Fase | Eseguire su ciascun controller 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[Icona di didascalia uno]
 a| 
...
Tappo terminale dello scaffale
 ...
 a| 
image::../media/legend_icon_02.png[Icona due didascalie]
 a| 
Mascherina dello scaffale
 ...
 a| 
image::../media/legend_icon_03.png[Icona della didascalia tre]
 a| 
LED ID shelf
 ...
 a| 
image::../media/legend_icon_04.png[Icona quattro didascalie]
 a| 
