...
---
= Spegni il controller guasto nel tuo sistema AFF A900 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni il controller guasto nel tuo sistema storage AFF A900 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del controller.
