...
summary: Inizia a sostituire lo chassis del tuo sistema AFF A900. La procedura richiede la rimozione e la reinstallazione degli alimentatori, delle ventole, dei moduli controller, dei moduli I/O, dei moduli DCPM e del modulo LED USB. Tutti gli altri componenti del sistema devono funzionare correttamente. 
---
= Sostituisci lo chassis nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo sistema AFF A900 quando è necessario a causa di un guasto hardware. Il processo di sostituzione prevede la rimozione degli alimentatori, delle ventole, dei moduli controller e dei moduli I/O dallo chassis danneggiato e la loro installazione nello chassis di ricambio.
...
+
image::../media/drw_a900_remove_install_PSU_module.svg[Rimuovere o installare un modulo PSU]
...
+
image::../media/drw_a900_remove_install_fan.svg[Rimuovere o installare la ventola]
...
+
image::../media/drw_a900_remove_PCM.svg[Rimuovere il controller]
...
+
image:../media/drw_a900_remove_PCIe_module.svg["Rimuovere un modulo PCIe"]
...
+
image::../media/drw_a900_remove_NV_battery.svg[Rimuovere una batteria NV]
...
image::../media/drw_a900_remove_replace_LED_mod.svg[Rimuovere o sostituire un modulo LED USB]
