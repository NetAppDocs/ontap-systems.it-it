...
sidebar: sidebar 
keywords: AFF A900 
summary: Per sostituire a caldo un modulo di alimentazione del controller di destaging, che contiene la batteria NVRAM11, individuare il modulo DCPM guasto, rimuoverlo dallo chassis e installare il modulo DCPM sostitutivo. 
---
= Sostituisci il modulo DCPM contenente la batteria NVRAM11 nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo il modulo di alimentazione del controller di destage (DCPM) nel tuo sistema AFF A900 quando si guasta. Il DCPM contiene la batteria NVRAM11 e deve essere sostituito entro cinque minuti dalla rimozione per evitare la perdita della protezione dei dati.
...
+
image::../media/drw_a900_remove_NV_battery.svg[Rimuovere la batteria NV]
