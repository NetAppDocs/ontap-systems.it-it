...
summary: Il modulo NVRAM è composto da NVRAM11 e DIMM e da un massimo di due moduli NVMe SSD Flash Cache per ciascun modulo NVRAM. 
---
= Sostituisci il modulo NVRAM o i DIMM NVRAM nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo NVRAM o i DIMM NVRAM nel tuo sistema AFF A900 quando il modulo si guasta o un DIMM risulta difettoso. La procedura di sostituzione prevede la rimozione del modulo NVRAM dallo chassis, la sostituzione del componente guasto e la reinstallazione del modulo.
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[Rimuovere il modulo NVRAM]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Rimuovere il contenuto del modulo NVRAM]
