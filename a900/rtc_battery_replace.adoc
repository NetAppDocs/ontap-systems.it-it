...
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema AFF A900 per garantire che i servizi e le applicazioni che si basano su una sincronizzazione oraria precisa continuino a funzionare.
...
+
image::../media/drw_a900_remove_RTC_battery.svg[Rimuovere e installare la batteria RTC]
