...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema AFF A900 in modo che i servizi e le applicazioni che si basano su una sincronizzazione oraria precisa continuino a funzionare.
