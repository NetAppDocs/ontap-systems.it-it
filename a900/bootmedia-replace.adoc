...
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A900 utilizzando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il boot media nel tuo sistema AFF A900 memorizza i dati essenziali del firmware e della configurazione. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del boot media danneggiato, l'installazione del boot media sostitutivo e quindi il trasferimento dell'immagine ONTAP sul boot media sostitutivo utilizzando una chiavetta USB.
