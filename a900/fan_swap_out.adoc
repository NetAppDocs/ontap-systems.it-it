...
---
= Sostituisci a caldo un modulo ventola nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un modulo ventola nel tuo sistema AFF A900 per mantenere un raffreddamento adeguato. I moduli ventola devono essere sostituiti senza interrompere il servizio, eseguendo una sequenza specifica di operazioni.
...
+
image::../media/drw_a900_remove_install_fan.svg[Rimozione o installazione della ventola]
