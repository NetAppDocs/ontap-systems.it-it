...
summary: Ripristina la crittografia sul supporto di avvio sostitutivo. Completa i passaggi specifici per i sistemi che hanno Onboard Key Manager, NetApp Storage Encryption o NetApp Volume Encryption abilitati. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A900 utilizzando la procedura di ripristino manuale dal menu di boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
