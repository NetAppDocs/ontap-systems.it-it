...
summary: 'Inizia a sostituire il boot media nel tuo sistema storage AFF A900. Il flusso di lavoro include la revisione dei requisiti di sostituzione, il controllo dello stato della crittografia, lo spegnimento del controller, la sostituzione del boot media, l"avvio dell"immagine di ripristino, il ripristino della crittografia e la verifica della funzionalità del sistema.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema AFF A900 usando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
