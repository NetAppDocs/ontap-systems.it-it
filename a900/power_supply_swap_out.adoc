...
---
= Sostituisci a caldo un alimentatore in un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un alimentatore nel tuo sistema AFF A900 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per effettuare questa sostituzione.
