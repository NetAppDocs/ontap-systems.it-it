...
---
= Sostituisci il controller nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo sistema AFF A900 quando un guasto hardware lo richiede. La procedura di sostituzione prevede la rimozione del modulo controller danneggiato, lo spostamento dei componenti FRU sul controller di ricambio, l'installazione del modulo controller di ricambio nello chassis e l'avvio del sistema in modalità Maintenance.
