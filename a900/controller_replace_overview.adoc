...
---
= Flusso di lavoro per la sostituzione del controller AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Inizia a sostituire il controller nel tuo sistema AFF A900 verificando i prerequisiti, spegnendo il controller guasto, spostando l'hardware sul controller sostitutivo e ripristinando la configurazione del sistema.
