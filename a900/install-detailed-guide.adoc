...
---
= Installa il tuo sistema AFF A900 usando istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A900 seguendo queste istruzioni dettagliate passo passo, dalla preparazione del sito all'avvio del cluster ONTAP.
...
+
I ripiani NS224 sono preimpostati con ID ripiano 00 e 01. Se vuoi cambiare gli ID dei ripiani, devi creare uno strumento da inserire nel foro in cui si trova il pulsante. Vedi link:../ns224/change-shelf-id.html["Modifica dell'ID di uno shelf - shelf NS224"] per istruzioni dettagliate.
...
.. Seleziona *Network* nel riquadro a sinistra e fai clic con il pulsante destro del mouse, poi seleziona *refresh*.
