...
---
= Sostituisci un modulo I/O nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un modulo I/O nel tuo AFF A900 quando si guasta o necessita di un aggiornamento. La procedura di sostituzione richiede una sequenza specifica di operazioni per evitare interruzioni del servizio.
