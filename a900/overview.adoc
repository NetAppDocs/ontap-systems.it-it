...
---
= Specifiche principali per un sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
I sistemi storage AFF A900 in una singola coppia HA offrono queste specifiche principali. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] per le specifiche complete di questo sistema storage.
...
* Versione minima ONTAP : ONTAP 9.10.1RC2
