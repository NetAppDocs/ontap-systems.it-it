...
---
= Completa la sostituzione dello chassis del tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica lo stato HA dello chassis e restituisci il componente guasto a NetApp per completare la sostituzione dello chassis del tuo sistema AFF A900.
