...
summary: Proseguire la procedura di sostituzione ricablando le configurazioni di storage e di rete. 
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ricollega le configurazioni di storage e di rete e ripristina NetApp Storage Encryption per riportare il tuo sistema AFF A900 alla piena operatività.
