...
[role="lead"]
Prima di sostituire il boot media nel tuo sistema AFF A900, assicurati di soddisfare i requisiti necessari per una sostituzione corretta. Questo include avere una chiavetta USB formattata in FAT32 con spazio sufficiente per l'immagine di ripristino ONTAP e capire se stai eseguendo una sostituzione non disruptiva o disruptiva.
