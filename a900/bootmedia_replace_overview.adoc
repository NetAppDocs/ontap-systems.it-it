...
sidebar: sidebar 
keywords: AFF A900 
summary: 'Il supporto di avvio memorizza un set primario e uno secondario di file di sistema che il sistema utilizza durante l"avvio. A seconda della configurazione di rete, è possibile eseguire una sostituzione non disruptiva o disruptiva.' 
---
= Consulta i requisiti per la sostituzione del supporto di avvio nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
