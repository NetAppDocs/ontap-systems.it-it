...
---
= Sostituisci il modulo LED USB nel tuo sistema AFF A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo LED USB nel tuo AFF A900 per ripristinare la connettività alle porte console e lo stato del sistema. La sostituzione non richiede attrezzi e non interrompe il servizio.
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[Rimuovere un modulo USB LED]
