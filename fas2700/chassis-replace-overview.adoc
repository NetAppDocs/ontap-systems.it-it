...
summary: 'Prima di sostituire lo chassis del tuo sistema FAS2700, controlla i requisiti per una sostituzione riuscita. La procedura di sostituzione dello chassis prevede lo spostamento di tutti gli alimentatori, le unità e i moduli controller dallo chassis guasto allo chassis di ricambio ed è un"operazione che comporta interruzioni.' 
---
= Controlla i requisiti per la sostituzione di uno chassis in un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
