...
summary: Sostituisci il controller nel tuo sistema FAS2700 rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller di ricambio, installandolo nello chassis e avviando in modalità manutenzione. 
---
= Sostituisci il controller nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo sistema FAS2700 rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller di ricambio, installandolo nello chassis e avviando in modalità manutenzione.
