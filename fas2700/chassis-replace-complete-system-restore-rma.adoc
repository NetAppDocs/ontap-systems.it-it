...
summary: Completa la sostituzione dello chassis per il tuo sistema FAS2700 verificando lo stato HA dello chassis e restituendo il componente guasto a NetApp. 
---
= Completa la sostituzione dello chassis del tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione dello chassis per il tuo sistema FAS2700 verificando lo stato HA dello chassis e restituendo il componente guasto a NetApp.
