...
summary: Sostituisci la batteria NVMEM nel tuo sistema FAS2700 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller. 
---
= Sostituisci la batteria NVMEM nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema FAS2700 rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller.
