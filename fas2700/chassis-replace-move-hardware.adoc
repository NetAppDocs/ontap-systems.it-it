...
summary: 'Sposta gli alimentatori, le unità e i moduli controller dallo chassis guasto al nuovo chassis, e sostituisci il vecchio chassis nel rack delle apparecchiature o nell"armadio di sistema con quello nuovo dello stesso modello.' 
---
= Sostituisci lo chassis nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Trasferisci gli alimentatori, le unità e i moduli controller dallo chassis guasto allo chassis di ricambio nel tuo sistema FAS2700, quindi sostituisci il vecchio chassis nel rack delle apparecchiature o nell'armadio di sistema con quello nuovo dello stesso modello.
...
Dopo aver installato il modulo controller e qualsiasi altro componente nel nuovo chassis, avviare il sistema.
