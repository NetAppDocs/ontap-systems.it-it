...
summary: 'La sostituzione di un alimentatore prevede lo spegnimento, la disconnessione e la rimozione del vecchio alimentatore, nonché l"installazione, il collegamento e l"accensione del nuovo alimentatore.' 
---
= Sostituisci a caldo un alimentatore in un sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un alimentatore nel tuo sistema FAS2700 spegnendo, scollegando e rimuovendo l'unità guasta, quindi installando e ricollegando quella di ricambio.
