...
summary: Sostituisci un DIMM nel tuo sistema FAS2700 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, che di solito è causato dal guasto di un singolo DIMM. 
---
= Sostituisci un modulo DIMM nel tuo sistema FAS2700 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema FAS2700 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, che di solito è causato dal guasto di un singolo DIMM.
