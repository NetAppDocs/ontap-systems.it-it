...
summary: Sostituisci il DIMM nel tuo sistema FAS2700 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, in genere causato dal guasto di un singolo DIMM. 
---
= Sostituisci un modulo DIMM in un sistema FAS2700 per risolvere errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il DIMM nel tuo sistema FAS2700 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, in genere causato dal guasto di un singolo DIMM.
