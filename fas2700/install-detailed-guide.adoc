...
sidebar: sidebar 
keywords: fas2700, detailed, guide, prepare, install, hardware, cable, controllers, node, switchless, cluster, network, configuration, system, setup, discovery 
summary: Questa pagina fornisce istruzioni dettagliate passo passo per installare il tuo sistema FAS2700. 
---
= Installa il tuo sistema FAS2700 utilizzando istruzioni dettagliate
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Segui istruzioni dettagliate, passo dopo passo, per installare il tuo sistema FAS2700, dalla preparazione per l'installazione fino alla configurazione iniziale.
