...
summary: Ricollega i cavi dello storage, conferma la riassegnazione dei dischi e completa le attività rimanenti per restituire il controller e ripristinare il pieno funzionamento del tuo sistema FAS2700. 
---
= Restituisci il controller nel tuo sistema FAS2700 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ricollega i cavi dello storage, conferma la riassegnazione dei dischi e completa le attività rimanenti per restituire il controller e ripristinare il pieno funzionamento del tuo sistema FAS2700.
