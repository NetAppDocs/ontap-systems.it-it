...
sidebar: sidebar 
keywords: fas2700, how to restore NetApp Storage Encryption, how to complete the replacement process 
summary: Per ripristinare il funzionamento completo del sistema FAS2700, devi ripristinare la configurazione della NetApp Storage Encryption, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per ripristinare il funzionamento completo del sistema FAS2700, devi ripristinare la configurazione di NetApp Storage Encryption (se necessario), installare le licenze per il nuovo controller e restituire il componente guasto a NetApp, come descritto nelle istruzioni RMA fornite con il kit.
