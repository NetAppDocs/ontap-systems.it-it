...
sidebar: sidebar 
keywords: fas2700, replace, boot, media, controller, module, fru map, manual, manual boot recovery 
summary: Sostituire il supporto di avvio non riuscito su un modulo controller FAS2700. Il sistema FAS2700 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Sostituisci il supporto di avvio nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
