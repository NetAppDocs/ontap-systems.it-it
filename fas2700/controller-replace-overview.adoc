...
summary: Prima di sostituire il controller nel sistema FAS2700, controlla i prerequisiti per la procedura di sostituzione e scegli quella corretta per la tua versione di ONTAP. 
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel sistema FAS2700, controlla i prerequisiti per la procedura di sostituzione e scegli quella corretta per la tua versione di ONTAP.
