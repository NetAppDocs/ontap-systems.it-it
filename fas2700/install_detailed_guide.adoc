...
---
= Guida dettagliata - AFF A220 e FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per installare il sistema FAS2700 o AFF A220, è necessario creare un account sul sito di supporto NetApp, registrare il sistema e ottenere le chiavi di licenza. È inoltre necessario inventariare il numero e il tipo di cavi appropriati per il sistema e raccogliere informazioni di rete specifiche.
