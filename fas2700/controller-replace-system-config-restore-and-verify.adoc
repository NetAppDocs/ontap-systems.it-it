...
summary: 'Dopo aver completato la sostituzione dell"hardware e aver avviato il sistema FAS2700 in modalità manutenzione, ripristina e verifica la configurazione del controller.' 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver completato la sostituzione dell'hardware e aver avviato il sistema FAS2700 in modalità manutenzione, ripristina e verifica la configurazione del controller.
