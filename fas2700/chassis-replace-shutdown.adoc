...
summary: Arresta o prendi il controllo del controller compromesso nel tuo sistema FAS2700 utilizzando la procedura appropriata per la tua configurazione prima di sostituire lo chassis. 
---
= Spegni il controller FAS2700 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta o prendi il controllo del controller compromesso nel tuo sistema FAS2700 utilizzando la procedura appropriata per la tua configurazione prima di sostituire lo chassis.
