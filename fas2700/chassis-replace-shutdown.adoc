...
summary: Spegni i controller nel tuo sistema FAS2700 utilizzando la procedura appropriata per la tua configurazione prima di sostituire lo chassis. 
---
= Spegni i controller FAS2700 per sostituire lo chassis
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegni i controller nel tuo sistema FAS2700 utilizzando la procedura appropriata per la tua configurazione prima di sostituire lo chassis.
