...
summary: Sostituisci il modulo di caching nel tuo sistema FAS2700 quando il sistema registra un singolo messaggio ASUP AutoSupport che indica che il modulo è offline. Se non lo fai, si verifica un peggioramento delle performance. 
---
= Sostituisci il modulo di caching nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo di caching nel tuo sistema FAS2700 quando il sistema registra un singolo messaggio AutoSupport (ASUP) che indica che il modulo è offline. Se non lo fai, si verifica un peggioramento delle performance.
