...
summary: 'Sostituisci un"unità nel tuo sistema FAS2700 quando la piattaforma registra un messaggio di avviso nella console di sistema che indica che un"unità si è guastata. Sia il LED di errore sul pannello di visualizzazione dell"operatore sia il LED di errore sull"unità guasta sono accesi.' 
---
= Sostituisci un'unità nel tuo sistema FAS2700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un'unità nel tuo sistema FAS2700 quando la piattaforma registra un messaggio di avviso nella console di sistema che indica che un'unità si è guastata. Sia il LED di errore sul pannello di visualizzazione dell'operatore sia il LED di errore sull'unità guasta sono accesi.
