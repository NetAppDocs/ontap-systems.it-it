...
summary: Per ripristinare il funzionamento completo del sistema AFF A20, AFF A30 o AFF A50, installare le licenze richieste sul nuovo controller, verificare che le interfacce logiche stiano segnalando le proprie porte home ed eseguire un controllo dello stato di salute del cluster. Infine, registrare il numero di serie della nuova centralina e restituire la parte guasta a NetApp. 
---
