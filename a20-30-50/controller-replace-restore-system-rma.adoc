...
summary: Per completare la sostituzione del controller per il tuo sistema storage AFF A20, AFF A30 o AFF A50, ripristina la configurazione di NetApp Storage Encryption e installa le licenze necessarie sul nuovo controller. Conferma che le interfacce logiche stiano riportando alle loro porte home ed esegui un controllo dello stato di salute del cluster. Registra il numero di serie del nuovo controller e restituisci la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
