...
Dopo aver sostituito il controller AFF A20, AFF A30 o AFF A50 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
