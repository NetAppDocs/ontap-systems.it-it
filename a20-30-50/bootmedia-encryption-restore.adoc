...
summary: 'Ripristina la crittografia sul supporto di avvio sostitutivo del tuo sistema di archiviazione AFF A20, AFF A30 o AFF A50 per garantire la protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell"accesso sicuro ai dati.' 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema AFF A20, AFF A30 o AFF A50 utilizzando la procedura di ripristino manuale dal menu di boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina la crittografia sul supporto di avvio sostitutivo del tuo sistema di archiviazione AFF A20, AFF A30 o AFF A50 per garantire la protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell'accesso sicuro ai dati.
