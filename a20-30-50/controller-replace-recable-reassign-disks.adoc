...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema storage AFF A20, AFF A30 o AFF A50 possa riprendere il normale funzionamento. La procedura di restituzione varia a seconda che il sistema non utilizzi alcuna crittografia, utilizzi la crittografia con Onboard Key Manager o la crittografia con External Key Manager. 
---
= Restituisci il controller nel tuo sistema AFF A20, AFF A30 o AFF A50 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
