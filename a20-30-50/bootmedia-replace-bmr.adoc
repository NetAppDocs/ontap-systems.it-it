...
summary: 'Il supporto di avvio del sistema di storage AFF A20, AFF A30 o AFF A50 memorizza firmware e dati di configurazione essenziali. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l"installazione del supporto di avvio sostitutivo e la successiva reinstallazione del modulo controller.' 
---
= Sostituisci il supporto di avvio in un sistema AFF A20, AFF A30 o AFF A50 utilizzando la procedura automatizzata di ripristino dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il supporto di avvio del sistema di storage AFF A20, AFF A30 o AFF A50 memorizza firmware e dati di configurazione essenziali. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l'installazione del supporto di avvio sostitutivo e la successiva reinstallazione del modulo controller.
