...
summary: 'Sostituire un"unità di alimentazione CA o CC nel sistema storage AFF A20, AFF A30 o AFF A50 quando si guasta o presenta malfunzionamenti, garantendo che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"alimentatore difettoso dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"alimentatore difettoso e quindi ricollegarlo alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore nel tuo sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
