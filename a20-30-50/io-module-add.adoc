...
---
= Aggiungi un modulo I/O a un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungi un modulo I/O al tuo sistema di archiviazione AFF A20, AFF A30 o AFF A50 per migliorare la connettività di rete ed espandere la capacità del tuo sistema di gestire il traffico dati.

L'aggiunta del modulo I/O prevede lo spegnimento di un controller, l'aggiunta del modulo, il riavvio e poi la ripetizione di questi passaggi per l'altro controller.

.A proposito di questa attività
* È possibile aggiungere un modulo I/O ai sistemi storage quando ci sono slot disponibili o quando tutti gli slot sono completamente occupati.
...
+
Puoi spegnerli inserendo il comando  `system location-led _off_`. Se non sei sicuro che i LED siano accesi o spenti, puoi verificarne lo stato inserendo il comando  `system location-led show`.
