...
---
= Aggiungi un modulo I/O al tuo sistema AFF A20, AFF A30 o AFF A50 per migliorare la connettività di rete
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Il processo di aggiunta prevede lo spegnimento di un controller, l'aggiunta del nuovo modulo I/O, il riavvio del controller, lo spegnimento dell'altro controller, l'aggiunta del nuovo modulo I/O e il riavvio del controller.
