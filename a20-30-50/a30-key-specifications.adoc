...
summary: Specifiche chiave per AFF A30 
---
...
[role="lead"]
Di seguito sono riportate alcune specifiche per il sistema di archiviazione AFF A30 in una singola coppia ad alta disponibilità.  Per le specifiche complete di questo sistema di storage, visitare NetApp Hardware Universe (HWU).



== Specifiche AFF A30 in sintesi
...
* Tipo: NAS; Coppie HA: 4; Capacità raw: 16,2 PB / 14,3 PiB; Memoria massima: 512 GB
* Tipo: SAN; Coppie HA: 4; Capacità grezza: 16,2 PB / 14,3 PiB; Memoria massima: 512 GB
