...
---
= Specifiche principali per un sistema AFF A30
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste specifiche selezionate descrivono il sistema storage AFF A30 configurato in una singola coppia ad alta disponibilità. Visita NetApp Hardware Universe (HWU) per le specifiche complete di questo sistema.
