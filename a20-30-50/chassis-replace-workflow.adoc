...
summary: Inizia a sostituire lo chassis del sistema storage AFF A20, AFF A30 o AFF A50 rivedendo i requisiti di sostituzione, spegnendo i controller, sostituendo lo chassis e verificando il funzionamento del sistema. 
---
= Procedura di sostituzione dello chassis AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Inizia a sostituire lo chassis del sistema storage AFF A20, AFF A30 o AFF A50 rivedendo i requisiti di sostituzione, spegnendo i controller, sostituendo lo chassis e verificando il funzionamento del sistema.
...
[role="quick-margin-para"]
La sostituzione dello chassis prevede il trasferimento delle unità, dei distanziatori per le unità, dei controller (con i relativi alimentatori) e del pannello frontale dallo chassis guasto al nuovo chassis. Poi scambi lo chassis guasto con un nuovo chassis dello stesso modello.
