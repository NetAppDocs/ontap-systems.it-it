...
summary: 'Dopo aver installato l"hardware del sistema di storage AFF A20, AFF A30 o AFF A50, collegare i controller alla rete e agli shelf.' 
---
= Collega l'hardware AFF A20, AFF A30 o AFF A50 per la connettività di rete e storage.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["schema di cablaggio del cluster commutato a20 utilizzando un modulo I/O da 25 GbE"]
...
.AFF A20, AFF A30 o AFF A50 con un modulo I/O 10/25 GbE a 4 porte
...
.AFF A20, AFF A30 o AFF A50 con un modulo I/O FC a 4 porte da 64 Gb/s
