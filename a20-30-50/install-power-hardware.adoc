...
** Il display dell'ID dello shelf sulla parte anteriore dello chassis del sistema non si illumina. L'ID dello shelf interno del sistema è fissato a 00.


. Fissare i cavi di alimentazione utilizzando il dispositivo di fissaggio su ciascun alimentatore. :a20-30-50!:
