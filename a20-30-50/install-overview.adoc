...
---
= Flusso di lavoro per l'installazione e la configurazione di AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Prima di installare il sistema storage, deve soddisfare i requisiti di installazione.
