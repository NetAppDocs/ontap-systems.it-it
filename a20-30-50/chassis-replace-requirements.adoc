...
summary: Prima di sostituire lo chassis del tuo sistema storage AFF A20, AFF A30 o AFF A50, verifica di soddisfare i requisiti necessari per una sostituzione corretta. Questo include verificare che tutti gli altri componenti del sistema funzionino correttamente, che tu abbia lo chassis di ricambio corretto e che tu abbia gli strumenti necessari. 
---
= Esamina i requisiti per la sostituzione di uno chassis in un sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
