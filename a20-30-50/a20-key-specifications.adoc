...
summary: Specifiche chiave per AFF A20 
---
...
[role="lead"]
Di seguito sono riportate alcune specifiche per il sistema di archiviazione AFF A20 in una singola coppia ad alta disponibilità.  Per le specifiche complete di questo sistema di storage, visitare NetApp Hardware Universe (HWU).



== Specifiche AFF A20 in sintesi
...
* Tipo: NAS; Coppie HA: 3; Capacità raw: 12,1 PB / 10,8 PiB; Memoria massima: 384 GB
* Tipo: SAN; Coppie HA: 3; Capacità grezza: 12,1 PB / 10,8 PiB; Memoria massima: 384 GB
* Tipo: coppia HA; capacità grezza: 4,0 PB / 3,6 PiB; memoria massima: 128,0000
