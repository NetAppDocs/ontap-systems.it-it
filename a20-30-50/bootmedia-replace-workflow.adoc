...
summary: 'Come iniziare a sostituire i supporti di avvio nel sistema di storage AFF A20, AFF A30 o AFF A50, rivedere i requisiti di sostituzione, controllare lo stato della crittografia, spegnere il controller, sostituire il supporto di avvio, avviare l"immagine di ripristino, ripristinare la crittografia e verificare la funzionalità del sistema.' 
---
...
[role="lead"]
Come iniziare a sostituire i supporti di avvio nel sistema di storage AFF A20, AFF A30 o AFF A50, rivedere i requisiti di sostituzione, controllare lo stato della crittografia, spegnere il controller, sostituire il supporto di avvio, avviare l'immagine di ripristino, ripristinare la crittografia e verificare la funzionalità del sistema.
