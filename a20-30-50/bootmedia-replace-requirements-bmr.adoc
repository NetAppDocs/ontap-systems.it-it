...
summary: Prima di sostituire il supporto di avvio nei sistemi storage AFF A20, AFF A30 e AFF A50, assicurarsi di soddisfare i requisiti necessari per una sostituzione corretta. Ciò include la verifica di disporre del supporto di avvio sostitutivo corretto, la conferma che la porta e0M sul controller danneggiato funzioni correttamente e la determinazione se Onboard Key Manager o External Key Manager siano abilitati. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema AFF A20, AFF A30 o AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
