...
---
= Requisiti e considerazioni sull'installazione - AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Leggi i requisiti e le considerazioni sul tuo sistema di storage AFF A20, AFF A30 o AFF A50.
