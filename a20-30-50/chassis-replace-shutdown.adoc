...
summary: Spegnere i controller del sistema storage AFF A20, AFF A30 o AFF A50 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis. 
---
= Spegnere i controller per sostituire lo chassis: AFF A20, AFF A30 e AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere i controller del sistema storage AFF A20, AFF A30 o AFF A50 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
