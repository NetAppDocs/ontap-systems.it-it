...
summary: Per completare la sostituzione del controller per il sistema AFF A1K, ripristinare la configurazione di NetApp Storage Encryption, confermare che le interfacce logiche stiano riportando alle loro porte home, eseguire un controllo dello stato del cluster e restituire la parte guasta a NetApp. 
---
= Completa la sostituzione del controller per il tuo sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
