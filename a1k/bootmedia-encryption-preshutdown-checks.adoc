...
summary: Per garantire la sicurezza dei dati sul sistema di storage AFF A1K, è necessario verificare il supporto della chiave di crittografia e lo stato sul supporto di avvio. Controllare se la versione di ONTAP in uso supporta la crittografia dei volumi NetApp e prima di arrestare il controller verificare se il gestore delle chiavi è attivo. 
---
= Controllare il supporto della crittografia per il ripristino manuale dei supporti di avvio - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema di storage AFF A1K, è necessario verificare il supporto della chiave di crittografia e lo stato sul supporto di avvio. Verifica se la versione di ONTAP supporta la crittografia dei volumi di NetApp (NVE) e prima di arrestare il controller verifica se il gestore delle chiavi è attivo.
