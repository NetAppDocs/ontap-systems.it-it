...
summary: Per garantire la sicurezza dei dati sul sistema storage AFF A1K, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Controlla se la versione di ONTAP supporta NetApp Volume Encryption e, prima di spegnere il controller, verifica che il key manager sia attivo. 
---
= Controlla il supporto della crittografia sul supporto di avvio in un sistema AFF A1K usando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per garantire la sicurezza dei dati sul sistema storage AFF A1K, è necessario verificare il supporto e lo stato della chiave di crittografia sul supporto di avvio. Verificare se la versione di ONTAP supporta NetApp Volume Encryption (NVE) e, prima di spegnere il controller, verificare che il key manager sia attivo.
