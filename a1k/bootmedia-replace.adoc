...
[role="lead"]
Per sostituire il supporto di avvio, è necessario rimuovere il modulo di gestione del sistema dal retro del sistema, rimuovere il supporto di avvio danneggiato, installare il supporto di avvio sostitutivo nel modulo di gestione del sistema e trasferire l'immagine ONTAP da un'unità flash USB al supporto di avvio sostitutivo.
...
.. Premere il pulsante della camma di gestione del sistema. La leva della camma si allontana dal contenitore.
