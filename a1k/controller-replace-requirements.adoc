...
summary: 'Prima di sostituire il controller nel tuo sistema AFF A1K, verifica di soddisfare i requisiti necessari per una sostituzione corretta. Questo include verificare che tutti gli altri componenti del sistema funzionino correttamente, che tu abbia il controller di ricambio corretto e salvare l"output della console del controller in un file di log.' 
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Dopo aver esaminato i requisiti per la sostituzione del controller AFF A1K, è necessario link:controller-replace-shutdown.html["spegnere il controller danneggiato"].
