...
[role="lead"]
Preparatevi a sostituire il telaio danneggiato nel vostro sistema AFF A1K identificando il telaio danneggiato, verificando i componenti sostitutivi ed etichettando i cavi e il modulo controller.
