...
summary: Aggiungere un modulo i/o al sistema AFF A1K per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati. 
---
= Aggiungi un modulo I/O in un sistema AFF A1K per migliorare la connettività di rete
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Aggiungere un modulo i/o al sistema AFF A1K per migliorare la connettività di rete ed espandere la capacità del sistema di gestire il traffico dati.
