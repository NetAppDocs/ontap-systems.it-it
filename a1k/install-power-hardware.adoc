...
---
= Accendi il tuo sistema storage AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato l'hardware e i cavi del rack per il sistema storage AFF A1K, accendi le shelf di storage e i controller.
...
Dopo aver acceso il sistema di archiviazione AFF A1K , https://docs.netapp.com/us-en/ontap/software_setup/workflow-summary.html["configura il tuo cluster"] .
