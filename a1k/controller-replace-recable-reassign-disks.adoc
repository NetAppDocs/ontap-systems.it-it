...
. Controllare la versione del firmware TMP con il `sysconfig -v` comando.
+
** Se la versione è inferiore a 5,63, contattare https://support.netapp.com["Supporto NetApp"].
** Se la versione è superiore a 5,63, uscire al prompt di Loader: `halt`.
