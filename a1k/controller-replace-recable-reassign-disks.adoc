...
---
= Restituisci il controller nel tuo sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituisci il controllo delle risorse di storage al controller sostitutivo così il tuo sistema AFF A1K può riprendere il normale funzionamento. La procedura di give back varia in base al tipo di crittografia utilizzato dal tuo sistema: nessuna crittografia oppure crittografia con Onboard Key Manager (OKM).
