...
---
= Restituisci il controller nel tuo sistema AFF A1K per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ripristina il controllo delle risorse di storage sul controller sostitutivo, in modo che il sistema AFF A1K possa riprendere il normale funzionamento. La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema: nessuna crittografia o crittografia Onboard Key Manager (OKM).
