...
summary: 'Il ripristino automatico dell"immagine di avvio prevede che il sistema identifichi e selezioni automaticamente l"opzione appropriata del menu di avvio. Utilizza l"immagine di avvio sul nodo partner per reinstallare ONTAP sul supporto di avvio sostitutivo del sistema AFF A1K .' 
---
...
[role="lead"]
Il ripristino automatico dell'immagine di avvio prevede che il sistema identifichi e selezioni automaticamente l'opzione appropriata del menu di avvio. Utilizza l'immagine di avvio sul nodo partner per reinstallare ONTAP sul supporto di avvio sostitutivo nel sistema di storage AFF A1K.
