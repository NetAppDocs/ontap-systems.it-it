...
summary: 'Il supporto di avvio nel tuo sistema AFF A1K memorizza dati essenziali del firmware e della configurazione. La sostituzione prevede la rimozione del modulo di gestione del sistema, la rimozione del supporto di avvio danneggiato, l"installazione del nuovo supporto di avvio e la reinstallazione del modulo.' 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A1K utilizzando la procedura di ripristino automatico dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
