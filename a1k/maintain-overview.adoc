...
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:chassis-replace-workflow.html["Chassis"]
 a| 
Lo chassis ospita le ventole, il controller, gli alimentatori, NVRAM, il modulo di gestione del sistema, le schede I/O e i moduli di chiusura.
