...
[role="lead"]
Potrebbe essere necessario eseguire le procedure di manutenzione dell'hardware. In questa sezione sono riportate le procedure specifiche per la manutenzione dei componenti del sistema AFF A1K.

Le procedure descritte in questa sezione presuppongono che il sistema AFF A1K sia già stato implementato come nodo di storage nell'ambiente ONTAP.
