...
summary: 'Sostituisci l"alimentatore CA o CC del tuo sistema AFF A1K quando si guasta o presenta un malfunzionamento, per garantire che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"alimentatore difettoso dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"alimentatore difettoso e quindi ricollegarlo alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire un'unità di alimentazione CA o CC (PSU) nel sistema AFF A1K in caso di guasto o guasto, assicurandosi che il sistema continui a ricevere l'alimentazione necessaria per un funzionamento stabile. Il processo di sostituzione prevede lo scollegamento dell'alimentatore difettoso dalla fonte di alimentazione, lo scollegamento del cavo di alimentazione, la sostituzione dell'alimentatore difettoso e il ricollegamento alla fonte di alimentazione.
