...
---
= Sostituisci a caldo un modulo I/O nel tuo sistema AFF A1K senza spegnerlo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per swap a caldo un modulo I/O, verifica che il sistema storage esegua ONTAP 9.18.1 GA o versioni successive. Poi prepara il sistema storage e il modulo I/O, sostituisci a caldo il modulo guasto, porta online il modulo sostitutivo, ripristina il normale funzionamento e restituisci il modulo guasto a NetApp.
