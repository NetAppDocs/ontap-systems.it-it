...
summary: Completare setup e configurazione utilizzando il rilevamento del cluster solo con una connessione allo switch e al portatile, oppure connettendoti direttamente a un controller nel sistema storage e quindi allo switch di gestione. 
---
...
[role="lead"]
Dopo l'attivazione del sistema di storage AFF A1K, è possibile rilevare una rete di cluster e configurare un cluster ONTAP.
