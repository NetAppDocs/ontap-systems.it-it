...
summary: Arrestare il controller danneggiato nel sistema di archiviazione AFF A1K per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di avvio. 
---
= Spegnere il controller per il ripristino manuale del supporto di avvio - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
