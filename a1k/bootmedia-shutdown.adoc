...
summary: 'Arresta il controller danneggiato nel tuo sistema storage AFF A1K per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale all"avvio.' 
---
= Arresta il controller nel tuo sistema AFF A1K durante il processo di ripristino manuale all'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema storage AFF A1K per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale all'avvio.
