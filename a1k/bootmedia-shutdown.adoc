...
summary: Arresta il controller nel tuo sistema storage AFF A1K per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot. 
---
...
[role="lead"]
Arresta il controller nel tuo sistema storage AFF A1K per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale del supporto di boot.
