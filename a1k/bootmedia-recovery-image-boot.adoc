...
[role="lead"]
Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema AFF A1K, è possibile avviare l'immagine di ripristino da un'unità USB e ripristinare la configurazione dal nodo partner.
