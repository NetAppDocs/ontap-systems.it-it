...
summary: Dopo aver installato il nuovo dispositivo di supporto di avvio nel sistema AFF A1K , è possibile avviare il processo di ripristino automatico del supporto di avvio per ripristinare la configurazione dal nodo partner. 
---
= Ripristino automatico del supporto di avvio dal nodo partner - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
