...
---
= Flusso di lavoro per l'installazione e la configurazione di AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Prima di accendere i controller, accendi ciascun shelf NS224 e assegna un ID univoco così che ogni shelf sia identificato in modo univoco all'interno della configurazione. Poi collega il laptop o la console al controller e collega i controller alle fonti di alimentazione.
