...
sidebar: sidebar 
keywords: hot-swap, fail, power, supply, ds460c, ds224c, ds212c, disk, shelf-nondisruptive, shelf, nondisruptive, system, power, I O, progress, hot-swap a power supply 
