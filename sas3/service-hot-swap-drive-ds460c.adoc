...
sidebar: sidebar 
keywords: hot-swap, replace, disk, drive, ds460c, sas, shelf 
summary: È possibile sostituire a caldo un disco guasto in uno shelf di dischi DS460C. 
---
= Sostituisci a caldo un'unità disco in uno shelf DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un'unità disco guasta in un alloggiamento per dischi DS460C con moduli IOM12, IOM12B o IOM12C.
