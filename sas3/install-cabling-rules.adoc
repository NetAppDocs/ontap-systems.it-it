...
sidebar: sidebar 
keywords: disk, shelf, iom12, module, iom12b, iom12c, configuration, support, platform, sas, cabling, cable, rule, controller, connection, mini-sas optical, ds212c, ds224c, ds460c 
summary: 'Gli alloggiamenti per dischi con moduli IOM12, IOM12B o IOM12C possono essere cablati in configurazioni a coppia HA e a singolo controller (per le piattaforme supportate).' 
---
= Regole e concetti di cablaggio SAS per shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gli shelf DS212C, DS224C e DS460C con moduli IOM12, IOM12B o IOM12C possono essere cablati in configurazioni a coppia HA e a singolo controller (per le piattaforme supportate) applicando le regole di cablaggio SAS: regole di configurazione, regole di numerazione degli slot del controller, regole di connessione shelf-to-shelf, regole di connessione controller-to-stack e, se applicabile, regole per i cavi ottici mini-SAS HD SAS.


NOTE: Le regole di cablaggio SAS relative alla numerazione degli slot del controller, alle regole di connessione tra shelf e alle regole di connessione tra controller e stack descritte in questa guida sono le stesse che si applicano a tutti gli shelf di dischi SAS, sia che abbiano moduli IOM12, IOM12B o IOM12C. Tuttavia, le informazioni in questa guida sono specifiche per le caratteristiche uniche degli shelf di dischi con moduli IOM12, IOM12B o IOM12C e per il loro utilizzo nelle configurazioni supportate.

Le regole di cablaggio SAS relative alle regole di configurazione e alle regole per i cavi ottici mini-SAS HD SAS descritte in questa guida sono specifiche per gli alloggiamenti per dischi con moduli IOM12, IOM12B o IOM12C.
...
Gli alloggiamenti per dischi con moduli IOM12, IOM12B o IOM12C sono supportati su specifici tipi di coppia HA e configurazioni a singolo controller.
...
[[controller-0b0b1-and-0a-port-connection-rules-for-platforms-with-internal-storage]]
