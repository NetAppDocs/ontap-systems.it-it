...
sidebar: sidebar 
keywords: hot-add, add, disk, shelf, iom12, stack, sas, hba, port, controller, iom12b, iom12c, ds212c, ds224c, ds460c 
summary: Puoi aggiungere a caldo uno o più shelf di dischi a una pila esistente di shelf di dischi oppure aggiungere a caldo una pila di uno o più shelf di dischi direttamente a un SAS HBA o a una porta SAS integrata sul controller. 
---
= Aggiungi a caldo uno shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi aggiungere a caldo uno o più shelf di dischi a una pila esistente di shelf di dischi oppure aggiungere a caldo una pila di uno o più shelf di dischi direttamente a un SAS HBA o a una porta SAS integrata sul controller.
...
* Assicurati che il tuo sistema soddisfi determinati requisiti prima di aggiungere a caldo unità disco con moduli IOM12, IOM12B o IOM12C:
+
...
+
** Se aggiungi a caldo uno shelf di dischi con moduli IOM12, IOM12B o IOM12C a uno stack esistente (di shelf di dischi con moduli IOM12, IOM12B o IOM12C), puoi aggiungere a caldo lo shelf di dischi a una delle due estremità—la prima o l'ultima shelf di dischi logica—dello stack.
+
...
** Gli alloggiamenti per dischi con moduli IOM12, IOM12B o IOM12C devono essere in uno stack unico.
...
CAUTION: *Possibile perdita di accesso ai dati:* Se in futuro sposti l'unità in un'altra area del data center o la trasporti in un'altra posizione, devi rimuovere i dischi dai cassetti dei dischi per evitare possibili danni ai cassetti dei dischi e ai dischi stessi.
...
.Prima di iniziare
* È necessario aver soddisfatto i requisiti per completare questa procedura e aver installato, acceso e impostato gli ID shelf per ogni shelf di dischi come indicato in<<install_disk_shelves_for_a_hot_add,Installare shelf di dischi con moduli IOM12 per un hot-add>> .
...
+
È necessario disattivare l'assegnazione automatica della proprietà del disco prima di cablare gli scaffali dei dischi aggiunti a caldo e riattivarla più avanti in questa procedura, dopo aver cablato gli scaffali dei dischi aggiunti a caldo.
...
. Se si aggiunge a caldo una pila di shelf di dischi direttamente a un controller, completare i seguenti sotto-passaggi; in caso contrario, passare al passaggio successivo.
+
...
Se in futuro sposti gli shelf DS460C in un'altra area del data center o trasporti gli shelf in un'altra posizione, devi rimuovere i dischi dai cassetti dei dischi per evitare possibili danni ai cassetti dei dischi e ai dischi stessi.
