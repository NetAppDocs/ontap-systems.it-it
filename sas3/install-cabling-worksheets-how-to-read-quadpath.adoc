...
summary: 'Usa questo esempio per guidarti nella lettura e nell"applicazione di un foglio di lavoro completato per cablare gli stack di shelf di dischi per una connettività a quattro percorsi.' 
---
= Leggi un foglio di lavoro per cablare i collegamenti controller-to-stack per la connettività quad-path di DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi usare questo esempio per capire come leggere e applicare un foglio di lavoro compilato ai cablaggi degli shelf di dischi con moduli IOM12, IOM12B o IOM12C per la connettività a quattro percorsi.
