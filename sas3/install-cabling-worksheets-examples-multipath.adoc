...
summary: Puoi usare i fogli di lavoro e gli esempi di cablaggio dal controller allo stack per cablare la tua coppia HA come una configurazione HA multipath. 
---
...
Questo vale per gli shelf con moduli IOM12, IOM12B o IOM12C.
