...
---
= Schema di cablaggio per una configurazione HA a quattro percorsi di DS212C, DS224C o DS460C con due HBA SAS a quattro porte
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi usare il foglio di lavoro completato per il cablaggio dal controller allo stack e l'esempio di cablaggio per collegare una configurazione HA a quattro percorsi con due HBA SAS a quattro porte. Questo vale per gli shelf con moduli IOM12, IOM12B o IOM12C.
