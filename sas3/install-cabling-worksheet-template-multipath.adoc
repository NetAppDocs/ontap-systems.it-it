...
summary: Puoi usare un foglio di lavoro per il cablaggio per definire le coppie di porte SAS del controller che puoi usare per collegare i controller agli stack di shelf di dischi e ottenere così una connettività multipath. 
---
= Schema di cablaggio per la connettività multipath DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi usare un foglio di lavoro per il cablaggio per definire le coppie di porte SAS del controller che puoi usare per collegare i controller agli stack di shelf di dischi, così da ottenere una connettività multipath in una coppia HA o in una configurazione a singolo controller. Puoi anche usare il foglio di lavoro compilato per guidarti nel cablaggio delle connessioni multipath per la tua configurazione.
