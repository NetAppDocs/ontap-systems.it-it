...
sidebar: sidebar 
keywords: install, cable, disk, shelf, iom12, module, system, ha, pair, single-controller, configuration, iom12b, iom12c, ds212c, ds224c, ds460c 
summary: Se il nuovo sistema non è stato fornito già installato in un armadio, devi installare e cablare gli shelf dei dischi in un rack. 
---
= Installa e collega uno shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Gli alloggiamenti per dischi con moduli IOM12, IOM12B o IOM12C vengono spediti con ID alloggiamento preimpostati su 00.
+
...
* Se non configuri il sistema per utilizzare l'assegnazione automatica della proprietà dei dischi durante l'installazione e la configurazione del sistema, dovrai assegnare manualmente la proprietà dei dischi.
