...
sidebar: sidebar 
keywords: shelf, sas, replace, drive, drawer, disk, dcm2, dcm, ds460c 
summary: 'Quando sostituisci un cassetto per unità disco in uno shelf, puoi arrestare l"intero sistema storage (coppia HA) oppure mantenere la coppia HA attiva e funzionante.' 
---
= Sostituisci un cassetto dischi DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Questa procedura si applica agli shelf dotati di cassetti con unità DCM e/o cassetti con unità DCM2 o DCM3. (Gli shelf avranno anche due moduli IOM12, due moduli IOM12B o due moduli IOM12C.)
+
...
[NOTE]
====
Quando sostituisci un cassetto unità guasto con un cassetto unità DCM2 o DCM3 più recente, assicurati che il software ONTAP e il firmware del modulo IOM12, IOM12B o IOM12C stiano eseguendo le versioni minime richieste per supportare i cassetti DCM2 o DCM3.

L'aggiornamento del firmware IOM12, IOM12B o IOM12C può essere eseguito prima o dopo la sostituzione di un drive drawer. Questa procedura prevede l'aggiornamento del firmware come parte della preparazione per la sostituzione del drive drawer.
...
. Se il tuo shelf avrà una combinazione di moduli IOM12, IOM12B o IOM12C con un qualsiasi numero di cassetti DCM3, il tuo sistema deve eseguire le seguenti versioni minime di ONTAP:
+
** ONTAP 9.17.1RC1
** ONTAP 9.16.1P3
** ONTAP 9.15.1P11
