...
summary: Se un modulo ventola si guasta in uno shelf di dischi DS460C, devi sostituirlo il prima possibile per garantire che lo shelf abbia un raffreddamento adeguato. 
---
= Sostituisci il modulo ventola del DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
