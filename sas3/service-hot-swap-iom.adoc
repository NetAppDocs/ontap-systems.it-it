...
summary: La configurazione del sistema determina se puoi eseguire una sostituzione a caldo senza interruzione del modulo IOM dello shelf o una sostituzione con interruzione del modulo IOM dello shelf quando un modulo IOM12, IOM12B o IOM12C dello shelf si guasta. 
---
= Sostituisci a caldo o sostituisci un modulo IOM DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La configurazione del sistema determina se puoi eseguire una sostituzione a caldo senza interruzione del modulo IOM dello shelf o una sostituzione con interruzione del modulo IOM dello shelf quando un modulo IOM12, IOM12B o IOM12C dello shelf si guasta.

.A proposito di questa attività
* Questa procedura si applica agli shelf dotati di moduli IOM12, IOM12B o IOM12C.
+

NOTE: Questa procedura è valida per la sostituzione a caldo di moduli IOM identici. Ciò significa che puoi sostituire un modulo IOM12 solo con un altro modulo IOM12, un modulo IOM12B solo con un altro modulo IOM12B o un modulo IOM12C solo con un altro modulo IOM12C.

* I moduli IOM12, IOM12B o IOM12C si distinguono per il loro aspetto:
+
...
+
I moduli IOM12C si distinguono per una striscia blu e grigia e per l'etichetta "IOM12C":

+
image::../media/drw_iom12c_ieops-2175.svg[Parte anteriore di IOM12C]
...
* Per le configurazioni HA a percorso singolo della serie FAS2700, devi eseguire un'operazione di takeover e giveback per sostituire un modulo IOM in un sistema acceso e che sta fornendo dati: l'I/O è in corso.
+
...
* Se necessario, puoi consultare la link:service-monitor-leds.html#operator-display-panel-leds["Monitoraggio dei LED del ripiano del disco"] guida per informazioni sul significato e la posizione dei LED degli shelf dei dischi sul pannello di visualizzazione dell'operatore e sui componenti FRU.


.Prima di iniziare
* Tutti gli altri componenti del sistema, compreso l'altro modulo IOM12, IOM12B o IOM12C, devono funzionare correttamente.
...
Passare alla fase successiva.
 ...
 a| 
Configurazione HA a percorso singolo della serie FAS2700
 a| 
