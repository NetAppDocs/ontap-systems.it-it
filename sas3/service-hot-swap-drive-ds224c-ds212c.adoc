...
sidebar: sidebar 
keywords: hot-swap, disk, drive, ds224c, ds212c, disk, replace, sas 
summary: È possibile sostituire a caldo un disco guasto in uno shelf di dischi DS224C o DS212C. 
---
= Sostituisci a caldo un'unità disco in uno shelf DS212C o DS224C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un'unità disco guasta in un alloggiamento per dischi DS224C o DS212C con i moduli IOM12, IOM12B o IOM12C.
