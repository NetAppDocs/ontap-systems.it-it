...
sidebar: sidebar 
keywords: hot-remove, remove, disk, shelf, sas3, iom12, iom12b, iom12c, stack, ds460c, transport, move, ds212c, ds224c 
summary: Puoi rimuovere a caldo uno shelf di dischi quando deve essere rimosso o sostituito da un sistema acceso e con I/O in corso. 
---
= Rimuovi a caldo uno shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi rimuovere a caldo uno shelf di dischi quando deve essere rimosso o sostituito da un sistema acceso e mentre è in corso I/O. Puoi rimuovere a caldo uno o più shelf di dischi da qualsiasi punto all'interno di una pila di shelf di dischi oppure rimuovere un'intera pila di shelf di dischi.
...
.. Se necessario, procedere alla riattivazione dell'assegnazione automatica (diversi passaggi riportati di seguito).
...
+
** I moduli IOM12, IOM12B o IOM12C sono disposti uno accanto all'altro come in un alloggiamento per dischi DS224C o DS212C; se hai un DS460C, i moduli IOM12, IOM12B o IOM12C sono disposti uno sopra l'altro.
...
Se sposti uno shelf DS460C in un'altra parte del data center o trasporti lo shelf in un'altra posizione, devi rimuovere i dischi dai cassetti dei dischi per evitare possibili danni ai cassetti dei dischi e ai dischi stessi.
