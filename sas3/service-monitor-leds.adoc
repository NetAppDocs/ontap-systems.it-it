...
---
= Monitora i LED dello shelf DS212C, DS224C o DS460C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Ambra fisso
 a| 
Si è verificato un errore nel funzionamento di uno o più FRU: il disk shelf, le unità disco, i moduli IOM12, IOM12B o IOM12C oppure gli alimentatori.
...
Il LED di posizione sul pannello di controllo dell'operatore e su entrambi i moduli IOM12, IOM12B o IOM12C si illumina quando questa funzione LED è attivata. I LED di posizione si spengono automaticamente dopo 30 minuti.
...
== LED del modulo IOM12, IOM12B o IOM12C

I LED presenti sui moduli IOM12, IOM12B o IOM12C indicano se il modulo funziona correttamente, se è pronto per il traffico I/O e se sono presenti problemi hardware.

La tabella seguente descrive i LED dei moduli IOM12, IOM12B o IOM12C associati alla funzione del modulo e alla funzione di ciascuna porta SAS sul modulo.

Il modulo IOM12, IOM12B o IOM12C viene utilizzato negli shelf di dischi DS460C, DS224C e DS212C.
...
Ambra fisso
 a| 
Funzione del modulo IOM12, IOM12B o IOM12C: si è verificato un errore nella funzione del modulo IOM12, IOM12B o IOM12C.
...
Blu fisso
 a| 
Il system administrator ha attivato questa funzione LED per aiutarti a individuare fisicamente il disk shelf con il modulo IOM12, IOM12B o IOM12C guasto.
