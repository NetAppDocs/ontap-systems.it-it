...
summary: 'Installare la shelf NS224 in un armadio o in un rack telco, collegare i cavi di alimentazione e impostare l"ID della shelf per il sistema AFF.' 
---
= Installa uno shelf NS224 sul tuo sistema AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installare la shelf NS224 in un armadio o in un rack telco, collegare i cavi di alimentazione e impostare l'ID della shelf per il sistema AFF.
...
Dopo aver installato la mensola, link:hot-add-aff-cable-overview.html["cabla il tuo shelf"].
