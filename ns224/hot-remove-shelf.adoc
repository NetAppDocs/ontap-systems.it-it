...
sidebar: sidebar 
keywords: ns224, shelves, shelf, ns224 shelves, drive, aggregate, ha, pair, serving, data, io, hot-remove an ns224 
...
---
= Rimuovi a caldo uno shelf NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se si desidera rimuovere più di un ripiano, ripetere i passaggi precedenti.
+
