...
summary: Collega il tuo shelf NS224 al sistema AFF A70, AFF A90 o AFF C80 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA. 
---
= Collega un shelf NS224 al tuo sistema AFF A70, AFF A90 o AFF C80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Collega il tuo shelf NS224 al sistema AFF A70, AFF A90 o AFF C80 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA.
