...
sidebar: sidebar 
keywords: ns224, shelves, shelf, ns224 shelves, boot, media, run, ontap, nvme, module, nsm, firmware, version, nondisruptive, io 
summary: 'È possibile sostituire un supporto di avvio guasto in uno shelf NS224. La sostituzione del supporto di avvio può essere eseguita senza interruzioni, mentre lo shelf del disco è acceso e l"i/o è in corso.' 
---
= Sostituire il supporto di avvio NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
