...
summary: 'Se hai disabilitato l"assegnazione automatica delle unità, assegna manualmente la proprietà delle unità e riattiva l"assegnazione automatica delle unità per il tuo sistema AFF.' 
---
= Completa l'aggiunta a caldo del shelf NS224 per il tuo sistema AFF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
