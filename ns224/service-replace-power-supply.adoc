...
sidebar: sidebar 
keywords: ns224, shelves, shelf, ns224 shelves, replace, fail, power, supply, nondisruptive, drive, io, progress, hot-swap, hot-swap a power supply 
...
---
= Sostituzione a caldo di un alimentatore NS224
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
