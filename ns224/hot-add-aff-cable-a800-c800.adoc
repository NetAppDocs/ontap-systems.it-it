...
summary: Collega il tuo shelf NS224 al sistema AFF A800 o AFF C800 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA. 
---
= Collega un shelf NS224 al tuo sistema AFF A800 o AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Collega il tuo shelf NS224 al sistema AFF A800 o AFF C800 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA.
