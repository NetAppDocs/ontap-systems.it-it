...
summary: Collega il tuo shelf NS224 al sistema AFF A400 o AFF C400 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA. 
---
= Collega uno shelf NS224 al tuo sistema AFF A400 o AFF C400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Collega il tuo shelf NS224 al sistema AFF A400 o AFF C400 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA.
