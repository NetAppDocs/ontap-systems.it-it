...
summary: Collega il tuo shelf NS224 al sistema ASA A30 o ASA A50 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA. 
---
= Collega uno shelf NS224 a un sistema ASA A30 o ASA A50 tramite cavo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Collega il tuo shelf NS224 al sistema ASA A30 o ASA A50 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA.

È possibile aggiungere a caldo fino a due shelf NS224 a una coppia HA ASA A30 o ASA A50 quando è necessario ulteriore storage (allo shelf interno).
