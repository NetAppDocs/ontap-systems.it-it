...
summary: Collega il shelf NS224 al sistema AFF A20 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA. 
---
= Collega uno shelf NS224 al tuo sistema AFF A20
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Collega il shelf NS224 al sistema AFF A20 in modo che ogni shelf abbia due connessioni a ciascun controller della coppia HA.
