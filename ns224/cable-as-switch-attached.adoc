...
summary: 'Se si dispone di un sistema in cui gli shelf di dischi NS224 devono essere cablati come storage collegato allo switch (non come storage collegato direttamente), utilizzare le informazioni fornite.' 
---
= Collega i ripiani NS224 come storage collegato allo switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
