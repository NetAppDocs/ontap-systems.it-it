...
summary: 'Se hai disabilitato l"assegnazione automatica delle unità, assegna manualmente la proprietà delle unità e riattiva l"assegnazione automatica delle unità per il tuo sistema end-of-availability.' 
---
= Completa l'aggiunta a caldo dello shelf NS224 al tuo sistema di fine disponibilità
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
