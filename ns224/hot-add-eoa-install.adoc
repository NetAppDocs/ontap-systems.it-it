...
summary: 'Installare il modulo NS224 in un armadio o in un rack per telecomunicazioni, collegare i cavi di alimentazione e impostare l"ID del modulo per il sistema di fine disponibilità.' 
---
= Installa un ripiano NS224 sul tuo sistema end-of-availability
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installare il modulo NS224 in un armadio o in un rack per telecomunicazioni, collegare i cavi di alimentazione e impostare l'ID del modulo per il sistema di fine disponibilità.

.Prima di iniziare
* Assicurati di avere una graffetta con un lato raddrizzato o una penna a sfera con la punta sottile.
+
...
Dopo aver installato la mensola, link:hot-add-eoa-cable-overview.html["cabla il tuo shelf"].
