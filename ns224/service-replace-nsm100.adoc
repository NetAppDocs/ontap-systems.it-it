...
sidebar: sidebar 
keywords: ns224, shelves, shelf, ns224 shelves, replace, impair, nvme, module, nsm, nondisruptive, drive, io, nsm, replace an NSM 
summary: 'È possibile sostituire un modulo shelf NVMe (NSM) non compromesso senza interruzioni in uno shelf di dischi NS224 acceso e mentre l"i/o è in corso.' 
---
= Sostituire un modulo NS224 NSM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Prima di chiudere il coperchio NSM danneggiato, assicurarsi che le linguette di espulsione di tutti gli slot DIMM vuoti siano completamente riportate in posizione di blocco.
