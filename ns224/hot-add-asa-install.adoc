...
summary: 'Installare lo shelf NS224 in un armadio o in un rack per telecomunicazioni, collegare i cavi di alimentazione e impostare l"ID dello shelf per il sistema ASA.' 
---
= Installa uno shelf NS224 sul tuo sistema ASA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installare lo shelf NS224 in un armadio o in un rack per telecomunicazioni, collegare i cavi di alimentazione e impostare l'ID dello shelf per il sistema ASA.
...
Dopo aver installato la mensola, link:hot-add-asa-cable-overview.html["cabla il tuo shelf"].
