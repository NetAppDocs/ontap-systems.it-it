...
summary: È necessario sostituire un DIMM nel controller quando il sistema storage riscontra errori quali un numero eccessivo di errori CECC basati sugli avvisi di Health Monitor o errori ECC non correggibili, in genere causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP. 
---
= Sostituisci un modulo DIMM nel tuo sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo AFF A200 quando il sistema storage rileva un numero eccessivo di errori ECC correggibili o un errore ECC non correggibile, che di solito è causato dal guasto di un singolo DIMM.
