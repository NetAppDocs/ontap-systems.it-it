...
summary: 'Sostituisci la batteria dell"orologio in tempo reale nel tuo sistema AFF A200 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.' 
---
= Sostituisci la batteria dell'orologio real-time in un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
