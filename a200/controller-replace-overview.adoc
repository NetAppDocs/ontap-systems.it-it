...
---
= Esamina i requisiti per la sostituzione di un controller in un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel tuo sistema AFF A200, verifica i prerequisiti per la procedura di sostituzione e seleziona quella corretta per la tua versione di ONTAP.
