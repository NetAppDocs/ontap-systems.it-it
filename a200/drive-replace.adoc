...
---
= Sostituisci a caldo un disco in un sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puoi sostituire a caldo un'unità guasta nel tuo sistema AFF A200 senza interrompere l'I/O. L'AFF A200 supporta sia SSD che HDD, ognuno con una procedura di sostituzione dedicata.
