...
---
= Spegni il controller guasto nel tuo sistema AFF A200 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema AFF A200 prima della sostituzione, prendendone il controllo e portandolo al prompt LOADER.
