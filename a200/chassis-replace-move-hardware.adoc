...
---
= Sostituisci lo chassis nel tuo sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis nel tuo sistema AFF A200 spostando gli alimentatori, i dischi rigidi e i moduli controller dallo chassis guasto a quello di ricambio.
...
Spostare l'alimentatore dal vecchio chassis al nuovo chassis.
...
CAUTION: Non esercitare una forza eccessiva quando si inserisce l'alimentatore nel sistema. Il connettore potrebbe danneggiarsi.
