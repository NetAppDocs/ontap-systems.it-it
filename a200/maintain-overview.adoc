...
summary: 'Manutenzione dell"hardware AFF A200' 
---
= Scopri come effettuare la manutenzione del tuo sistema storage AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per il sistema storage AFF A200, è possibile eseguire le procedure di manutenzione dei seguenti componenti.
