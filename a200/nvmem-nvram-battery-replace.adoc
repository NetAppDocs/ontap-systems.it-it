...
---
= Sostituisci la batteria NVMEM nel tuo sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVMEM nel tuo sistema AFF A200 rimuovendo il modulo controller, aprendolo, sostituendo la batteria e reinstallando il modulo controller.
