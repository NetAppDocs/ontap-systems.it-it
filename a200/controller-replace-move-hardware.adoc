...
---
= Sostituisci il controller nel tuo sistema AFF A200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo sistema AFF A200 rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo controller di ricambio, installandolo nello chassis e avviando la modalità di manutenzione.
...
IMPORTANT: Durante il processo di avvio, potrebbero essere visualizzati i seguenti prompt:
