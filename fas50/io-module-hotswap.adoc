...
summary: È possibile eseguire lo swap a caldo di un modulo I/O Ethernet nel sistema storage FAS50 se un modulo si guasta e il sistema storage soddisfa tutti i requisiti della versione di ONTAP. 
---
= Effettua lo swap a caldo di un modulo I/O nel tuo sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
