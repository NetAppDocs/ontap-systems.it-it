...
---
= Flusso di lavoro per l'installazione e la configurazione di FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Per prepararti all'installazione, prepara il sito, verifica i requisiti ambientali ed elettrici e assicurati che ci sia abbastanza spazio rack. Poi, disimballa l'attrezzatura, confronta il contenuto con la packing slip e registra l'hardware per accedere ai vantaggi del supporto.
