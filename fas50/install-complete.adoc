...
summary: Dopo aver acceso il sistema di storage FAS50, sarai pronto a rilevare una rete di cluster e a configurare un cluster ONTAP. 
---
= Configurazione e configurazione completa del sistema di archiviazione - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver acceso il sistema di storage FAS50, sarai pronto a rilevare una rete di cluster e a configurare un cluster ONTAP.
