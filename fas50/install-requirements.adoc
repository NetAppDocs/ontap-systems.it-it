...
---
= Verifica i requisiti per l'installazione del tuo sistema storage FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Un ripiano DS460C può pesare fino a 260,4 libbre (118,1 kg). Per sollevare il ripiano, potresti aver bisogno fino a cinque persone o di un sollevatore idraulico. Tieni tutti i componenti all'interno del ripiano (sia davanti che dietro) per evitare di sbilanciare il peso del ripiano.
