...
summary: Il modulo I/O per cluster e HA supporta interconnessioni per clustering e alta disponibilità. È possibile sostituire a caldo il modulo nel sistema di storage FAS50 in caso di guasto e se il sistema di storage soddisfa requisiti specifici. 
---
= Sostituzione a caldo del modulo I/O utilizzato per il cluster e il traffico HA - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il modulo I/O per cluster e HA supporta interconnessioni per clustering e alta disponibilità. È possibile sostituire a caldo il modulo nel sistema di storage FAS50 in caso di guasto e se il sistema di storage soddisfa requisiti specifici.
