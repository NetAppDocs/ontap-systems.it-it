...
summary: Per sostituire il controller nel sistema di archiviazione FAS50, seguire questi passaggi del flusso di lavoro. 
---
= Procedura di sostituzione del controller FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire il controller nel sistema di archiviazione FAS50, seguire questi passaggi del flusso di lavoro.
...
[role="quick-margin-para"]
La sostituzione del controller prevede la rimozione del controller danneggiato, lo spostamento dei componenti FRU sul controller di ricambio, l'installazione del controller di ricambio, l'impostazione dell'ora e della data e il ricollegamento dei cavi.
