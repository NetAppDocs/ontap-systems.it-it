...
summary: 'Sostituire un"unità di alimentazione CA o CC nel sistema storage FAS50 quando si guasta o presenta un malfunzionamento, garantendo così che il sistema continui a ricevere l"alimentazione necessaria per un funzionamento stabile. La procedura di sostituzione prevede di scollegare l"unità di alimentazione difettosa dalla fonte di alimentazione, scollegare il cavo di alimentazione, sostituire l"unità di alimentazione difettosa e quindi ricollegarla alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
