...
---
= Specifiche chiave per un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Queste specifiche per il FAS50 si riferiscono a una singola coppia ad alta disponibilità. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche del FAS50.
