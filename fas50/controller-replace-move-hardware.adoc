...
summary: 'Sostituire il controller nel sistema di archiviazione FAS50 quando un guasto hardware lo richiede.  Il processo di sostituzione prevede la rimozione del controller danneggiato, lo spostamento dei componenti sul controller sostitutivo, l"installazione del controller sostitutivo e il riavvio.' 
---
= Sostituisci il controller nel tuo sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema di archiviazione FAS50 quando un guasto hardware lo richiede.  Il processo di sostituzione prevede la rimozione del controller danneggiato, lo spostamento dei componenti sul controller sostitutivo, l'installazione del controller sostitutivo e il riavvio.
...
CAUTION: Prima di chiudere il coperchio del controller danneggiato, assicurarsi che le linguette di espulsione di tutti gli slot DIMM vuoti siano completamente riportate in posizione di blocco.
...
Dopo aver sostituito il controller FAS50 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
