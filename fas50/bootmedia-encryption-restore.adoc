...
summary: 'Ripristina la crittografia sul supporto di avvio sostitutivo nel tuo sistema di storage FAS50 per garantire la protezione continua dei dati. Il processo di sostituzione prevede la verifica della disponibilità della chiave, la riapplicazione delle impostazioni di crittografia e la conferma dell"accesso sicuro ai dati.' 
---
= Ripristina la crittografia sul supporto di avvio in un sistema FAS50 usando la procedura di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
