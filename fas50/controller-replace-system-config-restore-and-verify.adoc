...
summary: Verifica che la configurazione ha del controller sia attiva e funzioni correttamente nel sistema di storage FAS50 e conferma che gli adattatori del sistema elencano tutti i percorsi dei dischi. 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Verifica che la configurazione ha del controller sia attiva e funzioni correttamente nel sistema di storage FAS50 e conferma che gli adattatori del sistema elencano tutti i percorsi dei dischi.
...
Dopo aver ripristinato e verificato la configurazione del sistema FAS50, è necessario link:controller-replace-recable-reassign-disks.html["restituire il controller"].
