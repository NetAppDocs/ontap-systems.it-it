...
summary: Dopo aver collegato i controller alla rete e agli shelf del sistema storage FAS50, si accenderanno shelf e controller. 
---
= Accendi il tuo sistema storage FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
