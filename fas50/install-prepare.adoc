...
summary: 'Preparare l"installazione del sistema di storage FAS50 preparando il sito, disimballando le confezioni e confrontando il contenuto delle confezioni con il documento di trasporto e registrando il sistema di storage per accedere ai vantaggi del supporto.' 
---
= Preparati a installare il tuo sistema storage FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
