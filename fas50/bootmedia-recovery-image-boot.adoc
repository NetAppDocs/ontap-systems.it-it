...
summary: 'Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema FAS50, è possibile avviare l"immagine di ripristino da un"unità USB e ripristinare la configurazione dal nodo partner.' 
---
= Avviare l'immagine di ripristino - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo aver installato il nuovo dispositivo multimediale di avvio nel sistema FAS50, è possibile avviare l'immagine di ripristino da un'unità USB e ripristinare la configurazione dal nodo partner.
