...
---
= Scopri come effettuare la manutenzione del tuo sistema storage FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:caching-module-hot-swap.html["Modulo di caching"]
 a| 
Un modulo di caching (modulo Flash Cache) utilizza SSD ad alta velocità per memorizzare i dati a cui si accede frequentemente, consentendone un recupero più rapido.
