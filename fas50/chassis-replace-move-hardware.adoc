...
summary: 'Sostituire lo chassis del sistema FAS50 quando un errore hardware lo richiede. Il processo di sostituzione prevede la rimozione dei controller e delle unità di alimentazione (PSU), la rimozione di eventuali moduli di caching, l"installazione dello chassis sostitutivo e la reinstallazione dei componenti dello chassis.' 
---
...
[role="lead"]
Sostituire lo chassis del sistema FAS50 quando un errore hardware lo richiede. Il processo di sostituzione prevede la rimozione dei controller e delle unità di alimentazione (PSU), la rimozione di eventuali moduli di caching, l'installazione dello chassis sostitutivo e la reinstallazione dei componenti dello chassis.
