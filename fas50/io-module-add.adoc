...
[role="lead"]
Aggiungi un modulo i/o al tuo sistema FAS50 per migliorare la connettività di rete e espandere la capacità del sistema di gestire il traffico dei dati.

È possibile aggiungere un modulo i/o ai sistemi di storage FAS50 quando sono disponibili slot o quando tutti gli slot sono completamente popolati.
