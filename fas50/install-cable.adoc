...
---
= Collega l'hardware FAS50 per la connettività di rete e storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/drw_isi_fas50_4p_25gbe_optional_cabling_ieops-1934.svg[Collega FAS50 agli switch di rete host Ethernet 10/25 GbE]
...
+
Il cablaggio per gli altri shelf SAS supportati è simile. Vedi link:../sas3/install-new-system.html["Ripiani di installazione e cavi per un'installazione di nuovo sistema"^]. Puoi anche fare riferimento a link:../sas3/overview-cabling-rules-examples.html["Panoramica delle regole di cablaggio SAS, dei fogli di lavoro e degli esempi"^].
