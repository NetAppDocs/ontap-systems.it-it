...
summary: Prima di sostituire il telaio del sistema di archiviazione FAS50, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita.  Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre del telaio sostitutivo corretto e degli strumenti necessari. 
---
...
[role="lead"]
Prima di sostituire il telaio del sistema di archiviazione FAS50, accertarsi di soddisfare i requisiti necessari per una sostituzione riuscita.  Ciò include la verifica del corretto funzionamento di tutti gli altri componenti del sistema, la verifica di disporre del telaio sostitutivo corretto e degli strumenti necessari.
