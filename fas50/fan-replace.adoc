...
summary: Sostituisci il modulo ventola nel tuo sistema FAS50 quando una ventola si guasta o non funziona in modo efficiente, perché questo può influire sul raffreddamento del sistema e sulle prestazioni complessive. La procedura di sostituzione prevede lo spegnimento del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp. 
---
= Sostituisci il modulo ventola in un sistema FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo ventola nel tuo sistema FAS50 quando una ventola si guasta o non funziona in modo efficiente, perché questo può influire sul raffreddamento del sistema e sulle prestazioni complessive. La procedura di sostituzione prevede lo spegnimento del controller, la rimozione del controller, la sostituzione della ventola, la reinstallazione del controller e la restituzione del componente guasto a NetApp.
