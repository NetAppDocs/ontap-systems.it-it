...
summary: Verificare il supporto e lo stato della chiave di crittografia prima di spegnere il controller danneggiato su un sistema FAS8200 . Il sistema FAS8200 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Verifica il supporto della crittografia sul supporto di avvio in un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
