...
---
= Sostituisci il controller nel tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_boot_media.png[Rimozione del supporto di avvio]
...
.. Con la maniglia a camma in posizione aperta, spingi con decisione il modulo controller fino a quando non incontra il midplane ed è completamente inserito, quindi chiudi la maniglia a camma in posizione di blocco. Stringi la vite a testa zigrinata sulla maniglia a camma sul retro del modulo controller.
+
