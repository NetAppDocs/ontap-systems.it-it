...
summary: Ripristinare la configurazione di crittografia sul supporto di avvio sostitutivo per un sistema FAS8200 . Il sistema FAS8200 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Ripristina la crittografia sul supporto di avvio nel tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
