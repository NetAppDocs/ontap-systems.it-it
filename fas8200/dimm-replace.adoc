...
summary: Sostituisci il DIMM in un sistema FAS8200 quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili tramite avvisi di Health Monitor o errori ECC non correggibili. Un DIMM guasto può impedire al sistema storage di avviare ONTAP, quindi la sostituzione ripristina il funzionamento stabile. 
---
= Sostituisci un modulo DIMM in un sistema FAS8200 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il DIMM in un sistema FAS8200 quando il sistema segnala un numero eccessivo di errori di memoria ECC correggibili tramite avvisi di Health Monitor o errori ECC non correggibili. Un DIMM guasto può impedire al sistema storage di avviare ONTAP, quindi la sostituzione ripristina il funzionamento stabile.
