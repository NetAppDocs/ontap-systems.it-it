...
summary: 'Devi sostituire un DIMM nel modulo controller quando il sistema storage segnala un numero eccessivo di errori CECC (Correctable Error Correction Code) identificati dagli avvisi di Health Monitor, oppure errori ECC non correggibili causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.' 
---
= Sostituisci un modulo DIMM nel tuo sistema FAS8200 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Devi sostituire un DIMM nel modulo controller quando il sistema storage segnala un numero eccessivo di errori CECC (Correctable Error Correction Code) identificati dagli avvisi di Health Monitor, oppure errori ECC non correggibili causati dal guasto di un singolo DIMM che impedisce al sistema storage di avviare ONTAP.
