...
summary: Sostituisci la batteria del real-time clock nel modulo controller così che i tuoi servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare. 
---
= Sostituisci la batteria dell'orologio in tempo reale nel tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[step-4-reinstall-the-controller-module-and-reset-the-time-and-date-after-rtc-battery-replacement]]
== Passaggio 4: Reinstalla il modulo controller e reimposta l'ora e la data dopo la sostituzione della batteria RTC
