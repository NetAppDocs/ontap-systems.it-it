...
summary: Sostituisci a caldo un modulo ventola guasto nel tuo sistema FAS8200 senza interrompere il servizio. Completa la sostituzione entro due minuti per evitare il surriscaldamento del controller. 
---
= Sostituisci a caldo un modulo ventola in un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un modulo ventola guasto nel tuo sistema FAS8200 senza interrompere il servizio. Completa la sostituzione entro due minuti per evitare il surriscaldamento del controller.
...
+
Il modulo della ventola si allontana leggermente dal chassis.
...
|===
. Estrai il modulo ventola tirandolo dritto fuori dal chassis. Sostienilo con la mano libera così non oscilla fuori dal chassis.
+
...
. Solleva la maniglia a camma verso l'alto fino alla posizione di chiusura, finché il fermo di rilascio della maniglia a camma non scatta in posizione di blocco.
+
