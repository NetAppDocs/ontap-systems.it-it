...
summary: Dopo aver completato i controlli di crittografia, arrestare il controller danneggiato su un sistema FAS8200 . Il sistema FAS8200 supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Arresta il controller danneggiato nel tuo sistema FAS8200 durante il processo di ripristino manuale dal menu di boot
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
