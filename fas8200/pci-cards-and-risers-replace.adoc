...
summary: Per sostituire una scheda PCIe, devi rimuovere il modulo controller dal sistema, aprire il pannello laterale, rimuovere la scheda guasta, installare la scheda sostitutiva e poi reinstallare il modulo controller. 
---
= Sostituisci una scheda PCIe nel tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per sostituire una scheda PCIe, devi rimuovere il modulo controller dal sistema, aprire il pannello laterale, rimuovere la scheda guasta, installare la scheda sostitutiva e poi reinstallare il modulo controller.

* È possibile utilizzare questa procedura con tutte le versioni di ONTAP supportate dal sistema
* Tutti gli altri componenti del sistema devono funzionare correttamente; in caso contrario, devi contattare il supporto tecnico.
...
Per sostituire una scheda PCIe, individuarla all'interno del controller e seguire la sequenza di passaggi specifica.
...
|===
. Rimuovere la scheda PCIe dal modulo controller e metterla da parte.
. Installare la scheda PCIe sostitutiva.
+
...
.. Se non è già stato fatto, ricollegare i cavi al modulo controller.
...
[cols="1,3"]
|===
| Se il sistema è in... | Eseguire questo comando dalla console del partner... 
...
== Fase 5 (solo MetroCluster a due nodi): Switch back aggregate
