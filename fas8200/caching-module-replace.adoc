...
summary: È necessario sostituire il modulo di caching nel modulo controller quando il sistema registra un singolo messaggio AutoSupport che indica che il modulo è andato offline. In caso contrario, si verifica un peggioramento delle performance. 
---
= Sostituisci il modulo di caching nel tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tutti gli altri componenti del sistema storage devono funzionare correttamente; in caso contrario, contatta il supporto tecnico.
+
