...
summary: 'Per ripristinare il sistema FAS8200 al pieno funzionamento, ripristina la configurazione NetApp Storage Encryption (se necessario), installa le licenze per il nuovo controller e restituisci il componente guasto a NetApp come descritto nelle istruzioni RMA fornite con il kit.' 
---
= Completa la sostituzione del controller per il tuo sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per ripristinare il sistema FAS8200 al pieno funzionamento, ripristina la configurazione NetApp Storage Encryption (se necessario), installa le licenze per il nuovo controller e restituisci il componente guasto a NetApp come descritto nelle istruzioni RMA fornite con il kit.
