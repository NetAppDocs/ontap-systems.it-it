...
summary: La sostituzione di un alimentatore prevede di spegnere, scollegare e rimuovere il vecchio alimentatore e di installare, collegare e accendere quello di ricambio. 
---
= Sostituisci a caldo un alimentatore in un sistema FAS8200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
La sostituzione di un alimentatore prevede di spegnere, scollegare e rimuovere il vecchio alimentatore e di installare, collegare e accendere quello di ricambio.
