...
summary: 'Sostituisci la batteria dell"orologio in tempo reale nel modulo controller AFF A400 per garantire che i servizi e le applicazioni che dipendono da una sincronizzazione oraria precisa continuino a funzionare.' 
---
= Sostituisci la batteria dell'orologio real-time nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria dell'orologio in tempo reale (RTC) nel tuo sistema AFF A400 per garantire che i servizi e le applicazioni che si basano su una sincronizzazione oraria precisa continuino a funzionare.
