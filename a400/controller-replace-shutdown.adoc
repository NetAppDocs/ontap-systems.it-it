...
summary: Spegnere il controller nel sistema storage AFF A400 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del controller. 
---
= Spegni il controller difettoso nel tuo sistema AFF A400 prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere il controller nel sistema storage AFF A400 per evitare la perdita di dati e garantire la stabilità del sistema durante la sostituzione del controller.
...
Dopo aver spento il controller AFF A400, è necessario link:controller-replace-move-hardware.html["sostituire la centralina"].
