...
summary: Sostituire il controller nel sistema AFF A400 quando un guasto hardware lo richiede. Rimuovere il controller guasto, trasferire i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo. 
---
= Sostituisci il controller nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller nel sistema AFF A400 quando un guasto hardware lo richiede. Rimuovere il controller guasto, trasferire i suoi componenti sul controller di ricambio, installare il nuovo controller e riavviarlo.
...
Dopo aver sostituito il controller AFF A400 danneggiato, è necessario link:controller-replace-system-config-restore-and-verify.html["ripristinare la configurazione del sistema"].
