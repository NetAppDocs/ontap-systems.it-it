...
summary: Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema AFF A400 possa riprendere il normale funzionamento. 
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Restituire il controllo delle risorse di storage al controller sostitutivo in modo che il sistema AFF A400 possa riprendere il normale funzionamento.
