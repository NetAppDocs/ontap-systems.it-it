...
---
= Sostituisci a caldo un modulo ventola nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nel tuo sistema AFF A400, puoi sostituire a caldo il modulo ventola per mantenere un raffreddamento adeguato. Il modulo ventola deve essere sostituito entro due minuti dalla rimozione per evitare il surriscaldamento.
