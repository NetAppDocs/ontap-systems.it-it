...
summary: 'Sostituire un alimentatore nel sistema AFF A400 scollegando l"alimentatore di destinazione dalla fonte di alimentazione, scollegando il cavo di alimentazione, rimuovendo il vecchio alimentatore, installando quello di ricambio e poi ricollegandolo alla fonte di alimentazione.' 
---
= Sostituisci a caldo l'alimentatore nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un alimentatore nel tuo sistema AFF A400 quando si guasta o presenta un malfunzionamento. Gli alimentatori sono ridondanti e hot-swappable, quindi non devi spegnere il controller per eseguire questa sostituzione.
