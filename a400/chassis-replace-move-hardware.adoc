...
---
= Sostituisci lo chassis nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis del tuo AFF A400 quando un guasto hardware lo richiede. La procedura di sostituzione prevede lo spostamento delle ventole, dei dischi e dei moduli controller dallo chassis guasto a quello di ricambio.
