...
---
= Sostituisci la batteria NVDIMM nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVDIMM nel tuo sistema AFF A400 quando inizia a scaricarsi o smette di funzionare. La procedura di sostituzione prevede la rimozione del modulo controller, la sostituzione della batteria e la reinstallazione del modulo controller.
...
image::../media/drw_A400_nvdimm-batt_IEOPS-1004.svg[Sostituire la batteria NVDIMM]
