...
[role="lead"]
Spegni il controller danneggiato nel tuo sistema storage AFF A400 per evitare la perdita di dati e mantenere la stabilità del sistema durante il processo di ripristino manuale all'avvio.
