...
summary: Per ripristinare il funzionamento completo del sistema AFF A400, ripristinare la configurazione NetApp Storage Encryption se necessario, installare le licenze per il nuovo controller e restituire la parte guasta a NetApp. 
---
= Ripristino completo del sistema - AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
