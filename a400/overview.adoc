...
---
= Specifiche principali per un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Consulta le specifiche selezionate per l'AFF A400. Visita  https://hwu.netapp.com["NetApp Hardware Universe"^] (HWU) per un elenco completo delle specifiche dell'AFF A400. Questa pagina si riferisce a una singola coppia ad alta disponibilità.
...
Controller di gestione della scheda madre (BMC) basato su Ethernet e interfaccia di gestione ONTAP ; Controller ridondanti sostituibili a caldo; * Alimentatori ridondanti sostituibili a caldo * Gestione in banda SAS su connessioni SAS
