...
---
= Installa il tuo sistema AFF A400 seguendo istruzioni dettagliate passo passo
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa il tuo sistema storage AFF A400 seguendo queste istruzioni dettagliate passo passo, dalla preparazione del sito all'avvio del cluster ONTAP.
...
image:../media/oie_cable_fiber_lc_connector.png["Connettore in fibra LC"]
 a| 
Cavi FC da 16 Gb o 25 GbE per schede mezzanine (a seconda dell'ordine)
...
NOTE: Se le etichette delle porte sulla scheda non sono visibili, controlla l'orientamento di installazione della scheda. Il connettore PCIe si trova sul lato sinistro dello slot negli A400 e FAS8300/8700. Poi cerca la scheda tramite il codice articolo nell' https://hwu.netapp.com["NetApp Hardware Universe"^] per vedere un'immagine del pannello frontale che mostra le etichette delle porte. Puoi trovare il codice articolo della scheda usando il comando  `sysconfig -a` o nella lista di imballaggio del sistema.
...
+
image::../media/drw_A400_TNSC-network-cabling.png[Cablaggio di rete senza switch a due nodi]
...
Puoi collegare al tuo sistema tramite cavo sia shelf NS224 che shelf SAS.
...
+
image::../media/drw_a400_two_ns224_shelves.png[Collegare due ripiani ai controller]
...
+
image::../media/drw_a400_three_ds224c_shelves.png[Collegare tre ripiani ai controller]
...
.. Seleziona *Network* nel riquadro di sinistra, fai clic con il pulsante destro del mouse e seleziona *refresh*.
