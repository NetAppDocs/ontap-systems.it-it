...
summary: 'Dopo aver completato la sostituzione dell"FRU in una configurazione MetroCluster a due nodi, eseguire l"operazione di switchback MetroCluster per riportare la configurazione al suo stato operativo normale, con le macchine virtuali di storage della sorgente di sincronizzazione sul sito precedentemente compromesso ora attive e che forniscono dati dai pool di dischi locali.' 
---
= Commuta nuovamente gli aggregati in una configurazione a due nodi MetroCluster nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
