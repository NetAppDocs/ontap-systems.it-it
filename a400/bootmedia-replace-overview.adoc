...
[role="lead"]
Prima di sostituire il boot media nel tuo sistema AFF A400, verifica di soddisfare i requisiti necessari per una sostituzione riuscita. Questo include avere una unità flash USB formattata in FAT32 con spazio sufficiente per l'immagine di ripristino di ONTAP e determinare se la sostituzione sarà non distruttiva o distruttiva.
