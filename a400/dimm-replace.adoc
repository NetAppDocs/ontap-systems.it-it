...
summary: Sostituisci un DIMM nel modulo controller AFF A400 quando il sistema registra un numero crescente di codici di correzione degli errori correggibili o errori ECC non correggibili. La mancata sostituzione di un DIMM difettoso può causare un blocco del sistema. 
---
= Sostituisci un modulo DIMM nel tuo sistema AFF A400 per risolvere gli errori di memoria
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci un DIMM nel tuo sistema AFF A400 quando il sistema storage rileva un numero eccessivo di errori di memoria correggibili (CECC) o non correggibili. Tali errori possono impedire al sistema storage di avviare ONTAP.
