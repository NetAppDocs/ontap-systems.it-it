...
---
= Installa il tuo sistema AFF A400 usando le istruzioni grafiche rapide
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa e collega il tuo sistema storage AFF A400 usando le rapide istruzioni grafiche.
