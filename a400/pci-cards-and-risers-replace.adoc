...
---
= Sostituisci una scheda PCIe o mezzanine nel tuo sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una scheda PCIe o mezzanine nel tuo AFF A400 quando la scheda si guasta o necessita di un aggiornamento. La procedura di sostituzione prevede la disconnessione dei cavi e dei moduli SFP o QSFP, la sostituzione della scheda e il ricablaggio.
