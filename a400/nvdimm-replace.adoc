...
summary: Sostituire il modulo NVDIMM nel controller AFF A400 quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM identificato non è integro. La mancata sostituzione di un modulo NVDIMM difettoso può causare un system panic. 
---
= Sostituisci il modulo NVDIMM in un sistema AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo NVDIMM nel tuo sistema AFF A400 quando il sistema rileva che la durata della memoria flash sta per terminare o che il modulo NVDIMM non è in buone condizioni. La mancata sostituzione può causare un system panic.
...
Per rimuovere il modulo controller dal telaio, è possibile utilizzare le seguenti animazioni, illustrazioni o istruzioni scritte.
