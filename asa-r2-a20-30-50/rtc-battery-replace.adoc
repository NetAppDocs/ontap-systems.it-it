...
summary: 'Sostituire la batteria dell"orologio in tempo reale (RTC), comunemente nota come batteria a bottone, nel sistema ASA A20, ASA A30 o ASA A50 per garantire che i servizi e le applicazioni basati su una sincronizzazione accurata dell"ora rimangano operativi.' 
---
...
[role="lead"]
Sostituire la batteria dell'orologio in tempo reale (RTC), comunemente nota come batteria a bottone, nel sistema ASA A20, ASA A30 o ASA A50 per garantire che i servizi e le applicazioni basati su una sincronizzazione accurata dell'ora rimangano operativi.
