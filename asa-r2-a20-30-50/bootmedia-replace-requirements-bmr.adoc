...
summary: Prima di sostituire il supporto di avvio nel sistema storage ASA A20, ASA A30 o ASA A50, assicurati di soddisfare i requisiti e le considerazioni necessarie per una sostituzione corretta. Ciò include la verifica di disporre del supporto di avvio sostitutivo corretto, la conferma che la porta e0M sul controller guasto funzioni correttamente e la determinazione se Onboard Key Manager o External Key Manager siano abilitati. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
