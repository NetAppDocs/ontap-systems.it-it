...
summary: Verifica che la configurazione ha del controller sia attiva e funzioni correttamente nel sistema storage ASA A20, ASA A30 o ASA A50 e conferma che gli adattatori del sistema elencano tutti i percorsi dei dischi. 
---
= Ripristina e verifica la configurazione del controller nel tuo sistema ASA A20, ASA A30 o ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
