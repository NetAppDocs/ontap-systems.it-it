...
summary: Restituisci il controllo delle risorse di storage al controller sostitutivo in modo che il tuo sistema storage ASA A20, ASA A30 o ASA A50 possa riprendere il normale funzionamento. La procedura di restituzione varia in base al tipo di crittografia utilizzato dal sistema. 
---
= Restituisci il controller nel tuo sistema ASA A20, ASA A30 o ASA A50 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
