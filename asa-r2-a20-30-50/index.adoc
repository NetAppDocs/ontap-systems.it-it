...
---
= Manutenzione dell'hardware ASA A20, ASA A30 e ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per i sistemi di archiviazione ASA A20, ASA A30 o ASA A50, è possibile eseguire le procedure di manutenzione sui seguenti componenti.
