...
summary: Spegnere i controller del sistema storage ASA A20, ASA A30 o ASA A50 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis 
---
= Spegnere i controller per sostituire lo chassis: ASA A20, ASA A30 e ASA A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere i controller del sistema storage ASA A20, ASA A30 o ASA A50 per evitare perdite di dati e garantire la stabilità del sistema durante la sostituzione dello chassis.
