...
Per sostituire la batteria NV, è necessario rimuovere la centralina, rimuovere la batteria difettosa, installare la batteria di ricambio, quindi reinstallare la centralina.
