...
summary: Sostituire la batteria NV nel sistema ASA A20, ASA A30 o ASA A50 quando la batteria inizia a perdere la carica o si guasta, poiché è responsabile della conservazione dei dati critici del sistema durante le interruzioni di alimentazione. 
---
