...
[role="lead"]
Per sostituire il supporto di avvio, è necessario rimuovere il controller danneggiato, rimuovere il supporto di avvio danneggiato e installare il supporto di avvio sostitutivo nel controller danneggiato.
