...
summary: 'Il supporto di avvio del sistema ASA A20, ASA A30 o ASA A50 memorizza firmware e dati di configurazione essenziali. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l"installazione del supporto di avvio sostitutivo e la successiva reinstallazione del modulo controller.' 
---
...
[role="lead"]
Il supporto di avvio del sistema ASA A20, ASA A30 o ASA A50 memorizza firmware e dati di configurazione essenziali. La procedura di sostituzione prevede la rimozione del modulo controller, la rimozione del supporto di avvio danneggiato, l'installazione del supporto di avvio sostitutivo e la successiva reinstallazione del modulo controller.
