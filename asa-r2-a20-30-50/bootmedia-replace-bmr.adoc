...
[role="lead"]
Per sostituire i supporti di avvio, è necessario rimuovere il controller danneggiato, rimuovere i supporti di avvio danneggiati, quindi installare i supporti di avvio sostitutivi nel controller danneggiato.
