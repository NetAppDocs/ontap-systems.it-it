...
summary: 'Iniziate a sostituire i supporti di avvio nei sistemi di storage ASA A30, ASA A20 e ASA A50 esaminando i requisiti di sostituzione, spegnendo il controller danneggiato, sostituendo i supporti di avvio, ripristinando l"immagine sui supporti di avvio e verificando la funzionalità del sistema.' 
---
