...
[role="lead"]
Potrebbe essere necessario eseguire le procedure di manutenzione dell'hardware. Le procedure specifiche per la manutenzione dei componenti del sistema ASA A20, ASA A30 e ASA A50 sono descritte in questa sezione.

Le procedure descritte in questa sezione presuppongono che i sistemi di storage ASA A20, ASA A30 o ASA A50 siano già stati implementati come nodi di storage nell'ambiente ONTAP.
