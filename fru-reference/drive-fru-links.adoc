...
summary: Trova le procedure di sostituzione delle unità per il tuo sistema di archiviazione NetApp organizzate per piattaforma o famiglia di scaffali. Questo riferimento fornisce collegamenti diretti ai flussi di lavoro passo passo per la sostituzione delle unità nei sistemi AFF, ASA e FAS e nei sistemi a scaffale, per aiutarti a individuare rapidamente la procedura corretta per il tuo modello specifico. 
---
...
[role="lead"]
Trova le procedure di sostituzione delle unità per il tuo sistema di archiviazione NetApp organizzate per piattaforma o famiglia di scaffali. Questo riferimento fornisce collegamenti diretti ai flussi di lavoro passo passo per la sostituzione delle unità per i sistemi AFF, ASA, FAS e shelf per aiutarti a individuare rapidamente la procedura corretta per il tuo modello specifico.
...
* link:../sas3/service-replace-drawer-ds460c.html["Cassetto DS460C"]
