...
summary: Questa pagina fornisce collegamenti alle procedure di sostituzione della batteria RTC in base al sistema. 
---
= Collegamenti FRU della batteria RTC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Questa pagina fornisce collegamenti alle procedure di sostituzione della batteria RTC organizzate in base al modello di piattaforma.
