...
summary: Questa pagina fornisce collegamenti alle procedure di sostituzione della batteria NVMEM/ NVRAM in base al sistema. 
---
= Collegamenti FRU della batteria NVMEM/ NVRAM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Questa pagina fornisce collegamenti alle procedure di sostituzione delle batterie NVMEM/ NVRAM organizzate in base al modello di piattaforma.
