...
summary: Prima di sostituire il supporto di avvio nel sistema ASA A900, assicurarsi di soddisfare i requisiti necessari per una sostituzione corretta. 
---
= Esamina i requisiti per il ripristino automatico del supporto di avvio nel tuo sistema ASA A900
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
