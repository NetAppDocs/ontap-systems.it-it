...
summary: 'Per iniziare a sostituire il supporto di avvio nel sistema di archiviazione ASA A900 , esaminare i requisiti di sostituzione, controllare lo stato della crittografia, arrestare il controller, sostituire il supporto di avvio, avviare l"immagine di ripristino, ripristinare la crittografia e verificare la funzionalità del sistema.' 
---
= Procedura di sostituzione del supporto di avvio per un sistema ASA A900 utilizzando il processo di ripristino manuale dell'avvio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
