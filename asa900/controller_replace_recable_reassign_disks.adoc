...
summary: Ricollega i cavi delle configurazioni di storage e di rete, conferma la riassegnazione dei dischi e restituisci il controllo delle risorse di storage al controller sostitutivo, così il tuo sistema ASA A900 può riprendere il normale funzionamento. 
---
= Restituisci il controller nel tuo sistema ASA A900 per riprendere il normale funzionamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
