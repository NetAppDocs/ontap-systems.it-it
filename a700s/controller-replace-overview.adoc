...
---
= Verifica i requisiti prima di sostituire il controller nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Prima di sostituire il controller nel tuo sistema AFF A700s, verifica i prerequisiti per la procedura di sostituzione e seleziona quella corretta per la tua versione di ONTAP.
