...
---
= Sostituisci il controller nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il controller nel tuo sistema AFF A700s rimuovendo il controller danneggiato, trasferendo i componenti FRU sul modulo di ricambio, installandolo nello chassis e avviando in modalità Maintenance.
