...
summary: Sostituire il supporto di avvio non riuscito su un modulo controller AFF A700s . Il sistema AFF A700s supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Sostituisci il supporto di avvio nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il supporto di avvio non riuscito su un modulo controller AFF A700s . Questa procedura include la rimozione del modulo controller dallo chassis, l'individuazione del supporto di avvio non funzionante tramite l'indicatore LED acceso, la sostituzione fisica del componente del supporto di avvio e il ripristino del normale funzionamento del sistema.
