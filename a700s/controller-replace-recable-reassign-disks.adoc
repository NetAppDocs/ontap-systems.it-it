...
---
= Ricollega i cavi del sistema e riassegna i dischi nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Completa la sostituzione del controller per il tuo sistema AFF A700s ricablando lo storage, ripristinando la configurazione NetApp Storage Encryption (se necessario) e installando le licenze per il nuovo controller.
