...
---
= Sostituisci lo chassis nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci lo chassis nel tuo sistema AFF A700s spostando gli alimentatori, i dischi rigidi e i moduli controller dallo chassis guasto a quello di ricambio.
