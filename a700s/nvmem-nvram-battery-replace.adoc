...
---
= Sostituisci la batteria NVRAM nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci la batteria NVRAM nel tuo sistema AFF A700s rimuovendo il modulo controller, sostituendo la batteria e reinstallando il modulo controller.
