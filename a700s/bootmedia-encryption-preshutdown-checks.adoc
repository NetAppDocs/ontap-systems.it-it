...
summary: Verificare il supporto e lo stato della chiave di crittografia prima di spegnere il controller danneggiato su un sistema AFF A700s . Il sistema AFF A700s supporta solo procedure di ripristino manuale tramite supporti di avvio. Il ripristino automatico del supporto di avvio non è supportato. 
---
= Verifica il supporto della crittografia sul supporto di avvio nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
