...
summary: 'Sostituisci un alimentatore nel tuo sistema AFF A700s scollegando l"alimentatore di destinazione dalla fonte di alimentazione, staccando il cavo di alimentazione, rimuovendo il vecchio alimentatore, installando quello di ricambio e poi ricollegandolo alla fonte di alimentazione.' 
---
= Sostituisci a caldo un alimentatore in un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un alimentatore nel tuo sistema AFF A700s scollegando, rimuovendo e sostituendo l'unità guasta, quindi ricollegandola alla fonte di alimentazione.
