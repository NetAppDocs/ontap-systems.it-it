...
---
= Sostituisci il modulo NVRAM e i DIMM NVRAM nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci il modulo NVRAM e i DIMM NVRAM nel tuo sistema AFF A700s rimuovendo il riser NVRAM, sostituendo la scheda guasta e reinstallando il riser.
