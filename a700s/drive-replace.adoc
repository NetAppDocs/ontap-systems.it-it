...
---
= Sostituisci a caldo un disco in un sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci a caldo un'unità guasta nel tuo sistema AFF A700s senza interrompere le operazioni di I/O.
