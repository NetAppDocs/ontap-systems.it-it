...
---
= Sostituisci una ventola nel tuo sistema AFF A700s
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituisci una ventola nel tuo sistema AFF A700s rimuovendo il modulo ventola guasto e installando quello di ricambio.
