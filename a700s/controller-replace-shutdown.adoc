...
---
= Spegni il controller guasto nel tuo sistema AFF A700s prima della sostituzione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Arresta il controller danneggiato nel tuo sistema AFF A700s prima della sostituzione, prendendone il controllo e fermandolo al prompt LOADER.
